...
class TemplateRoutesTest {
    ...
    @Test
    fun `can get names of all autobrev`() =
        testBrevbakerApp { client ->
    ...
    @Test
    fun `can get names of all redigerbar`() =
        testBrevbakerApp { client ->
            ...
            assertEquals(
                alleRedigerbareMaler
                    ...
                    .map { it.kode.kode() }.toSet(),
                response.body<Set<String>>(),
            )
        }

    @Test
    fun `can get description of all autobrev`() =
        testBrevbakerApp { client ->
    ...
    @Test
    fun `can get description of all redigerbar`() =
        testBrevbakerApp { client ->
            ...
            assertEquals(
                alleRedigerbareMaler
                    .filterNot { it.kode in setOf(Pesysbrevkoder.Redigerbar.PE_OVERSETTELSE_AV_DOKUMENTER, Pesysbrevkoder.Redigerbar.UT_AVSLAG_UFOERETRYGD) }
                    .map { it.description() },
                response.body<List<TemplateDescription.Redigerbar>>(),
            )
        }

    @Test
    fun `can get description of autobrev`() =
        testBrevbakerApp { client ->
    ...
    @Test
    fun `can get description of redigerbar`() =
        testBrevbakerApp { client ->
    ...
    @Test
    fun `can get modelSpecification of autobrev`() =
        testBrevbakerApp { client ->
    ...
    @Test
    fun `can get modelSpecification of redigerbar`() =
        testBrevbakerApp { client ->
    ...
    @Test
    fun `can get template documentation of autobrev`() =
        testBrevbakerApp { client ->
    ...
    @Test
    fun `can get template documentation of redigerbar`() =
        testBrevbakerApp { client ->
    ...
    @Test
    fun `filtrerer bort deaktiverte maler`() =
        testBrevbakerApp { client ->
            settOppFakeUnleash()

...
\newcommand{\lettersectiontitle}[1]{{
    \primaryFont \fontsize{\titletwotextsize}{0pt}
    \selectfont
    \vspace{14pt}
    \pagebreak[3] %strongly encourage page break
    \textbf{#1}
...
\newcommand{\tableHeaderText}[1]{\allowbreak{\primaryFont \fontsize{\titletwotextsize}{\titletwotextsize} \selectfont \textbf{#1}}} %footer font command

...
object OMSFelles {
        ...
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            ...
            paragraph {
                ...
                list {
                    item { text(Language.Bokmal to "gifter deg eller blir samboer med en du tidligere har vært gift med", Nynorsk to "", English to "") }
                    item { text(Language.Bokmal to "blir samboer med en du har eller har hatt felles barn med", Nynorsk to "", English to "") }
                    item { text(Language.Bokmal to "får felles barn med en ny samboer", Nynorsk to "", English to "") }
                    item { text(Language.Bokmal to "flytter eller oppholder deg i et annet land i 6 måneder eller mer", Nynorsk to "", English to "") }
                    item { text(Language.Bokmal to "får varig opphold i institusjon", Nynorsk to "", English to "") }
                }
                text(

            ...
            outline {
                ...
                paragraph {
                    textExpr(
                        ...
                        "Hvis du ikke finner svar på spørsmålet ditt, kan du ringe oss på telefon" + ifElse(borIUtlandet, "(+47) 55 55 33 34", "55 55 33 34") + "hverdager mellom klokken 09.00-15.00." +
                        ...
                        Nynorsk to "Du finn meir informasjon på ".expr() + ifElse(sakType.equalTo(SakType.BARNEPENSJON), BARNEPENSJON_URL.expr(), OMS_URL.expr()) + "." +
                                "Dersom du ikkje finn svar på spørsmålet ditt der, kan du ringje oss på telefon" + ifElse(borIUtlandet, "(+47) 55 55 33 34", "55 55 33 34") + " kvardagar mellom klokka 09.00–15.00."  +
                        ...
                        English to "For more information, visit us online: ".expr() + ifElse(sakType.equalTo(SakType.BARNEPENSJON), BARNEPENSJON_URL.expr(), OMS_URL.expr()) + "." +
                                "If you cannot find the answer to your question, you can call us by phone at" + ifElse(borIUtlandet, "(+47) 55 55 33 34", "55 55 33 34") + "Monday to Friday between 9:00 AM and 3:00 PM." + "" +

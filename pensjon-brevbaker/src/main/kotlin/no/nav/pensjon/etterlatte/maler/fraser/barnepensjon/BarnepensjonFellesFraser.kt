                ...
                paragraph {
                    text(
                        Bokmal to "Hvis du mener at du ikke er skattepliktig til Norge, må du søke om fritak hos " +
                            ...
                            "om fritak til Nav familie- og pensjonsytelser, Postboks 6600 Etterstad, 0607 Oslo, Norway. " +
                        ...
                        Nynorsk to "Meiner du at du ikkje er skattepliktig til Noreg, må du søkje om fritak hos " +
                            "Skatteetaten. Du må sende kopi av vedtak om fritak til Nav familie- og pensjonsytelser, " +
                            "Postboks 6600 Etterstad, 0607 Oslo, Norway, for at vi ikkje skal trekkje skatt av " +
                            "barnepensjonen. Har du allereie sendt oss vedtak om skattefritak, blir det ikkje trekt " +
                            "skatt på barnepensjonen.",
                        English to "If you believe you are not liable to pay tax in Norway, you must apply for an " +
                            ...
                            "your children's pension, you must send the exemption decision to Nav familie- og " +
                            "pensjonsytelser, P.O. Box 6600 Etterstad, 0607 Oslo, Norway. If you have already done " +
                            "so, no tax will be deducted from your children's pension. ",
                    )
                }
            } orShow {
                paragraph {

            ...
            showIf((pe.pebrevkode().equalTo("PE_UT_04_114"))){
                ...
                paragraph {
                    text (
                        ...
                        English to "Your basis for calculation may be changed when your disability benefit is changed. On increasing your disability degree, your former basis of calculation of disability pension will be compared with your disability benefit calculation. You will be granted the alternative that gives you the best calculation.",
                    )

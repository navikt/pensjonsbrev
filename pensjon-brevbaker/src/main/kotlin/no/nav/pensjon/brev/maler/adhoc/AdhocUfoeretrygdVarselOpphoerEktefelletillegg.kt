...
object AdhocUfoeretrygdVarselOpphoerEktefelletillegg : AutobrevTemplate<EmptyBrevdata> {
    override val kode: Brevkode.AutoBrev = Brevkode.AutoBrev.UT_UFOERETRYGD_VARSEL_OPPHOER_EKTEFELLETILLEGG
    override val template: LetterTemplate<*, EmptyBrevdata> = createTemplate(
        ...
        outline {
            ...
            paragraph {
                text(Bokmal to "Uttalelsen bør være skriftlig. På nav.no/kontakt kan du chatte eller skrive til oss.")
            }
            paragraph {
                text(Bokmal to "Hvis du ikke finner frem på nav.no kan du ringe oss på telefon 55 55 33 33, hverdager 09.00-15.00.")
            }
            paragraph {

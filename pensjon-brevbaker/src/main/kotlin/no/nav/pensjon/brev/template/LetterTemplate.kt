...
typealias TextElement<Lang> = ContentOrControlStructure<Lang, Element.ParagraphContent.Text<Lang>>
typealias TableRowElement<Lang> = ContentOrControlStructure<Lang, Element.ParagraphContent.Table.Row<Lang>>
typealias ParagraphContentElement<Lang> = ContentOrControlStructure<Lang, Element.ParagraphContent<Lang>>
typealias ListItemElement<Lang> = ContentOrControlStructure<Lang, Element.ParagraphContent.ItemList.Item<Lang>>
typealias AnyElement<Lang> = ContentOrControlStructure<Lang, Element<Lang>>

sealed class Element<out Lang : LanguageSupport> {
    data class Title1<out Lang : LanguageSupport>(val title1: List<TextElement<Lang>>) : Element<Lang>()
    data class Paragraph<out Lang : LanguageSupport>(val paragraph: List<ParagraphContentElement<Lang>>) : Element<Lang>()

    sealed class ParagraphContent<out Lang : LanguageSupport> : Element<Lang>() {
        data class ItemList<out Lang : LanguageSupport>(
            val elements: List<ContentOrControlStructure<Lang, Item<Lang>>>

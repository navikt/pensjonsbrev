...
val vedleggPlikterAP5_001 = createPhrase<LangBokmalNynorskEnglish, Unit> {
    text(
        Bokmal to "en av dere får et varig opphold i institusjon",
        Nynorsk to "ein av dykk får et varig opphald i institusjon",
        English to "either you or your [_Script Script_bruker_sivilstand_ubestemtForm_] get permanent residency in an institution"
    )
}
...
val vedleggPlikterRettTilEktefelletilleggAP_001 = createPhrase<LangBokmalNynorskEnglish, Unit> {
    paragraph {
        text(

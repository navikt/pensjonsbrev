...
object EndretUfoeretrygdPGAInntekt : AutobrevTemplate<EmptyBrevdata> {
    ...
    override val template = createTemplate(
        ...
        val PE_Kontaktinformasjon_NavnAvsenderEnhet: Expression<String> = "<TEXTVARIABEL:4557>".expr()
        ...
        val PE_UT_VirkningFomArMinusEttAr: Expression<String> = "<TEXTVARIABEL:2995>".expr()
        ...
        val PE_Vedtaksdata_BeregningsData_BeregningAntallPerioder: Expression<Int> = 4190.expr()
        val PE_Vedtaksdata_BeregningsData_BeregningUforePeriode_BeregningYtelsesKomp_UforetrygdOrdiner_AvkortningsInformasjon_Inntektsgrense: Expression<Kroner> = Kroner(2586).expr()
        val PE_Vedtaksdata_BeregningsData_BeregningUforePeriode_BeregningYtelsesKomp_UforetrygdOrdiner_AvkortningsInformasjon_Inntektstak: Expression<Double> = 23.0.expr()
        ...
        val PE_Vedtaksdata_BeregningsData_BeregningUfore_BeregningYtelsesKomp_UforetrygdOrdiner_Brutto: Expression<Kroner> = Kroner(6330).expr()
        ...
        val PE_Vedtaksdata_BeregningsData_BeregningUfore_Total: Expression<Double> = 34.0.expr()

...
sealed interface LanguageSupport : StableHash {
    fun supports(language: Language): Boolean
    fun all(): Set<Language>

    sealed interface Single<Lang1 : Language> : LanguageSupport
    sealed interface Double<Lang1 : Language, Lang2 : Language> : Single<Lang1>
    sealed interface Triple<Lang1 : Language, Lang2 : Language, Lang3 : Language> : Double<Lang1, Lang2>
}

...
fun Application.brevbakerModule(
    ...
    val latexCompilerHttpService = LaTeXCompilerHttpService(
    ...
    configureMetrics()
    brevRouting(jwtConfigs?.map { it.name }?.toTypedArray(), latexCompilerHttpService, templates, latexAsyncCompilerService)
}

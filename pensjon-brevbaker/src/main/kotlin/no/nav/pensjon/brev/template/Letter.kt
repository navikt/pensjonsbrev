...
internal data class Letter<ParameterType : Any>(val template: LetterTemplate<*, ParameterType>, val argument: ParameterType, val language: Language, val felles: Felles) {

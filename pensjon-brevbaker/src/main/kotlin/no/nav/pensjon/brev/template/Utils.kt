...
internal fun ObjectMapper.brevbakerConfig() {
...
internal fun jacksonObjectMapper() = com.fasterxml.jackson.module.kotlin.jacksonObjectMapper().apply { brevbakerConfig() }

internal fun <T : Any> KClass<out T>.findSealedObjects(): Set<T> =
    if (isSealed) {
...
internal fun dateFormatter(language: Language, formatStyle: FormatStyle): DateTimeFormatter =
    DateTimeFormatter.ofLocalizedDate(formatStyle).withLocale(language.locale())

internal val CHARACTER_BLACKLIST =

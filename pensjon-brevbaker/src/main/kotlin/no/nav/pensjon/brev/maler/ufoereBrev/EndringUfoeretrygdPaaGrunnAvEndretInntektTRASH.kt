...
//
//
//data class EndringUfoeretrygdPaaGrunnAvEndretInntektDtoTRASH(
...
//object EndringUfoeretrygdPaaGrunnAvEndretInntektTRASH : AutobrevTemplate<EndringUfoeretrygdPaaGrunnAvEndretInntektDtoTRASH> {
//    override val kode: Brevkode.AutoBrev = Brevkode.AutoBrev.UT_ENDRING_UFOERETRYGD_PGA_INNTEKT
//    override val template: LetterTemplate<*, EndringUfoeretrygdPaaGrunnAvEndretInntektDtoTRASH> = createTemplate(
//        name = kode.name,
//        letterDataType = EndringUfoeretrygdPaaGrunnAvEndretInntektDtoTRASH::class,

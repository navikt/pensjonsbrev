...
import no.nav.pensjon.brev.template.dsl.text
    ...
    data class TabellSaerkullsbarn(
        val avkortningsbeloepAar: Expression<Kroner>,
        val beloepAarBrutto: Expression<Felles.KronerText>,
        val beloepNetto: Expression<Kroner>,
        val erRedusertMotInntekt: Expression<Boolean>,
        val fribeloep: Expression<Felles.KronerText>,
        val fribeloepEllerInntektErPeriodisert: Expression<Boolean>,
        val inntektBruktIAkortning: Expression<Felles.KronerText>,
        val inntektOverFribeloep: Expression<Felles.KronerText>,
        val inntektstak: Expression<Felles.KronerText>,

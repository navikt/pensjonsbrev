...
object Ufoeretrygd {
     ...
     * TBU3007
     */
    val ungUfoer20aar_001 = createPhrase<LangBokmal, KravVirkningFraOgMed> {
    ...
    val beloep = createPhrase<LangBokmal, BeloepPerMaaned> {
    ...
    val barnetileggIkkeUtbetalt = createPhrase<LangBokmal, BarnetilleggIkkeUtbetaltDto> {
     ...
     * TBU1092
     */
    val vedtakBegrunnelseOverskrift = createPhrase<LangBokmal, Unit> {
        title1 {
            text(
     ...
     */
    val ungUfoerHoeyereVed20aar = createPhrase<LangBokmal, GrunnbeloepSats> {
        paragraph {
            text(
     ...
     * TBU3011
     */
    val hjemmelSivilstand = createPhrase<LangBokmal, Unit> {
        paragraph {
            text(
     ...
     * TBU1174
     */
    val virkningFomOverskrift = createPhrase<LangBokmal, Unit> {
        title1 {
            text(
     ...
     * TBU2529x
     */
    val virkningFraOgMed = createPhrase<LangBokmal, KravVirkningFraOgMed> {
     ...
     * TBU1227
     */
    val sjekkUtbetalingene = createPhrase<LangBokmal, Unit> {
        title1 {
            text(

...
data class Trygdetid(
    val har40AarTrygdetid: Expression<Boolean>,
        ...
        paragraph {
            textExpr(
                ...
                English to "Your period of national insurance coverage has been established on the basis of your actual ".expr() +
                        ifElse(harFramtidigTrygdetid, ifTrue = "and future ", ifFalse = "") + "periods of national insurance coverage.".expr()
            )
            text(

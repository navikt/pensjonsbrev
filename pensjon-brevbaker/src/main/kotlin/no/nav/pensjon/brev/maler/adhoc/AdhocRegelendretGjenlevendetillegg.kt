    ...
    override val template: LetterTemplate<*, Unit> = createTemplate(
        ...
        title {
            text(
                ...
                English to "We are extending the survivor supplement in your disability benefit"
            )
        }
        outline {
            paragraph {
            ...
            paragraph {
                text(
                    ...
                    English to "You have been receiving a time-limited survivor supplement in your disability benefit. The survivor supplement is no longer time-limited."
                )
            }
            paragraph {
                text(

...
import no.nav.pensjon.brev.api.model.vedlegg.UfoeretrygdPerMaanedSelectors.barnetilleggFellesbarnNetto
import no.nav.pensjon.brev.api.model.vedlegg.UfoeretrygdPerMaanedSelectors.barnetilleggSaerkullsbarnBrutto
import no.nav.pensjon.brev.api.model.vedlegg.UfoeretrygdPerMaanedSelectors.barnetilleggSaerkullsbarnNetto
import no.nav.pensjon.brev.api.model.vedlegg.UfoeretrygdPerMaanedSelectors.dekningFasteUtgifter
import no.nav.pensjon.brev.api.model.vedlegg.UfoeretrygdPerMaanedSelectors.ektefelletilleggBrutto
import no.nav.pensjon.brev.api.model.vedlegg.UfoeretrygdPerMaanedSelectors.ektefelletilleggNetto
...
import no.nav.pensjon.brev.api.model.vedlegg.UfoeretrygdPerMaanedSelectors.gjenlevendetilleggBrutto
import no.nav.pensjon.brev.api.model.vedlegg.UfoeretrygdPerMaanedSelectors.gjenlevendetilleggNetto

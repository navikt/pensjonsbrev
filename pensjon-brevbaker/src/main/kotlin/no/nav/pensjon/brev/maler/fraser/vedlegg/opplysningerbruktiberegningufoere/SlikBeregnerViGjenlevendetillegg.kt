...
data class SlikBeregnerViGjenlevendetillegg(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        showIf(harGjenlevendetillegg and kravAarsakType.isNotAnyOf(KravAarsakType.SOKNAD_BT)) {
            ...
            AND PE_pebrevkode <> PE_UT_04_108, PE_pebrevkode <> PE_UT_04_109, PE_UT_04_500, PE_UT_07_200, PE_UT_06_300, PE_UT_04_102, PE_UT_04_102
            AND PE_Vedtaksdata_Kravhode_KravArsakType <> "tilst_dod"))) THEN
            THEN INCLUDE  */

            showIf(not(harNyttGjenlevendetillegg) and kravAarsakType.isNotAnyOf(KravAarsakType.TILST_DOD)) {
                paragraph {
                    text(

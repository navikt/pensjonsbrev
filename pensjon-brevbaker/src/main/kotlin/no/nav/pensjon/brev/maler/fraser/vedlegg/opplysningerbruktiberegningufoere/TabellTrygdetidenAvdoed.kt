...
data class TabellTrygdetidenAvdoed(
    val norskTrygdetidPeriode: Expression<List<OpplysningerBruktIBeregningUTDto.OpplysningerAvdoed.NorskTrygdetidPeriode1>>,
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        // TBU044V
        ifNotNull(norskTrygdetidPeriode) { norskTrygdetidPeriode ->
            paragraph {
                text(
        ...
        ifNotNull(utenlandskTrygdetidEOSPeriode) { utenlandskTrygdetidEOSPeriode ->
            paragraph {
                text(
        ...
        ifNotNull(utenlandskTrygdetidBilateralPeriode) { utenlandskTrygdetidBilateralPeriode ->
            paragraph {
                text(

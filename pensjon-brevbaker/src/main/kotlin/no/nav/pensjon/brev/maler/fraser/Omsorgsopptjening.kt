    ...
    object Info : OutlinePhrase<LangBokmalNynorskEnglish>() {
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            ...
            paragraph {
                ...
                textExpr(    Bokmal to "Pensjonsopptjeningen fra omsorgsarbeidet tilsvarer det du ville fått av en inntekt på 4,5 ganger grunnbeløpet for det aktuelle året. Du kan lese mer om dette på $NAV_URL, og få oversikt over pensjonsopptjeningen din på ".expr() +
                    ...
                    English to "The pension accrual from caregiving work corresponds to what you would have received from an income of 4.5 times the basic amount for the relevant year. You can read more about this at $NAV_URL, and get an overview of your pension accrual at ".expr() +
                            nettside + ". Here you will also find approved caregiving accrual.",)
            }
        }
    }

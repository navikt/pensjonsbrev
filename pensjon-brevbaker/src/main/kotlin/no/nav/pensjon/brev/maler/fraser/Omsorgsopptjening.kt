...
object Omsorgsopptjening {
    ...
    val hjelpestoenadInnledn = OutlinePhrase<LangBokmalNynorskEnglish, Year>  { aarInnvilgetOmrsorgspoeng ->
        paragraph {
            textExpr(
    ...
    val hjelpestKap20Hjemmel = OutlinePhrase<LangBokmalNynorskEnglish, Unit> {
        paragraph {
            text(
    ...
    val hjelpestKap3Hjemmel = OutlinePhrase<LangBokmalNynorskEnglish, Unit> {
        paragraph {
            text(
    ...
    val info = OutlinePhrase<LangBokmalNynorskEnglish, Unit> {
        title1 {
            text(
    ...
    val overforingInfo = OutlinePhrase<LangBokmalNynorskEnglish, Unit> {
        title1 {
            text(
    ...
    val hjelpestonadAutoGodkjennInfo = OutlinePhrase<LangBokmalNynorskEnglish, Unit> {
        title1 {
            text(

...
// <> brevkode PE_UT_04_103, PE_UT_04_108, PE_UT_04_109, PE_UT_04_115, PE_UT_04_300, PE_UT_04_500, PE_UT_05_100,
...
data class SlikFastsetterViInntektenDinFoerDuBleUfoer(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        showIf(
            ...
            ifNotNull(inntektFoerUfoereBegrunnelse) { begrunnelse ->
                showIf(
                    begrunnelse.isOneOf(
                        InntektFoerUfoereBegrunnelse.STDBEGR_12_8_2_3,
                        InntektFoerUfoereBegrunnelse.STDBEGR_12_8_2_4,
                        InntektFoerUfoereBegrunnelse.STDBEGR_12_8_2_5
                    )
                ) {
                    paragraph {
                        text(
                    ...
                    paragraph {
                        ...
                        list {
                            ...
                            item {
                                text(
                                    Bokmal to "3,3 gonger grunnbeløpet dersom du lever saman med ektefelle/partner/sambuar. Sambuarforholdet ditt må ha vart i minst 12 av dei siste 18 månadene.",
                            ...
                            item {
                                text(
                                    Bokmal to "3.3 times the National Insurance basic amount for individuals living with a spouse or partner, or in a cohabitant relationship that has lasted no less than 12 of the last 18 months.",

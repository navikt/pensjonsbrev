    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                ...
                english { + "If you plan to move or stay in another country, you must contact us so we can evaluate if you still can claim child supplement. This applies also if the child you support is to stay in another country." },
            )
        }
    }
}

        ...
        outline {
            ...
            paragraph {
                text(
                    ...
                    English to "You are entitled to see your case documents. Refer to the attachment ${quoted("Your rights and how to appeal")} for information about how to proceed."
                )
            }
            title1 {
                text(

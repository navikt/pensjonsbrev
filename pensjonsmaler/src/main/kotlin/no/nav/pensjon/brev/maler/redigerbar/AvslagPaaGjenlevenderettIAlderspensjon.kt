        ...
        outline {
            ...
            showIf(saksbehandlerValg.underEttAarsMedlemstidEOESEllerAvtaleland) {
                ...
                paragraph {
                    ...
                    universalTextExpr(fritekst(" eller "))
                    textExpr(
            ...
            showIf(saksbehandlerValg.under20AarBotid) {
                paragraph {
                    ...
                    universalTextExpr(pesysData.bruker.faktiskBostedsland_safe.ifNull(fritekst("BOSTEDSLAND")))
                    text(
            ...
            ifNotNull(pesysData.avtaleland) { land ->
                ...
                showIf(land.erEOSLand and saksbehandlerValg.hjemmelEOES) {
                    ...
                    paragraph {
                        ...
                        ifNotNull(land.navn) { universalTextExpr(it + ".") }
                    }
                }
            }

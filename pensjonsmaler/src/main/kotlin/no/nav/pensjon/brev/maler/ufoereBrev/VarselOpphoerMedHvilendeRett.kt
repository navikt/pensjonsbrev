...
object VarselOpphoerMedHvilendeRett : AutobrevTemplate<VarselOpphoerMedHvilendeRettDto> {
    ...
    override val template = createTemplate(
        name = kode.name,
        letterDataType = VarselOpphoerMedHvilendeRettDto::class,
        ...
        outline {
            paragraph {
                textExpr(
                    Bokmal to "Dette er et varsel om at uføretrygden din blir opphørt fra 1.1.".expr() + etteroppgjorsar.format() + " hvis du ikke har rett " +

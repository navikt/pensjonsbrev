    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
                list {
                    item {
                        textExpr(
                            Bokmal to "For å kunne ta ut alderspensjon før du fyller ".expr() + normertPensjonsalder.aarOgMaanederFormattert() + //TODO start her
            ...
            showIf(borINorge) {
                textExpr(
                    Bokmal to "Selv om vi har avslått denne søknaden, kan du likevel ha rett til å ta ut alderspensjon før du fyller ".expr() +
                            ...
                            "På ${no.nav.pensjon.brev.maler.fraser.common.Constants.DIN_PENSJON_URL} kan du sjekke når du tidligst kan ta ut alderspensjon. " +
                    ...
                    Nynorsk to "Sjølv om vi har avslått denne søknaden, kan du likevel ha rett til å ta ut alderspensjon før du fyller ".expr() +
                            ...
                            "På ${no.nav.pensjon.brev.maler.fraser.common.Constants.DIN_PENSJON_URL} kan du sjekke når du tidlegast kan ta ut alderspensjon. " +
                    ...
                    English to "Even though we have rejected this application, you may still be eligible to withdraw your retirement pension before you turn ".expr() +
                            ...
                            "In \"Din Pensjon\" at ${no.nav.pensjon.brev.maler.fraser.common.Constants.DIN_PENSJON_URL}, you can check when you can earliest withdraw your retirement pension. " +
                            "You can also see what your pension will be, depending on when and how much you withdraw.",
                )
            }.orShow {
                textExpr(
                    Bokmal to "I Din pensjon på ${no.nav.pensjon.brev.maler.fraser.common.Constants.DIN_PENSJON_URL} kan du sjekke når du tidligst kan ta ut alderspensjon. ".expr() +
                            ...
                            " ${no.nav.pensjon.brev.maler.fraser.common.Constants.NAV_KONTAKTSENTER_TELEFON} hvis du trenger hjelp til dette. ",
                    Nynorsk to "I Din pensjon på ${no.nav.pensjon.brev.maler.fraser.common.Constants.DIN_PENSJON_URL} kan du sjekke når du tidlegast kan ta ut ".expr() +
                            ...
                            "${no.nav.pensjon.brev.maler.fraser.common.Constants.NAV_KONTAKTSENTER_TELEFON} hvis du treng hjelp til dette. ",
                    English to "You may still be eligible for retirement pension before you turn ".expr() +
                            ...
                            "Log on to \"Din Pensjon\" at ${no.nav.pensjon.brev.maler.fraser.common.Constants.DIN_PENSJON_URL} to find out more about your pension payments and how it changes " +
        ...
        paragraph {
            text(
                Bokmal to "Hvis du mener vedtaket er feil, kan du klage innen seks uker fra den datoen du mottok vedtaket. " +
                        "Klagen skal være skriftlig. Du finner skjema og informasjon på ${no.nav.pensjon.brev.maler.fraser.common.Constants.KLAGE_URL}.",
                Nynorsk to "Om du meiner vedtaket er feil, kan du klage innan seks veker frå den datoen du fekk vedtaket. " +
                        "Klagen skal vere skriftleg. Du finn skjema og informasjon på ${no.nav.pensjon.brev.maler.fraser.common.Constants.KLAGE_URL}.",
                English to "If you think the decision is wrong, you may appeal the decision within six weeks of the date on which " +
                        ...
                        "information about appeals at ${no.nav.pensjon.brev.maler.fraser.common.Constants.KLAGE_URL}."
            )
        }
        ...
        includePhrase(no.nav.pensjon.brev.maler.fraser.common.Felles.HarDuSpoersmaal.alder)

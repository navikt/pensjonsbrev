    ...
    override fun OutlineOnlyScope<LangBokmalNynorsk, Unit>.template() {
        ...
        showIf((pe.vedtaksbrev_vedtaksdata_etteroppgjorresultat_avviksbeloptfb().notEqualTo(0))){
            ...
            paragraph {
                ...
                textExpr (
                    Bokmal to "Opplysningene om inntekt for deg og annen forelder viser at du skulle ha fått ".expr() + pe.vedtaksbrev_vedtaksdata_etteroppgjorresultat_totalbeloptfb().format() + " i barnetillegg i " + pe.ut_uforetrygdetteroppgjor_periodefom_year().format() + ". Du fikk imidlertid " + pe.vedtaksbrev_vedtaksdata_etteroppgjorresultat_tidligerebeloptfb().format() + ". Du har derfor fått " + pe.ut_avviksbeloptfbutenminus().format() + " for ",
                    Nynorsk to "Opplysningane om inntekta til deg og den andre forelderen viser at du skulle ha fått ".expr() + pe.vedtaksbrev_vedtaksdata_etteroppgjorresultat_totalbeloptfb().format() + " i barnetillegg i " + pe.ut_uforetrygdetteroppgjor_periodefom_year().format() + ". Du fekk derimot " + pe.vedtaksbrev_vedtaksdata_etteroppgjorresultat_tidligerebeloptfb().format() + ". Du har derfor fått " + pe.ut_avviksbeloptfbutenminus().format() + " for ",
                )

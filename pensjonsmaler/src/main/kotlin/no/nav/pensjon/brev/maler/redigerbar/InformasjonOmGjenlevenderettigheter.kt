    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            showIf(pesysData.sakstype.isOneOf(Sakstype.ALDER)) {
                paragraph {
                    text(
                        bokmal { + "Vi oppfordrer deg til å søke så snart som mulig frodi vi vi vanligvis kun etterbetaler for tre måneder. Du finner informasjon og søknad på ${Constants.ALDERSPENSJON_GJENLEVENDE_URL}." },
                        nynorsk { + "Vi oppmodar deg til å søkje så snart som mogleg fordi vi vanlegvis berre etterbetalar for tre månader. Du finn informasjon og søknad på ${Constants.ALDERSPENSJON_GJENLEVENDE_URL}." },
                        english { + "We encourage you to apply as soon as possible because we normally only pay retroactively for three months. You will find information and the application form at ${Constants.ALDERSPENSJON_GJENLEVENDE_URL}." },
                    )
                }
                paragraph {
                    text(
                        ...
                        nynorsk { + "Vi oppmodar deg til å søkje så snart som mogleg fordi vi vanlegvis berre etterbetaler for tre månader. Dersom du bur i utlandet, må du kontakte trygdeorgana i bustedslandet ditt." },
                        english { + "You should apply as soon as possible as surviving person's benefits are not paid for more than 3 months in arrears. If you live outside Norway, you must contact the National Insurance authorities in your country of residence and apply for a pension." },
                    )
                }
            }
            showIf(pesysData.sakstype.isOneOf(Sakstype.UFOREP)) {

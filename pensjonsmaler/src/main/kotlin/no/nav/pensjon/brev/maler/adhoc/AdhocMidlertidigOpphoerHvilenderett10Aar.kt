...
object AdhocMidlertidigOpphoerHvilenderett10Aar : AutobrevTemplate<EmptyAutobrevdata> {
    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            paragraph {
                text(
                    bokmal { + "Du har tidligere fått tilsendt brev der vi opplyser at uføretrygden din stanser fra 1.1.2025 hvis du ikke har fått utbetaling av uføretrygd i 2023 og 2024. Det utbetales ikke uføretrygd når den pensjonsgivende inntekten utgjør mer enn 80 prosent av inntekten du hadde før du ble ufør. Dette står i folketrygdloven § 12-14 tredje ledd." },
                )
            }
            paragraph {
                text(
                    bokmal { + "Du har ikke fått utbetaling av uføretrygd i 2023 og 2024 og har hatt 10 sammenhengende år uten utbetaling av uføretrygd. Du har dermed nådd den maksimale grensen for hvor lenge du kan ha hvilende rett til uføretrygd." },
                )
            }
            paragraph {
                text(
            ...
            paragraph {
                text(
                    bokmal { + "Når etteroppgjøret for 2024 er klart må vi vurdere om du skal få et endelig vedtak om stans av uføretrygden din. Vi stanser uføretrygden din midlertidig allerede nå for å unngå feilutbetaling av uføretrygd, og for å være sikker på at det stemmer at du ikke har rett til uføretrygd i 2024." },
                )
            }
            paragraph {
                text(

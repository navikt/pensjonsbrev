    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
		...
		paragraph {
			textExpr (
				...
				English to "Please be aware that disability benefit is not paid if your income exceeds 80 percent of the income you had prior to your disability, adjusted for inflation, i.e. ".expr() + pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_avkortningsinformasjon_inntektstak().format() + " per year.",
			)
		}
    }
}

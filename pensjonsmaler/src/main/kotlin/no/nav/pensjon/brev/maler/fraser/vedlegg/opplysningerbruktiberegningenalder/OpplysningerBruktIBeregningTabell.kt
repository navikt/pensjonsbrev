            ...
            table(opplysningerBruktIBeregningenHeader(beregnetPensjonPerManedVedVirk.virkDatoFom)) {
                ...
                showIf(beregningKap19VedVirk.forholdstallLevealder.greaterThan(0.0)) {
                    row {
                        ...
                        cell { universalTextExpr(beregningKap19VedVirk.forholdstallLevealder.format(scale = 3)) }
                    }
                }
                ...
                ifNotNull(yrkesskadeDetaljerVedVirk) {
                    row {
                        ...
                        cell { universalTextExpr(it.yrkesskadeUforegrad.format() + " %") }
                    }
                    ...
                    row {
                        ...
                        cell { universalTextExpr(it.sluttpoengtall.format()) }
                    }
                ...
                showIf(alderspensjonVedVirk.skjermingstilleggInnvilget) {
                    ...
                    showIf(beregningKap19VedVirk.uforegradVed67.greaterThan(0)) {
                        row {
                            ...
                            cell { universalTextExpr(beregningKap19VedVirk.uforegradVed67.format() + " %") }
                        }
                    }
                    ...
                    showIf(beregningKap19VedVirk.skjermingsgrad.greaterThan(0.0)) {
                        row {
                            ...
                            cell { universalTextExpr(beregningKap19VedVirk.skjermingsgrad.format() + " %") }
                        }
                    }
                    ...
                    showIf(beregningKap19VedVirk.forholdstall67Soeker.greaterThan(0.0)) {
                        row {
                            ...
                            cell { universalTextExpr(beregningKap19VedVirk.forholdstall67Soeker.format(scale = 3)) }
                        }
                    }
                }
            }
                ...
                ifNotNull(beregningKap20VedVirk) { beregningKap20VedVirk ->
                    ...
                    showIf(beregningKap20VedVirk.delingstallLevealder.greaterThan(0.0)) {
                        row {
                            ...
                            cell { universalTextExpr(beregningKap20VedVirk.delingstallLevealder.format()) }
                        }
                    }
                }
            }
                ...
                ifNotNull(garantipensjonVedVirk) { garantipensjonVedVirk ->
                    showIf(alderspensjonVedVirk.garantipensjonInnvilget and
                        ...
                        row {
                            ...
                            cell { universalTextExpr(garantipensjonVedVirk.delingstalletVed67Ar.format()) }
                        }
                    }
                }
            }

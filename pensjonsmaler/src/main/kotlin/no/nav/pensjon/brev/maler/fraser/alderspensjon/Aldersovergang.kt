        ...
        showIf(ytelseForAldersovergangKode.equalTo(YtelseForAldersovergangKode.GJP_FULL)) {
            paragraph {
                text(
                    ...
                    Nynorsk to "Attlevandepensjonen din opphøyrer frå og med månaden etter at du fyller 67 år.",
            ...
            showIf(ytelseForAldersovergangKode.equalTo(YtelseForAldersovergangKode.UT_GRAD)) {
                paragraph {
                    text(
                        ...
                        Nynorsk to "Uføretrygda di stoppar og blir rekna om til alderspensjon månaden etter at du " +
            ...
            paragraph {
                text(
                    Bokmal to "Hvis du ønsker hel alderspensjon fra måneden etter at uføretrygden stopper, " +
                    ...
                    Nynorsk to "Om du ønskjer heil alderspensjon frå månaden etter at uføretrygda stoppar, " +
                    ...
                    English to "If you wish to receive full retirement pension from the month after your " +
            ...
            paragraph {
                text(
                    Bokmal to "Du kan også velge å ta ut alderspensjonen din med en annen uttaksgrad. " +
                        "Uttaksgrad er hvor stor andel av pensjonen du tar ut. Du kan ta ut " +
                        "20, 40, 50, 60, 80 eller 100 prosent alderspensjon.",
                    Nynorsk to "Du kan også velje å ta ut alderspensjonen din med ein annan uttaksgrad. " +
                        "Uttaksgrad er kor stor del av pensjonen du tar ut. Du kan ta ut " +
                        "20, 40, 50, 60, 80 eller 100 prosent alderspensjon.",
                    English to "You may also choose to withdraw your retirement pension at a different " +
            ...
            paragraph {
                text(
                    Bokmal to "I pensjonskalkulatoren på nav.no kan du sjekke hvor høy pensjonen blir " +
                    ...
                    Nynorsk to "I pensjonskalkulatoren på nav.no kan du sjekke kor høg pensjonen blir " +
                        "med ulike uttaksgradar. Om du treng hjelp til berekninga eller søknaden, " +
                        "kan du kontakte oss på telefon $NAV_KONTAKTSENTER_TELEFON_PENSJON.",
                    English to "You can use the pension calculator at nav.no to check how much your pension " +
                ...
                textExpr(
                    ...
                    English to "You can ".expr() +
                        ifElse(
                            ...
                            ifTrue = "nevertheless",
                            ifFalse = "",
                        ) + " select one of the following options:".expr(),
                )
                list {
                    item {
                        text(
...
data class InfoFTAP(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        showIf(
            ...
            paragraph {
                text(
                    Bokmal to "Du finner mer informasjon om dette på $FORSOERGINGSTILLEGG_URL.",
                    Nynorsk to "Du finn meir informasjon om dette på $FORSOERGINGSTILLEGG_URL.",
                    English to "You can find more information at $FORSOERGINGSTILLEGG_URL.",
                )
            }
        }
    }
...
data class InfoSoekeAP(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        showIf(
            ...
            paragraph {
                text(
                    Bokmal to "Du kan bruke pensjonskalkulatoren på $DIN_PENSJON_URL_INNLOGGET til å beregne alderspensjonen din.",
                    Nynorsk to "Du kan bruke pensjonskalkulatoren på $DIN_PENSJON_URL_INNLOGGET til å berekne alderspensjon din.",
                    English to
...
object HvorKanDuFaaViteMerOmAlderspensjonenDin : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                Bokmal to
                    "Du finner mer informasjon om hvordan alderspensjon er satt sammen og oversikter over " +
                    "grunnbeløp og aktuelle satser på $ALDERSPENSJON.",
                Nynorsk to
                    "Du finn meir informasjon om korleis alderspensjonen er sett saman, og oversikter over " +
                    "grunnbeløp og aktuelle satsar på $ALDERSPENSJON.",
                English to
                    "There is more information on how retirement pension is calculated, with overviews of " +
                    "basic amounts and relevant rates, at $ALDERSPENSJON.",
            )
        }
        paragraph {
            text(

    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
		...
		paragraph {
			text (
				...
				english { + "You will not receive child supplement for the " + pe.ut_barnet_barna_felles() + " who live" + pe.ut_barnet_barna_felles_en_entall_flertall() + " together with both parents because your total income is higher than " + pe.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggfelles_avkortningsinformasjon_inntektstak().format() + ". You will not receive child supplement for the " + pe.ut_barnet_barna_serkull() + " who do not live" + pe.ut_barnet_barna_serkull_en_entall_flertall() + " together with both parents because your income alone is higher than " + pe.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggserkull_avkortningsinformasjon_inntektstak().format() + ". You will not receive child supplement because your income exceeds the income limit. " },
			)
		}
    }
}

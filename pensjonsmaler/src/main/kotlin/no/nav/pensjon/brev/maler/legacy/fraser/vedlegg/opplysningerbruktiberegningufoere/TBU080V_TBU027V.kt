            ...
            showIf((pe.vedtaksdata_beregningsdata_beregningufore_uforetrygdberegning_beregningsmetode().equalTo("folketrygd") and pe.vedtaksdata_kravhode_vurderetrygdeavtale())){
                ...
                paragraph {
                    text (
                        ...
                        Nynorsk to "Vi bereknar uføretrygda di etter reglane i folketrygdlova fordi dette gir deg ei høgare berekning enn etter trygdeavtale. Uføretrygda di er berekna etter samla opptening i Noreg. Du kan sjå kva opplysningar vi har brukt i berekninga i tabellen ${quoted("Opplysningar vi har brukt i berekninga")}.",

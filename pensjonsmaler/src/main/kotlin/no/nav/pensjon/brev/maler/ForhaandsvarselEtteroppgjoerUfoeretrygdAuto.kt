            ...
            outline {
                ...
                paragraph {
                    text(
                        ...
                        nynorsk { + "Dette er eit varselbrev. Du har ein frist på 3 veker frå du får varselet til å komma med tilbakemeldingar eller nye opplysningar. Høyrer me ikkje frå deg, blir varselet automatisk omgjort til eit vedtak etter 4 veker. Frå vedtaket er gyldig, er fristen for å klaga på vedtaket 6 veker. Du finn skjema og informasjon om korleis du klagar, på ${Constants.KLAGE_URL}. Du må som hovudregel byrje å betale tilbake sjølv om du klagar på vedtaket, jf. forvaltingslova § 42." },

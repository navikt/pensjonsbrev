...
object ForhaandsvarselVedTilbakekreving : RedigerbarTemplate<EmptyRedigerbarBrevdata> {
    ...
    override val template = createTemplate(
        ...
        title {
            text(
                bokmal { + "Varsel om at Nav vurderer å kreve tilbake feilutbetalt beløp" },
                nynorsk { + "Varsel om at Nav vurderer å krevje tilbake feilutbetalt beløp" },
                english { + "Notification that Nav is considering demanding repayment of incorrectly paid amount" }
            )
        }
        outline {
            paragraph {
                text(
                    bokmal { + felles.avsenderEnhet.navn + " viser til vedtak av " + fritekst("dato") +
                            " hvor det er lagt til grunn at du har fått utbetalt for mye " + fritekst("type ytelse") +
                            " i perioden fra og med " + fritekst("dato fra og med") + " til og med " +
                            fritekst("dato til og med") + "." },
                    nynorsk { + felles.avsenderEnhet.navn + " viser til vedtak av " + fritekst("dato") +
                            " der det er lagt til grunn at du har fått utbetalt for mykje " + fritekst("type ytelse") +
                            " i perioden frå og med " + fritekst("dato fra og med") + " til og med " +
                            fritekst("dato til og med") + "." },
                    english { + felles.avsenderEnhet.navn + " refers to the decision of " + fritekst("dato") + "," +
                            " which indicates that you have received over-payment of " + fritekst("type ytelse") +
                            " during the period from and including " + fritekst("dato fra og med") + " up to and including " +
                            fritekst("dato til og med") + "." }
                )
            }
            paragraph {
                text(
                    bokmal { + "Beløpet er " + fritekst("beløp") + " kr. " +
                            "Det feilutbetalte beløpet er summen av utbetaling som mottakeren ikke hadde krav på." },
                    nynorsk { + "Beløpet er " + fritekst("beløp") + " kr. " +
                            "Det feilutbetalte beløpet er summen av utbetaling som mottakeren ikkje hadde krav på." },
                    english { + "The amount is NOK " + fritekst("beløp") + ". " +
                            "The incorrectly paid amount is the total of the payments to which the recipient was not entitled." }
                )
            }
            paragraph {
                text(
                    bokmal { + "Dette brevet gir informasjon om" },
                    nynorsk { + "Dette brevet gir informasjon om" },
                    english { + "This letter gives information about" }
                )
                list {
                    item {
                        text(
                            bokmal { + "årsak til feilutbetaling" },
                            nynorsk { + "årsaka til feilutbetalinga" },
                            english { + "reason for incorrect payment" }
                        )
                    }
                    item {
                        text(
                            bokmal { + "reglene for tilbakekreving i folketrygdloven kapittel 22" },
                            nynorsk { + "reglane for tilbakekrevjing i folketrygdlova kapittel 22" },
                            english { + "rules for demanding repayment in section 22 of the Social Security Act" }
                        )
                    }
                    item {
                        text(
                            bokmal { + "hvordan du går fram hvis du ønsker å uttale deg i saken" },
                            nynorsk { + "korleis du går fram dersom du ønskjer å uttale deg i saka" },
                            english { + "how to proceed if you wish to submit an opinion in this case " }
                        )
                    }
                }
            }
            paragraph {
                text(
                    bokmal { + "Vi understreker at dette brevet er et forhåndsvarsel etter forvaltningsloven paragraf 16 om at det er aktuelt å vurdere tilbakekreving av feilutbetalt beløp. " +
                    ...
                    nynorsk { + "Vi understrekar at dette brevet er eit førehandsvarsel etter forvaltingslova paragraf 16 om at det er aktuelt å vurdere tilbakekrevjing av feilutbetalt beløp. " +
                    ...
                    english { + "We stress that this letter is a prior notification, in accordance with paragraph 16 of the Public Administration Act, " +
            ...
            title1 {
                text(
                    bokmal { + "Hva som har skjedd" },
                    nynorsk { + "Kva som har skjedd " },
            ...
            title1 {
                text(
                    bokmal { + "Reglene for tilbakekreving" },
                    nynorsk { + "Reglane for tilbakekrevjing" },
                    english { + "The rules for demanding repayment" }
                )
            }
            paragraph {
                text(
                    bokmal { + "Ved en feilutbetaling skal Nav vurdere om det skal fattes vedtak om å kreve tilbake det feilutbetalte beløpet fra mottakeren. " +
                    ...
                    nynorsk { + "Ved ei feilutbetaling skal Nav vurdere om det skal fattast vedtak om å krevje tilbake det feilutbetalte beløpet frå mottakaren. " +
                    ...
                    english { + "In the event of an incorrect payment, Nav will consider whether a decision should be made to demand repayment by the recipient of the incorrectly paid amount. " +
            ...
            paragraph {
                text(
                    bokmal { + "Et feilutbetalt beløp kan kreves tilbake med mindre særlige grunner taler mot det. " +
                    ...
                    nynorsk { + "Eit feilutbetalt beløp kan krevjast tilbake med mindre særlege grunnar taler mot det. " +
                    ...
                    english { + "A demand may be made for repayment of an incorrectly paid amount unless specific grounds indicate otherwise. " +
            ...
            paragraph {
                text(
                    bokmal { + "Dersom det blir gjort vedtak om tilbakebetaling vil det bli gitt nærmere informasjon om hvordan tilbakebetalingen skal skje." },
                    nynorsk { + "Dersom det blir gjort vedtak om tilbakebetaling, vil det bli gitt nærmare informasjon om korleis tilbakebetalinga skal skje." },
                    english { + "If a decision is taken to demand repayment, further information will be provided about how repayment is to be made." }
                )
            }
            title1 {
                text(
            ...
            paragraph {
                text(
                    bokmal { + "Du har rett til å uttale deg, skriftlig eller muntlig, før vi tar den endelige avgjørelsen om tilbakebetaling. Du har også som hovedregel rett til å se sakens dokumenter etter bestemmelsene i forvaltningsloven, paragraf 18. Fristen for å gi uttale er 14 dager etter at du har mottatt dette brevet. Du kan ta kontakt med oss på telefonnummer " + fritekst(
                        "tlfnr"
                    ) + ", eller du kan sende et skriftlig svar til:" },
                    nynorsk { + "Du har rett til å uttale deg, skriftleg eller munnleg, før vi tek den endelege avgjerda om tilbakebetaling. Du har òg som hovudregel rett til å sjå saksdokumenta etter føresegnene i forvaltingslova paragraf 18. Fristen for å uttale seg er 14 dagar etter at du har fått dette brevet. Du kan ta kontakt med oss på telefonnummer " + fritekst(
                        "tlfnr"
                    ) + ", eller du kan sende eit skriftleg svar til:" },
                    english { + "You have the right to submit an opinion, either in writing or verbally, before we take a final decision regarding repayment. As a general rule, you are also entitled to see the case documents, in accordance with the provisions of paragraph 18 of the Public Administration Act. The deadline for submitting an opinion is 14 days after you have received this letter. You can contact us by telephone on " + fritekst(
                        "tlfnr"
                    ) + " or you can send a written response to:" }
                )
            }

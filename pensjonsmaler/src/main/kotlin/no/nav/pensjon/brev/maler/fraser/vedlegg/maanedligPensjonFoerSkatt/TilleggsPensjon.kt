...
data class MaanedligPensjonFoerSkattTilleggsPensjon(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        showIf(tilleggsPensjonErRedusert and regelverkstype.isOneOf(AP2011, AP2016)) {
            paragraph {
                includePhrase(TilleggspensjonenBold)
                text(
        ...
        showIf(tilleggsPensjonErPgaYrkesskade and regelverkstype.isOneOf(AP2011, AP2016)) {
            paragraph {
                text(
        ...
        showIf(tilleggsPensjonErPgaUngUfoer and regelverkstype.isOneOf(AP2011, AP2016)) {
            paragraph {
                text(

...
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.arligAvkortningsbelopBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.arligAvkortningsbelopBTSB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.avkortningInntektsgrense
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.avkortningInntektstak
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.avkortningInntektstakBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.avkortningInntektstakBTSB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.avkortningsbelopPerAr
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.belopFratrukketAnnenForeldersInntektBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.belopOkt
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.belopRedusert
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.brukerBorINorge
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.brukersInntektBruktIAvkortningAvBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.ettArForVirkningstidspunkt
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.forventetInntekt
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.fribelopBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.borMed
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.fribelopBTSB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.gammeltBelop
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.antallBarnBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.antallBarnBTSB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.gammeltBelopBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.gammeltBelopBTSB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.grunnbelop
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.inntektAnnenForelderBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.inntektBruktIAvkortningAvBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.inntektBruktIAvkortningAvBTSB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.innvilgetBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.innvilgetBTSB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.innvilgetET
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.innvilgetGJT
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.instoppholdType
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.justeringsbelopPerArBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.justeringsbelopPerArBTSB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.kravarsaksType
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.maanedligUfoeretrygdFoerSkatt
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.nettoAkk
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.nettoBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.nettoBTSB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.nettoPerManed
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.nyttBelop
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.nyttBelopBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.nyttBelopBTSB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.orienteringOmRettigheterUfoere
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.pe
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.periodisertFribelopBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.periodisertFribelopBTSB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.periodisertInntektBTFB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.periodisertInntektBTSB
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.regelverktypeBT
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.totalNetto
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.totalNettoForAr
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.uforegrad
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.utbetalingsgrad
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.vilFylle67IlaVirkningFomAr
import no.nav.pensjon.brev.api.model.maler.ufoerApi.EndretUfoeretrygdPGAInntektDtoSelectors.virkningFom

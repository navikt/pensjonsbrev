...
data class TBU1286_2_Generated(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            ...
            textExpr(
                Bokmal to " blir ikke utbetalt fordi dere har en samlet inntekt som er høyere enn ".expr() + pe.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggfelles_avkortningsinformasjon_inntektstak().format(
                    true
                ) + " kroner. De samlede inntektene er over grensen for å få utbetalt barnetillegg.",
                Nynorsk to "blir ikkje utbetalt fordi dei har ei samla inntekt som er høgare enn ".expr() + pe.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggfelles_avkortningsinformasjon_inntektstak().format(
                    true
                ) + " kroner. Dei samla inntektene er over grensa for å få utbetalt barnetillegg.",

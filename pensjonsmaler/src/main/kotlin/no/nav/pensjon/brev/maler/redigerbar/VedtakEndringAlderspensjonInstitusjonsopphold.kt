...
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAlderspensjonInstitusjonsoppholdDtoSelectors.PesysDataSelectors.AlderspensjonVedVirkSelectors.regelverkType
...
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAlderspensjonInstitusjonsoppholdDtoSelectors.PesysDataSelectors.maanedligPensjonFoerSkattAlderspensjonDto
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAlderspensjonInstitusjonsoppholdDtoSelectors.PesysDataSelectors.orienteringOmRettigheterOgPlikterDto
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAlderspensjonInstitusjonsoppholdDtoSelectors.SaksbehandlerValgSelectors.alderspensjonRedusert
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAlderspensjonInstitusjonsoppholdDtoSelectors.SaksbehandlerValgSelectors.alderspensjonStanset
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAlderspensjonInstitusjonsoppholdDtoSelectors.SaksbehandlerValgSelectors.alderspensjonUnderOppholdIInstitusjon
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAlderspensjonInstitusjonsoppholdDtoSelectors.SaksbehandlerValgSelectors.alderspensjonUnderSoning
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAlderspensjonInstitusjonsoppholdDtoSelectors.SaksbehandlerValgSelectors.alderspensjonVedVaretektsfengsling
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAlderspensjonInstitusjonsoppholdDtoSelectors.SaksbehandlerValgSelectors.hvisEndringIPensjon
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAlderspensjonInstitusjonsoppholdDtoSelectors.SaksbehandlerValgSelectors.hvisEtterbetaling
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAlderspensjonInstitusjonsoppholdDtoSelectors.SaksbehandlerValgSelectors.hvisReduksjonTilbakeITid
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAlderspensjonInstitusjonsoppholdDtoSelectors.SaksbehandlerValgSelectors.informasjonOmSivilstandVedInstitusjonsopphold

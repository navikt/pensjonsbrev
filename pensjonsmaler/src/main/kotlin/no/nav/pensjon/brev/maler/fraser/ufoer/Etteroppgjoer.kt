...
data class Innledning(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            textExpr(
                Bokmal to "Vår beregning viser at du har fått ".expr() +
                    totaltAvvik.absoluteValue()
                        .format() + " kroner for mye utbetalt.",
                Nynorsk to "Utrekninga vår viser at du har fått utbetalt ".expr() +
                    totaltAvvik.absoluteValue()
                        .format() + " kroner for mykje.",
                English to "Our calculations show that you have received an overpayment of NOK ".expr() +
                    totaltAvvik.absoluteValue()
                        .format() + ".",
            )
        }

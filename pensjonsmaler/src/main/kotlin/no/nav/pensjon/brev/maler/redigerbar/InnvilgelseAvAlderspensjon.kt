    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            showIf(gjenlevendetilleggKap19Innvilget) {
                ...
                paragraph {
                    text(
                        bokmal { + "Du får " + totalPensjon.format() + " i alderspensjon og gjenlevendetillegg fra folketrygden hver måned før skatt fra " +
                                kravVirkDatoFom + "." },
                        nynorsk { + "Du får " + totalPensjon.format() + " i alderspensjon og attlevandetillegg frå folketrygda kvar månad før skatt frå " +
                                kravVirkDatoFom + "." },
                        english { + "You will receive " + totalPensjon.format() + " in retirement pension and survivor’s supplement from the National Insurance Scheme every month before tax from " +
                                kravVirkDatoFom + "." }
                    )
                    showIf(not(gjenlevendetilleggInnvilget)) {
                        text(
                            bokmal { + " Av dette er gjenlevendetillegget " + gjenlevendetilleggKap19.format() + "." },
                            nynorsk { + " Av dette er attlevandetillegget " + gjenlevendetilleggKap19.format() + "." },
                            english { + " Of this, the survivor’s supplement is " + gjenlevendetilleggKap19.format() + "." }
                        )
                    }
            ...
            showIf(harAvdod) {
                showIf(gjenlevenderettAnvendt and not(gjenlevendetilleggKap19Innvilget) and not(gjenlevendetilleggInnvilget)) {
                    paragraph {
                        text(
                            bokmal { + "I beregningen vår har vi tatt utgangspunkt i pensjonsrettigheter du har etter " + avdodNavn + ". Dette gir deg en høyere pensjon enn om vi bare hadde tatt utgangspunkt i din egen opptjening." },
                            nynorsk { + "I beregninga vår har vi teke utgangspunkt i pensjonsrettar du har etter " + avdodNavn + ". Dette gir deg ein høgare pensjon enn om vi berre hadde teke utgangspunkt i di eiga opptening." },
                            english { + "We have based the calculation on the pension rights you have after " + avdodNavn + ". This gives you a higher pension than if we had only based the calculation on your own earnings." }
                        )
                    }
                }
                ...
                showIf(gjenlevendetilleggKap19Innvilget) {
                    ...
                    paragraph {
                        text(
                            bokmal { + "Du får et gjenlevendetillegg i alderspensjonen fordi du har pensjonsrettigheter etter "
                                    + avdodNavn + "." },
                            nynorsk { + "Du får eit attlevandetillegg i alderspensjonen fordi du har pensjonsrettar etter "
                                    + avdodNavn + "." },
                            english { + "You receive a survivor’s supplement in retirement pension because you have pension rights after "
                                    + avdodNavn + "." }
                        )
                    }
                }
                showIf(gjenlevenderettAnvendt and gjenlevendetilleggKap19.greaterThan(0)) {
                    ...
                    paragraph {
                        text(
                            ...
                            english { + "The survivor's supplement will not be adjusted when the pension increases from 1 May every year." }
                        )
                    }
                }
                ...
                showIf(not(gjenlevenderettAnvendt) and not(gjenlevendetilleggKap19Innvilget) and not(gjenlevendetilleggInnvilget)) {
                    ...
                    paragraph {
                        text(
                            bokmal { + "I beregningen vår har vi tatt utgangspunkt i din egen opptjening. Dette gir deg en høyere pensjon enn om vi hadde tatt utgangspunkt i pensjonsrettighetene du har etter "
                                    + avdodNavn + "." },
                            nynorsk { + "I vår berekning har vi teke utgangspunkt i di eiga opptening. Dette gir deg ein høgare pensjon enn om vi hadde teke utgangspunkt i pensjonsrettane du har etter "
                                    + avdodNavn + "." },
                            english { + "We have based our calculation on your own earnings. This gives you a higher pension than if we had based it on the pension rights you have after "
                                    + avdodNavn + "." }
                        )
                    }
                }
            ...
            showIf(
                ...
                paragraph {
                    text(
                        bokmal { + "Du har ikke vært medlem i folketrygden i minst 20 år. Da har du ikke rett til å få utbetalt hele alderspensjonen din når du bor i "
                                + faktiskBostedsland + "." },
                        nynorsk { + "Du har ikkje vore medlem i folketrygda i minst 20 år. Da har du ikkje rett til å få utbetalt heile alderspensjonen din når du bur i "
                                + faktiskBostedsland + "." },
                        english { + "You have not been a member of the National Insurance Scheme for at least 20 years. You are therefore not eligible for a full retirement pension while living in "
                                + faktiskBostedsland + "." }
                    )
                }
            }
            ...
            showIf(
                ...
                paragraph {
                    text(
                        bokmal { + "Verken du eller avdøde har vært medlem i folketrygden i minst 20 år. Da har du ikke rett til å få utbetalt hele alderspensjonen din når du når du bor i "
                                + faktiskBostedsland + "." },
                        nynorsk { + "Verken du eller avdøde har vore medlem i folketrygda i minst 20 år. Da har du ikkje rett til å få utbetalt heile alderspensjonen din når du bur i "
                                + faktiskBostedsland + "." },
                        english { + "Neither you nor the deceased have been a member of the National Insurance Scheme for at least 20 years. You are therefore not eligible for a full retirement pension while living in "
                                + faktiskBostedsland + "." }
                    )
                }
            }

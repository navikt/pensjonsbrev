...
import no.nav.pensjon.brev.api.model.vedlegg.Tilbakekreving
...
data class TabellFeilutbetalingerMaanedsbeloep(
    val aar: Expression<Year>,
    val tilbakekrevingPerAar:Expression<List<Tilbakekreving>,
    val maaned: Expression<String>,
    val tilbakekrevingPerMaaned: Expression<List<Tilbakekreving>,

    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
		...
		paragraph {
			text (
				...
				english { + "You have been working more than 50 percent over a long period after turning 26. Your application for disability benefit was submitted after you turned 36. Therefore, you do not meet the criteria." },
			)
		}
    }
}

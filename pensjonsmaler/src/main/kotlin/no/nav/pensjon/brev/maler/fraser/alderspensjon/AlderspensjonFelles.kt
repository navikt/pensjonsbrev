...
object Skatteplikt : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        paragraph {
            text(
                bokmal { + "Spørsmål om skatteplikt til Norge etter flytting til utlandet må rettes til Skatteetaten." +
...
data class InnvilgelseAPUttakEndr(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal { + "Du kan ha mulighet til å ta ut 20, 40, 50, 60, 80 eller 100 prosent alderspensjon." +
                ...
                nynorsk { + "Du kan ha høve til å ta ut 20, 40, 50, 60, 80 eller 100 prosent alderspensjon." +
                ...
                english { + "You are entitled to draw retirement pension at a rate of 20, 40, 50, 60, 80 or 100 percent." +

...
data class TBU3301_Generated(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorsk, Unit>.template() {
		...
		paragraph {
			...
			textExpr (
				Bokmal to "i ".expr() + pe.ut_uforetrygdetteroppgjor_periodefom_year().format() + ". Resultatet av etteroppgjøret viser at du har fått " + pe.ut_avviksbeloputenminus().format() + " for lite i ",
				Nynorsk to "i ".expr() + pe.ut_uforetrygdetteroppgjor_periodefom_year().format() + ". Resultatet av etteroppgjeret viser at du har fått " + pe.ut_avviksbeloputenminus().format() + " for lite i ",
			)

...
object AvslagUfoeretrygd : RedigerbarTemplate<AvslagUfoeretrygdDto> {
    ...
    override val template =
        createTemplate(
            name = kode.name,
            letterDataType = AvslagUfoeretrygdDto::class,
            ...
            outline {
                ...
                showIf(
                    (
                        pe.vedtaksdata_kravhode_kravgjelder().notEqualTo("sok_uu") and
                            pe.vedtaksdata_kravhode_kravgjelder()
                                .notEqualTo("sok_ys") and
                            pe.vedtaksdata_kravhode_kravarsaktype()
                                .notEqualTo("endring_ifu") and
                            pe.vedtaksdata_kravhode_kravlinjeliste_kravlinje_kravlinjetype().equalTo(
                                "ut",
                ...
                showIf(pe.vedtaksdata_kravhode_kravgjelder().equalTo("sok_okn_ug")) {
                    ...
                    paragraph {
                        textExpr(
                            Bokmal to "Vi har avslått søknaden din om økt uføretrygd som vi mottok ".expr() +
                                pe.vedtaksdata_kravhode_kravmottatdato()
                                    .format() + ".",
                            Nynorsk to "Vi har avslått søknaden din om auka uføretrygd som vi fekk ".expr() +
                                pe.vedtaksdata_kravhode_kravmottatdato()
                                    .format() + ".",
                            English to "We have denied your application for increased disability benefit, which we received on ".expr() +
                                pe.vedtaksdata_kravhode_kravmottatdato()
                                    .format() + ".",
                        )
                    }
                ...
                showIf(pe.vedtaksdata_kravhode_kravgjelder().equalTo("sok_ys")) {
                    ...
                    paragraph {
                        textExpr(
                            Bokmal to "Vi har avslått søknaden din om særbestemmelser for yrkesskade eller yrkessykdom i uføretrygden, som vi mottok ".expr() +
                                pe.vedtaksdata_kravhode_kravmottatdato()
                                    .format() + ".",
                            Nynorsk to "Vi har avslått søknaden din om særreglar for yrkesskade eller yrkessjukdom i uføretrygda som vi fekk ".expr() +
                                pe.vedtaksdata_kravhode_kravmottatdato()
                                    .format() + ".",
                            English to "We have denied your application for special rules pertaining to occupational injury or occupational illness to be applied to your disability benefit, which we received on ".expr() +
                                pe.vedtaksdata_kravhode_kravmottatdato()
                                    .format() + ".",
                        )
                    }
                ...
                showIf(pe.vedtaksdata_kravhode_kravgjelder().equalTo("sok_uu")) {
                    ...
                    paragraph {
                        textExpr(
                            Bokmal to "Vi har avslått søknaden din om rettighet som ung ufør som vi mottok ".expr() +
                                pe.vedtaksdata_kravhode_kravmottatdato()
                                    .format() + ".",
                            Nynorsk to "Vi har avslått søknaden din om rett som ung ufør som vi fekk ".expr() +
                                pe.vedtaksdata_kravhode_kravmottatdato()
                                    .format() + ".",
                            English to "We have denied your application to be granted rights as a young disabled person, which we received on ".expr() +
                                pe.vedtaksdata_kravhode_kravmottatdato()
                                    .format() + ".",
                        )
                    }
                ...
                showIf(pe.vedtaksdata_kravhode_kravarsaktype().equalTo("endring_ifu")) {
                    ...
                    paragraph {
                        textExpr(
                            Bokmal to "Vi har avslått søknaden din om å endre den fastsatte inntekten din før du ble ufør, som vi mottok ".expr() +
                                pe.vedtaksdata_kravhode_kravmottatdato()
                                    .format() + ".",
                            Nynorsk to "Vi har avslått søknaden din om å endre den fastsette inntekta di før du blei ufør, som vi fekk ".expr() +
                                pe.vedtaksdata_kravhode_kravmottatdato()
                                    .format() + ".",
                            English to "We have denied your application to change your determined income prior to your disability, which we received on ".expr() +
                                pe.vedtaksdata_kravhode_kravmottatdato()
                                    .format() + ".",
                        )
                    }
                ...
                showIf(
                    (
                        (
                            ...
                            (
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigbehandlingresultat().equalTo(
                                    "ikke_oppfylt",
                                ) or
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigarbeidsrettedetiltakresultat().equalTo(
                                        "ikke_oppfylt",
                                    ) or
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_sykdomskadelyteresultat()
                                        .equalTo("ikke_oppfylt") or
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevneresultat()
                                        .equalTo("ikke_oppfylt")
                            ) or (
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_forutgaendemedlemskapresultat().equalTo(
                                    "ikke_oppfylt",
                                ) and not(pe.vedtaksdata_kravhode_vurderetrygdeavtale())
                            )
                        ) and
                            ...
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigbehandlingbegrunnelse().notEqualTo(
                                "stdbegr_12_5_1_i_3",
                            ) and
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigarbeidsrettedetiltakbegrunnelse().notEqualTo(
                                "stdbegr_12_5_2_i_3",
                ...
                showIf(
                    (
                        pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigbehandlingbegrunnelse()
                            .equalTo("stdbegr_12_5_2_i_3") or
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigarbeidsrettedetiltakbegrunnelse()
                                .equalTo("stdbegr_12_5_2_i_3") or
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_sykdomskadelytebegrunnelse().equalTo(
                                "stdbegr_12_5_2_i_3",
                            )
                    ),
                ) {
                ...
                showIf(
                    (
                        pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_forutgaendemedlemskapresultat().equalTo("ikke_oppfylt") and
                            not(
                    ...
                    paragraph {
                        textExpr(
                            Bokmal to "Du flyttet til Norge <FRIKTEKST: siste innflyttingsdato til Norge>, og ble da medlem av folketrygden. Vi har fastsatt uføretidspunktet ditt til ".expr() +
                                uforetidspunkt
                                    .format() + ". Da ble inntektsevnen din varig nedsatt med minst ",
                            Nynorsk to "Du flytta til Noreg <FRITEKST: siste innflyttingsdato til Norge>, og blei då medlem av folketrygda. Vi har fastsett uføretidspunktet ditt til ".expr() +
                                uforetidspunkt
                                    .format() + ". Då blei inntektsevna di varig sett ned med minst ",
                            English to "You moved to Norway on <FRITEKST: siste innflyttingsdato til Norge>, and you have national insurance coverage from that date. We have determined your date of disability to be ".expr() +
                                uforetidspunkt
                ...
                showIf(
                    (
                        pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_fortsattmedlemsskapresultat()
                            .equalTo("ikke_oppfylt") and
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_forutgaendemedlemskapresultat()
                    ...
                    paragraph {
                        textExpr(
                            Bokmal to "Vi har satt uføretidspunktet ditt til ".expr() +
                                uforetidspunkt
                                    .format() + ". Da ble inntektsevnen din varig nedsatt med minst ",
                            Nynorsk to "Vi har sett uføretidspunktet ditt til ".expr() +
                                uforetidspunkt
                                    .format() + ". Då blei inntektsevna di varig sett ned med minst ",
                            English to "We have determined your date of disability to be ".expr() +
                                uforetidspunkt
                                    .format() + ". Your earning ability then became permanently reduced by at least ",
                        )
                ...
                showIf(
                    (
                        pe.vedtaksdata_kravhode_vurderetrygdeavtale() and (
                            pe.vedtaksdata_kravhode_kravgjelder()
                                .equalTo("f_bh_bo_utland") or
                                pe.vedtaksdata_kravhode_kravgjelder()
                                    .equalTo("mellombh")
                        ) and
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_forutgaendemedlemskapresultat().equalTo(
                ...
                showIf((pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_alderresultat().equalTo("ikke_oppfylt"))) {
                    ...
                    showIf((pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_alderbegrunnelse().equalTo("stdbegr_12_4_1_i_2"))) {
                        ...
                        paragraph {
                            textExpr(
                                Bokmal to "Når du søker om uføretrygd mellom fylte 62 og 67 år, må din pensjonsgivende inntekt ha vært minst folketrygdens grunnbeløp i året før uføretidspunktet. Hvis du ikke oppfyller dette vilkåret, må du ha tjent minst tre ganger folketrygdens grunnbeløp i løpet av de tre siste årene før dette tidspunktet. Grunnbeløpet utgjør ".expr() +
                ...
                showIf(
                    (
                        pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigbehandlingresultat()
                            .equalTo("ikke_oppfylt") and
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigarbeidsrettedetiltakresultat()
                                .equalTo("ikke_oppfylt") and
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigbehandlingbegrunnelse().equalTo(
                                "stdbegr_12_5_1_i_1",
                            ) and pe.vedtaksdata_kravhode_kravlinjeliste_kravlinje_kravlinjetype().equalTo("ut") and
                            pe.vedtaksdata_kravhode_kravgjelder()
                    ...
                    (
                        pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigbehandlingresultat()
                            ...
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigarbeidsrettedetiltakresultat()
                                .equalTo("ikke_oppfylt") and
                            pe.vedtaksdata_kravhode_kravgjelder()
                                .equalTo("sok_okn_ug") and
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigarbeidsrettedetiltakbegrunnelse().equalTo(
                                "stdbegr_12_5_2_i_1",
                            )
                    ),
                ) {
                ...
                showIf(
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_sykdomskadelytebegrunnelse()
                                .equalTo("stdbegr_12_6_1_i_1") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigarbeidsrettedetiltakresultat()
                                    .equalTo("oppfylt") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigbehandlingresultat().equalTo(
                                    "oppfylt",
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_sykdomskadelytebegrunnelse()
                                .equalTo("stdbegr_12_6_1_i_2") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigarbeidsrettedetiltakresultat()
                                    .equalTo("oppfylt") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_hensiktsmessigbehandlingresultat().equalTo(
                                    "oppfylt",
                ...
                showIf(
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse()
                                .equalTo("stdbegr_12_7_2_i_2") or
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse()
                                    .equalTo("stdbegr_12_7_2_i_3") or
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse().notEqualTo(
                                    "",
                                )
                        ),
                    ) {
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse()
                                .notEqualTo("") and pe.vedtaksdata_kravhode_kravarsaktype().notEqualTo("endring_ifu") and
                                pe.vedtaksdata_kravhode_kravgjelder()
                                    .notEqualTo("sok_uu") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_yrkesskadebegrunnelse().notEqualTo(
                                    "stdbegr_12_17_1_i_1",
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse()
                                .equalTo("stdbegr_12_7_2_i_2") and
                                pe.vedtaksdata_kravhode_kravarsaktype()
                                    .notEqualTo("endring_ifu") and pe.vedtaksdata_kravhode_kravgjelder().notEqualTo("sok_uu") and
                                pe.vedtaksdata_kravhode_kravgjelder()
                                    .notEqualTo("sok_ys")
                        ),
                    ) {
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse()
                                .equalTo("stdbegr_12_7_2_i_3") and
                                pe.vedtaksdata_kravhode_kravarsaktype()
                                    .notEqualTo("endring_ifu") and
                                pe.vedtaksdata_kravhode_kravgjelder()
                                    .notEqualTo("sok_uu") and
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_kravhode_kravgjelder()
                                .equalTo("sok_okn_ug") and (
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse().equalTo(
                                    "stdbegr_12_7_1_i_2",
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse()
                                ...
                                pe.vedtaksdata_kravhode_kravgjelder()
                                    .notEqualTo("sok_ys") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_alderresultat().equalTo(
                                    "oppfylt",
                                )
                        ),
                    ) {
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse()
                                .notEqualTo("") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_yrkesskadebegrunnelse()
                                    .notEqualTo("stdbegr_12_17_1_i_1") and
                            ...
                            textExpr(
                                Bokmal to "Inntekten din før du ble ufør er fastsatt til ".expr() +
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_ifuinntekt()
                                        .format() + " kroner. <FRITEKST: begrunnelse for fastsatt IFU>. Oppjustert til dagens verdi tilsvarer dette en inntekt på <FRITEKST: Oppjustert ifu> kroner. Du har en inntekt på " +
                                ...
                                Nynorsk to "Inntekta di før du blei ufør, er fastsett til ".expr() +
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_ifuinntekt()
                                        .format() + " kroner. <FRITEKST: begrunnelse for fastsatt IFU>. Oppjustert til dagens verdi svarer dette til ei inntekt på <FRITEKST: Oppjustert ifu> kroner. Du har ei inntekt på " +
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_ieuinntekt()
                                ...
                                English to "Your income prior to your disability was determined as NOK ".expr() +
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_ifuinntekt()
                                        .format() + ". <FRITEKST: begrunnelse for fastsatt IFU>. Adjusted to current value, this is equivalent to an income of NOK <FRITEKST: Oppjustert ifu>. Your current income is NOK " +
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_ieuinntekt()
                    ...
                    showIf(
                        ...
                        paragraph {
                            textExpr(
                                ...
                                Nynorsk to "Inntekta di før du blei ufør, er fastsett til ".expr() +
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_ifuinntekt()
                                        .format() + " kroner. <FRITEKST: begrunnelse for fastsatt IFU>. Oppjustert til dagens verdi svarer dette til ei inntekt på <FRITEKST: Oppjustert ifu> kroner. Det er dokumentert at du har moglegheiter for å skaffe inntekter som du ikkje nyttar, og desse tek vi med når vi fastset inntekta di etter at du blei ufør. Inntekta di etter at du blei ufør, er fastsett til " +
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_ieuinntekt()
                ...
                showIf(
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_kravhode_kravgjelder().equalTo("sok_okn_ug") or
                                pe.vedtaksdata_kravhode_kravlinjeliste_kravlinje_kravlinjetype()
                                    .equalTo("ut")
                        ) and (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse().equalTo(
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_kravhode_kravlinjeliste_kravlinje_kravlinjetype()
                                .equalTo("ut") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse()
                                    .notEqualTo("") and pe.vedtaksdata_kravhode_kravgjelder().notEqualTo("sok_ys") and
                                pe.vedtaksdata_kravhode_kravgjelder()
                                    .notEqualTo("sok_uu") and pe.vedtaksdata_kravhode_kravarsaktype().notEqualTo("endring_ifu") and
                                pe.vedtaksdata_kravhode_kravgjelder()
                                    .notEqualTo("sok_okn_ug") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_alderresultat().equalTo(
                                    "oppfylt",
                                ) and (
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse()
                                .notEqualTo("") and
                                pe.vedtaksdata_kravhode_kravlinjeliste_kravlinje_kravlinjetype()
                                    .equalTo("ut") and pe.vedtaksdata_kravhode_kravgjelder().notEqualTo("sok_ys") and
                                pe.vedtaksdata_kravhode_kravgjelder()
                                    .notEqualTo("sok_uu") and pe.vedtaksdata_kravhode_kravarsaktype().notEqualTo("endring_ifu") and
                                pe.vedtaksdata_kravhode_kravgjelder()
                                    .notEqualTo("sok_okn_ug") and
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse()
                                .notEqualTo("") and pe.vedtaksdata_kravhode_kravgjelder().equalTo("sok_okn_ug") and
                                pe.vedtaksdata_kravhode_kravgjelder()
                                    .notEqualTo("sok_ys") and (
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_yrkesskaderesultat()
                                        .equalTo("ikke_vurdert") or pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_yrkesskaderesultat().equalTo("")
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevnebegrunnelse()
                                ...
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_yrkesskaderesultat()
                                    .equalTo("oppfylt") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_yrkesskadegrad()
                                    .lessThan(30) and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_yrkesskadegrad()
                                    .greaterThan(0) and
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevneresultat()
                                .equalTo("ikke_oppfylt") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_yrkesskadebegrunnelse()
                                    .equalTo("stdbegr_12_17_1_o_2") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_yrkesskadegrad().lessThan(
                                    30,
                                ) and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_yrkesskadegrad()
                                    .greaterThan(0) and
                                pe.vedtaksdata_beregningsdata_beregninguforeperiode_uforetrygdberegning_uforegrad()
                        ...
                        paragraph {
                            textExpr(
                                Bokmal to "Du har en godkjent yrkesskade eller yrkessykdom. Vi har vurdert at ".expr() +
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_yrkesskadegrad()
                                ...
                                Nynorsk to "Du har ein godkjend yrkesskade eller yrkessjukdom. Vi har vurdert det slik at ".expr() +
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_yrkesskadegrad()
                                ...
                                English to "You have a certified occupational injury or occupational illness. We have concluded that ".expr() +
                                    pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_yrkesskadegrad()
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_nedsattinntektsevneresultat()
                                ...
                                pe.vedtaksdata_kravhode_kravgjelder()
                                    .notEqualTo("sok_ys") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_yrkesskadebegrunnelse().equalTo(
                                    "stdbegr_12_17_1_o_2",
                                ) and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_yrkesskadegrad()
                ...
                showIf(
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_kravhode_kravgjelder().equalTo("sok_ys") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_yrkesskadebegrunnelse()
                                    .equalTo(
                                        "stdbegr_12_17_1_i_1",
                                    )
                    ...
                    showIf(
                        (
                            pe.vedtaksdata_kravhode_kravgjelder().equalTo("sok_uu") and
                                pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_unguforbegrunnelse()
                                    .notEqualTo(
                                        "",

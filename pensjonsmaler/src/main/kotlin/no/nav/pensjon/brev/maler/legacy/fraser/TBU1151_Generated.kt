    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
		...
		paragraph {
			text (
				...
				english { + "To be granted rights as a young disabled person, you must have become disabled before turning 26 due to a serious and permanent illness or injury, which has been clearly documented." },
			)
			text (
				...
				english { + "You do not meet the criteria regarding rights as a young disabled person, because it has not been documented that you had a serious and permanent illness before you turned 26. <FRITEKST: konkret begrunnelse>." },
			)
		}
    }
}

...
class ProductionTemplatesTest {
    ...
    fun `alle autobrev fins i templates`() {
        val brukteKoder = ProductionTemplates.hentAutobrevmaler().map { it.template.kode }
    ...
    fun `alle redigerbare brev fins i templates`() {
        val brukteKoder = ProductionTemplates.hentRedigerbareMaler().map { it.template.kode }

...
class ProductionTemplatesTest {
    ...
    fun `alle autobrev fins i production templates`() {
        ...
        val ubrukteKoder = (Pesysbrevkoder.AutoBrev.entries + Ufoerebrevkoder.AutoBrev.entries).filterNot { brukteKoder.contains(it) }
    ...
    fun `alle redigerbare brev fins i production templates`() {
        ...
        val ubrukteKoder = (Pesysbrevkoder.Redigerbar.entries + Ufoerebrevkoder.Redigerbar.entries).filterNot { brukteKoder.contains(it) }

...
fun createUfoerOmregningEnsligDto() =
    UfoerOmregningEnsligDto(
        ...
        avdoed =
            UfoerOmregningEnsligDto.Avdoed(
                navn = "Avdod Person",
        ...
        ufoeretrygdVedVirk =
            UfoerOmregningEnsligDto.UfoeretrygdVedVirk(
        ...
        inntektFoerUfoerhetVedVirk =
            UfoerOmregningEnsligDto.InntektFoerUfoerhetVedVirk(
        ...
        bruker =
            UfoerOmregningEnsligDto.Bruker(
                borIAvtaleLand = false,
                borINorge = true,
            ),
        barnetilleggSaerkullsbarnVedVirk =
            UfoerOmregningEnsligDto.BarnetilleggSaerkullsbarnVedvirk(
                beloep = Kroner(0),

...
private fun createUforetrygdEtteroppgjorDetaljBruker() =
    UforetrygdEtteroppgjorDetaljBruker(
...
private fun createUforetrygdEtteroppgjorDetaljEps() =
    UforetrygdEtteroppgjorDetaljEPS(
        inntektliste = createInntektsListe(),
        fratrekkListe = createFratrekkListe(),
...
private fun createFratrekkListe() =
    FratrekkListe(
        inntektsgrunnlag =
            listOf(
                createInntektsgrunnlag(),
...
private fun createInntektsgrunnlag(): Inntektsgrunnlag =
    Inntektsgrunnlag(
...
private fun createTrygdetidsgrunnlagBilateral() =
...
private fun createTtUtlandTrygdeavtale(): TTutlandTrygdeavtale =
...
fun createBarnetilleggFellesYK() =
    BarnetilleggFellesYK(
        belopgammelbtfb = Kroner(5850),
        belopnybtfb = Kroner(5851),
    )

fun createBarnetilleggSerkullYK() =
    BarnetilleggSerkullYK(
        belopgammelbtsb = Kroner(5140),
        belopnybtsb = Kroner(5141),
    )

fun createUforetrygdOrdinerYK() =
    UforetrygdOrdinerYK(
    ...
    Gjenlevendetillegg(
        ...
        gjenlevendetillegginformasjon =
            GjenlevendetilleggInformasjon(
                ...
                beregningsgrunnlagavdodordiner =
                    BeregningsgrunnlagAvdodOrdiner(
...
private fun createOpptjeningUt(): OpptjeningUT =
    OpptjeningUT(

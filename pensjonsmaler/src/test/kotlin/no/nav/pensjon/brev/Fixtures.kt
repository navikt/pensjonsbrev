...
import no.nav.pensjon.brev.fixtures.createVarselOpphoerMedHvilendeRettDto
...
object Fixtures {
    ...
    fun <T : Any> create(letterDataType: KClass<T>): T =
        when (letterDataType) {
            ...
            VarselOpphoerMedHvilendeRettDto::class -> createVarselOpphoerMedHvilendeRettDto() as T

...
export const mapP1DtoToForm = (p1: P1Redigerbar): P1RedigerbarForm => ({
  ...
  innvilgedePensjoner: p1.innvilgedePensjoner.map(mapInnvilgetDtoToForm),
  avslaattePensjoner: p1.avslaattePensjoner.map(mapAvslaattDtoToForm),
...
export const mapP1FormToDto = (form: P1RedigerbarForm): P1Redigerbar => ({
  ...
  innvilgedePensjoner: form.innvilgedePensjoner.map(mapInnvilgetFormToDto),
  avslaattePensjoner: form.avslaattePensjoner.map(mapAvslaattFormToDto),

...
import { type Control, Controller, type UseFormRegister, useFormState } from "react-hook-form";
  ...
  return (
    <Table.Row>
      ...
      <Table.DataCell className={hasInstitusjonError ? "p1-cell-error" : ""}>
        ...
        />
        <TextField
          data-e2e={`innvilget-${index}-institusjonsnavn`}
        ...
        />
        <TextField
          data-e2e={`innvilget-${index}-saksnummer`}
        ...
        <Controller
          ...
          render={({ field: dateField, fieldState }) => (
            <ManagedDatePicker
              data-e2e={`innvilget-${index}-datoForVedtak`}
              dateField={dateField}
      ...
      <Table.DataCell className={rowErrors?.pensjonstype ? "p1-cell-error" : ""}>
        <Controller
          ...
          render={({ field: radioField, fieldState }) => (
            <RadioGroup
              data-e2e={`innvilget-${index}-pensjonstype`}
      ...
      <Table.DataCell className={rowErrors?.datoFoersteUtbetaling ? "p1-cell-error" : ""}>
        <Controller
          ...
          render={({ field: dateField, fieldState }) => (
            <ManagedDatePicker
              data-e2e={`innvilget-${index}-datoFoersteUtbetaling`}
              dateField={dateField}
              fieldState={fieldState}
              label="Dato"
            />
      ...
      <Table.DataCell className={`cell-seamless ${rowErrors?.utbetalt ? "p1-cell-error" : ""}`}>
        <Textarea
          ...
          data-e2e={`innvilget-${index}-utbetalt`}

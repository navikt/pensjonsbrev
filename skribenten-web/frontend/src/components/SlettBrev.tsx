  ...
  return (
    ...
    >
      <Modal.Body>
        <BodyLong>
          {!slett.isSuccess
            ? (properties.texts?.body ??
              "Brevet vil bli slettet, og du kan ikke angre denne handlingen. Hvis brevet allerede er journalført, må du huske å følge rutinen for feilregistrering av journalpost.")

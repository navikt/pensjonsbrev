  ...
  describe("overskrift", () => {
    describe("manuelt", () => {
      it("toggler av/på", () => {
        ...
        cy.getDataCy("typography-select").contains("Overskrift (alt/option+1)").should("be.selected");
        cy.getDataCy("typography-select").select("Normal (alt/option+3)");
        cy.getDataCy("typography-select").contains("Normal (alt/option+3)").should("be.selected");
        cy.contains("title1").should("have.css", "font-size", "16.5px");
        cy.getDataCy("typography-select").select("Overskrift (alt/option+1)");
        cy.getDataCy("typography-select").contains("Overskrift (alt/option+1)").should("be.selected");
  ...
  describe("underoverskrift", () => {
    describe("manuelt", () => {
      it("toggler av/på", () => {
        ...
        cy.getDataCy("typography-select").contains("Underoverskrift (alt/option+2)");
        cy.getDataCy("typography-select").select("Normal (alt/option+3)");
        cy.getDataCy("typography-select").contains("Normal (alt/option+3)").should("be.selected");
        cy.contains("title2").should("have.css", "font-size", "16.5px");
        cy.getDataCy("typography-select").select("Underoverskrift (alt/option+2)");
        cy.getDataCy("typography-select").contains("Underoverskrift (alt/option+2)").should("be.selected");
  ...
  describe("normal", () => {
    ...
    describe("shortcut", () => {
      it("toggler av/på", () => {
        ...
        cy.getDataCy("typography-select").contains("Overskrift (alt/option+1)").should("be.selected");
        cy.contains("paragraph").should("have.css", "font-size", "19.5px");
        cy.contains("paragraph").type("{alt}3");
        cy.getDataCy("typography-select").contains("Normal (alt/option+3)").should("be.selected");
        cy.contains("paragraph").should("have.css", "font-size", "16.5px");
      });
      it("caret holder seg i samme posisjon ved toggle", () => {

...
const testBackend = async () => {
  ...
  // await fetch(`${SKRIBENTEN_BACKEND_BASE_PATH}/lettertemplates/UFOREP`);
  // await fetch(`${SKRIBENTEN_BACKEND_BASE_PATH}/foretrukketSpraak/01520276730`);
  // await fetch(`${SKRIBENTEN_BACKEND_BASE_PATH}/adresse/01520276730`);
};

...
\newlength{\spacebetweentitles}
\setlength{\spacebetweentitles}{3pt}

%extra space is added between title and non title elements          %if previous element was title   % if previous was not title
\newcommand{\spaceabovetitle}{\ifdefstring{\previouselement}{title}{\addvspace{\spacebetweentitles}}{\pagebreak[3]\addvspace{\spacebetweentitleandnontitle}}}
...
% Title 3
\newcommand{\lettersectiontitlethree}[1]{\lettersectiontitle{\titlethree #1}\setpreviouselement{title}}
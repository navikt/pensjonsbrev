...
\setlength{\spacebetweentitleandnontitle}{\dimexpr(32pt-\parskip) plus 10 pt minus 10 pt}

\newcommand{\lettersectiontitlespacing}[1]{
    \ifdefstring{\previouselement}{title}{par}{}
}
...
\newcommand{\lettersectiontitle}[1]{
    ...
    \ifdefstring{\previouselement}{title}{}{\addvspace{\spacebetweentitleandnontitle}}
    #1
    \nopagebreak

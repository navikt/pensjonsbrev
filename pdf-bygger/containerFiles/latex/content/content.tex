...
% macro for å erstatte hyphen symbol med symbol fra annen font (åpen font inkludert i latex)
% vurder å bytte ut denne implementasjonen med url-tagging (hyperref/accsup)
\begingroup
  \catcode`\-=13
  \gdef\StartMinusErstatning{%
    \catcode`\-=13
    \def-{\leavevmode\hbox{\fontencoding{OT1}\fontfamily{cmr}\selectfont\char45}}
  }
  \gdef\StopMinusErstatning{\catcode`\-=12}
\endgroup

...
import no.nav.pensjon.brev.api.model.maler.auto.AFPPrivateBeregningSelectors.totalPensjon
import no.nav.pensjon.brev.api.model.maler.auto.OpptjeningInfoSelectors.antallAarEndretOpptjening
import no.nav.pensjon.brev.api.model.maler.auto.OpptjeningInfoSelectors.endretOpptjeningsAar
import no.nav.pensjon.brev.api.model.maler.auto.OpptjeningInfoSelectors.sisteGyldigeOpptjeningsAar
...
import no.nav.pensjon.brev.api.model.maler.auto.VedtakEndringAFPEndretOpptjeningAutoDtoSelectors.afpPrivatBeregningGjeldende
import no.nav.pensjon.brev.api.model.maler.auto.VedtakEndringAFPEndretOpptjeningAutoDtoSelectors.afpPrivateBeregningVedVirk
import no.nav.pensjon.brev.api.model.maler.auto.VedtakEndringAFPEndretOpptjeningAutoDtoSelectors.belopEndring
import no.nav.pensjon.brev.api.model.maler.auto.VedtakEndringAFPEndretOpptjeningAutoDtoSelectors.endretOpptjening
import no.nav.pensjon.brev.api.model.maler.auto.VedtakEndringAFPEndretOpptjeningAutoDtoSelectors.opptjeningType
import no.nav.pensjon.brev.api.model.maler.auto.VedtakEndringAFPEndretOpptjeningAutoDtoSelectors.virkFom
    ...
    override val template =
        createTemplate(
            ...
            outline {
                ...
                // TODO - vedleggene
                // TODO - includePhrase(RettTilAAKlage(vedlegg = brev.felles.dineRettigheterOgMulighetTilAaKlagePensjonStatisk))
                // TODO - includePhrase(RettTilInnsyn(vedlegg = brev.felles.rettTilInnsyn))

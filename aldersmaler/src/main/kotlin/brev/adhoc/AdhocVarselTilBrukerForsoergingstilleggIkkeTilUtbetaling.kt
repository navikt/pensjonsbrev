...
import brev.felles.Constants.FORSOERGINGSTILLEGG_URL
...
object AdhocVarselTilBrukerForsoergingstilleggIkkeTilUtbetaling : AutobrevTemplate<EmptyBrevdata> {
    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            paragraph {
                text(
                    bokmal { +"Hvis du ikke finner frem på $NAV_URL, kan du ringe oss på telefon $NAV_KONTAKTSENTER_TELEFON_PENSJON, hverdager $NAV_KONTAKTSENTER_AAPNINGSTID." },

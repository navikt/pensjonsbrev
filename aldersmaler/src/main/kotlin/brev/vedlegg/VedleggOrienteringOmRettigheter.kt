...
import brev.felles.Constants.FULLMAKT_URL
import brev.felles.Constants.KLAGE_URL
...
object VedleggInnsynSakUfoeretrygdPesys : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal {
                    +"Med få unntak har du rett til å se dokumentene i saken din. Du kan logge deg inn via $NAV_URL for å se dokumenter i saken din. Du kan også ringe oss på telefon $NAV_KONTAKTSENTER_TELEFON."
                },
                nynorsk {
                    +"Med få unntak har du rett til å sjå dokumenta i saka di. Du kan logge deg inn via $NAV_URL for å sjå dokumenter i saka di. Du kan også ringje oss på telefon $NAV_KONTAKTSENTER_TELEFON."
                },
                english {
                    +"With some exceptions, you are entitled to access the documents relating to your case. Log on to $NAV_URL to review the documents in connection with your case. You can also call us at telephone +47 $NAV_KONTAKTSENTER_TELEFON."
                },
            )
        }
    }
...
object VedleggInnsynSakUfoeretrygdPesysNoenDokumenter : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal {
                    +"Med få unntak har du rett til å se dokumentene i saken din. Du kan se noen dokumenter på $DITT_NAV. Du kan også ringe oss på telefon " +
                        felles.avsenderEnhet.telefonnummer.format() +
                        "."
                },
                nynorsk {
                    +"Med få unntak har du rett til å sjå dokumenta i saka di. Du kan sjå nokre dokument på $DITT_NAV. Du kan også ringe oss på telefon " +
                        felles.avsenderEnhet.telefonnummer.format() +
                        "."
                },
                english {
                    +"With some exceptions, you are entitled to access all the documents pertaining to your case. You can read some of the documents at $DITT_NAV. You can also call us at tel.: " +
                        felles.avsenderEnhet.telefonnummer.format() +
                        "."
                },
            )
...
object VedleggHjelpFraAndre : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal {
                    +"Du kan be om hjelp fra andre under hele saksbehandlingen, for eksempel av advokat, rettshjelper, en organisasjon du er medlem av eller en annen myndig person. Hvis den som hjelper deg ikke er advokat, må du gi denne personen en skriftlig fullmakt. Bruk gjerne skjemaet du finner på $FULLMAKT_URL."
                },
                nynorsk {
                    +"Du kan be om hjelp frå andre under heile saksbehandlinga, for eksempel av advokat, rettshjelpar, ein organisasjon du er medlem av, eller ein annan myndig person. Dersom den som hjelper deg, ikkje er advokat, må du gi denne personen ei skriftleg fullmakt. Bruk gjerne skjemaet du finn på $FULLMAKT_URL."
                },
                english {
...
data class VedleggKlagePaaVedtaket(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal {
                    +"Klagen må inneholde navn, fødselsnummer og adresse. Bruk gjerne skjemaet som du finner på $KLAGE_URL. Trenger du hjelp, er du velkommen til å ringe oss på telefon " +
                        telefonnummer.format() +
                        "."
                },
                nynorsk {
                    +"Klaga må innehalde namn, fødselsnummer og adresse. Bruk gjerne skjemaet som du finn på $KLAGE_URL. Treng du hjelp, er du velkomen til å ringje oss på telefon " +
                        telefonnummer.format() +
                        "."
                },
                english {
                    +"Your appeal must include your name, national identity number and address. Feel free to use the form found at $KLAGE_URL. Should you need assistance in writing the appeal, please call us at tel.: " +
                        telefonnummer.format() +
                        "."
                },
            )

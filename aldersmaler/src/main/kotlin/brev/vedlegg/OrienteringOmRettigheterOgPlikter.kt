...
import no.nav.pensjon.brev.model.alder.Institusjon.FENGSEL
import no.nav.pensjon.brev.model.alder.Institusjon.HELSE
import no.nav.pensjon.brev.model.alder.Institusjon.SYKEHJEM
import no.nav.pensjon.brev.model.alder.MetaforceSivilstand.ENKE
import no.nav.pensjon.brev.model.alder.MetaforceSivilstand.ENSLIG
...
import no.nav.pensjon.brev.model.alder.MetaforceSivilstand.SAMBOER_1_5
import no.nav.pensjon.brev.model.alder.MetaforceSivilstand.SAMBOER_3_2
...
import no.nav.pensjon.brev.model.alder.MetaforceSivilstand.UKJENT
import no.nav.pensjon.brev.model.alder.vedlegg.OrienteringOmRettigheterOgPlikterDto
import no.nav.pensjon.brev.model.alder.vedlegg.OrienteringOmRettigheterOgPlikterDtoSelectors.borSammenMedBruker
import no.nav.pensjon.brev.model.alder.vedlegg.OrienteringOmRettigheterOgPlikterDtoSelectors.brukerBorINorge
import no.nav.pensjon.brev.model.alder.vedlegg.OrienteringOmRettigheterOgPlikterDtoSelectors.brukerUnder18Aar
import no.nav.pensjon.brev.model.alder.vedlegg.OrienteringOmRettigheterOgPlikterDtoSelectors.epsOppholdSykehjem
import no.nav.pensjon.brev.model.alder.vedlegg.OrienteringOmRettigheterOgPlikterDtoSelectors.epsPaInstitusjon
import no.nav.pensjon.brev.model.alder.vedlegg.OrienteringOmRettigheterOgPlikterDtoSelectors.harBarnetillegg
import no.nav.pensjon.brev.model.alder.vedlegg.OrienteringOmRettigheterOgPlikterDtoSelectors.institusjonsoppholdGjeldende
import no.nav.pensjon.brev.model.alder.vedlegg.OrienteringOmRettigheterOgPlikterDtoSelectors.sakstype
import no.nav.pensjon.brev.model.alder.vedlegg.OrienteringOmRettigheterOgPlikterDtoSelectors.sivilstand

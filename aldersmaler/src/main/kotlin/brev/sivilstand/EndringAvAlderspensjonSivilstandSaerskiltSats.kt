...
object EndringAvAlderspensjonSivilstandSaerskiltSats :
    ...
    override val featureToggle =
        FeatureToggles.endringAvAlderspensjonSivilstandVurderSaerskiltSats.toggle
            ...
            outline {
                ...
                showIf(saksbehandlerValg.eps.equalTo(EPS.epsIkkeFylt62Aar)) {
                    ...
                    paragraph {
                        text(
                            bokmal {
                                +"Du får ikke beregnet alderspensjonen din med særskilt sats fordi " + sivilstandBestemtLitenBokstav +
                                    " din har inntekt høyere enn grunnbeløpet (" +
                                    grunnbelop.format() +
                                    ")."
                            },
                            nynorsk {
                                +"Du får ikkje berekna alderspensjonen din med særskilt sats fordi " + sivilstandBestemtLitenBokstav +
                ...
                showIf(saksbehandlerValg.aarligKontrollEPS) {
                    ...
                    paragraph {
                        text(
                            bokmal {
                                +"Fram til " + sivilstandBestemtLitenBokstav + " din fyller 67 år, har vi en årlig kontroll om " +
                                    sivilstandBestemtLitenBokstav +
                                    " din har rett til full alderpensjon. Du får nytt vedtak hvis dette fører til at alderspensjonen din blir omregnet."
                            },
                            nynorsk {
                                +"Fram til " + sivilstandBestemtLitenBokstav + " din fyller 67 år, har vi ein årleg kontroll av " +
                                    sivilstandBestemtLitenBokstav +

...
data class InnholdLavOpptjening(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal { + "I Din pensjon på ${Constants.DIN_PENSJON_URL} kan du sjekke når du har mulighet til å ta ut mer alderspensjon. " +
                        "Du kan også se hva pensjonen din blir, avhengig av når og hvor mye du tar ut." },
                nynorsk { + "I Din pensjon på ${Constants.DIN_PENSJON_URL} kan du sjekke når du har høve til å ta ut meir alderspensjon. " +
                        "Du kan også sjå kva pensjonen din blir, avhengig av når og kor mykje du tek ut." },
                english { + "Log on to " + quoted("Din pensjon") + " at ${Constants.DIN_PENSJON_URL}  to find out more about your pension payments. " +

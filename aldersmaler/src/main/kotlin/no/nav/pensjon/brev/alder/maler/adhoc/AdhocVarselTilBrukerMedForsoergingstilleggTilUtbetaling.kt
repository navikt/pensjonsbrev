...
object AdhocVarselTilBrukerMedForsoergingstilleggTilUtbetaling : AutobrevTemplate<EmptyBrevdata> {
    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            paragraph {
                text(
                    bokmal { +"Hvis du har spørsmål om saken din, kan du ringe oss på telefon ${Constants.NAV_KONTAKTSENTER_TELEFON_PENSJON}, hverdager ${Constants.NAV_KONTAKTSENTER_AAPNINGSTID}." },

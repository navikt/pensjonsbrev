...
import no.nav.pensjon.brev.alder.model.vedlegg.OpplysningerBruktIBeregningenAlderDtoSelectors.AlderspensjonVedVirkSelectors.erEksportberegnet
...
import no.nav.pensjon.brev.alder.model.vedlegg.OpplysningerBruktIBeregningenAlderDtoSelectors.InngangOgEksportVurderingSelectors.eksportBeregnetUtenGarantipensjon_safe
...
import no.nav.pensjon.brev.alder.model.vedlegg.OpplysningerBruktIBeregningenAlderDtoSelectors.TrygdetidsdetaljerKap20VedVirkSelectors.beregningsmetode_safe
import no.nav.pensjon.brev.alder.model.vedlegg.Trygdetid
import no.nav.pensjon.brev.alder.model.vedlegg.TrygdetidSelectors.fom
import no.nav.pensjon.brev.alder.model.vedlegg.TrygdetidSelectors.land
import no.nav.pensjon.brev.alder.model.vedlegg.TrygdetidSelectors.tom

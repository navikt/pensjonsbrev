...
val uttaksskjema = createAttachment<LangBokmalEnglish, EmptyVedleggData>(
    ...
    outline = {
        ...
        paragraph {
            text(
                bokmal { +"Norge har også en ordning som heter ${quoted("fleksibelt uttak av alderspensjon fra 62 år")}. Dette innebærer at hvis du har hatt høy nok opptjening kan du ta ut pensjon allerede fra måneden etter at du fyller 62 år. Du kan lese mer om hva ${quoted("høy nok opptjening")} betyr under punktet ${quoted("valg av uttakstidspunkt - høyere pensjon jo lenger du venter")}."},
                english { +"Norway also has an option called ${quoted("flexible withdrawal of retirement pension from the age of 62")}. This means that if you have had high enough earnings, you can draw a pension from the month after you turn 62. You can read more about what ${quoted("high enough earnings")} means under the heading ${quoted("choice of withdrawal time - higher pension the longer you wait")}."}
            )
        }
        title2 {
            text(

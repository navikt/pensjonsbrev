...
object AdhocAlderspensjonFraFolketrygden : AutobrevTemplate<EmptyAutobrevdata> {
    override val kode = Aldersbrevkoder.AutoBrev.PE_AP_ADHOC_2024_REGLERENDRET_GJR_AP_MNTINDV
    override val template = createTemplate(
        ...
        outline {
            ...
            paragraph {
                text(
                    bokmal {
                        +"Reglene har ingen praktisk betydning for deg. Samlet pensjon før skatt er den samme som før. "
                        +"Vi har bare endret metoden for beregningen av alderspensjonen din."
                    },
                    nynorsk {
                        +"Reglane har ingen praktisk tyding for deg. Samla pensjon før skatt er den same som før. "
                        +"Vi har berre endra metoden for utrekninga av alderspensjonen din."
                    },
                    english {
                        +"The rules have no practical significance for you. Your total pension amount before tax is the same as before. "
            ...
            paragraph {
                text(
                    bokmal {
                        +"Metoden for beregningen av alderspensjonen din gjør at du nå får et gjenlevendetillegg. "
                        +"Dette erstatter det som før het " + quoted("minstenivåtillegg individuelt") + "."
                    },
                    nynorsk {
                        +"Metoden for utrekninga av alderspensjonen din gjer at du no får eit attlevandetillegg. "
                        +"Dette erstattar det som før heitte " + quoted("minstenivåtillegg individuelt") + "."
                    },
                    english {
                        +"The method for calculating your retirement pension means that you now receive a survivor’s supplement. "
            ...
            paragraph {
                text(
                    bokmal {
                        +"Gjenlevendetillegget vil ikke bli regulert. For at du ikke skal tape på dette, "
                        +"vil du ved reguleringen få et nytt minstenivåtillegg individuelt."
                    },
                    nynorsk {
                        +"Attlevandetillegget vil ikkje bli regulert. For at du ikkje skal tape på dette, "
                        +"vil du ved reguleringa få eit nytt minstenivåtillegg individuelt."
                    },
                    english {
                        +"The survivor’s supplement will not be adjusted. To ensure that you do not lose out on this, "
            ...
            paragraph {
                text(
                    bokmal {
                        +"Hvis du får endringer i familiesituasjon eller planlegger opphold i et annet land, kan det påvirke utbetalingen din. "
                        +"I slike tilfeller må du derfor straks melde fra til Nav. Se hva du må melde fra om på ${Constants.PENSJON_ENDRING_URL}."
                    },
                    nynorsk {
                        +"Viss du får endringar i familiesituasjon eller planlegg opphald i eit anna land, kan det påverke utbetalinga di. "
                        +"I slike tilfelle må du derfor straks melde frå til Nav. Sjå kva du må melde frå om på ${Constants.PENSJON_ENDRING_URL}."
                    },
                    english {
                        +"If you have changes in your family situation or you plan to live abroad, this may influence your benefits. "

...
import no.nav.pensjon.brev.alder.model.aldersovergang.AlderspensjonVedVirkSelectors.totalPensjon
import no.nav.pensjon.brev.alder.model.aldersovergang.AlderspensjonVedVirkSelectors.uttaksgrad
import no.nav.pensjon.brev.alder.model.aldersovergang.BeregnetPensjonPerManedVedVirkSelectors.garantitillegg
import no.nav.pensjon.brev.alder.model.aldersovergang.VedtakAldersovergang67AarGarantitilleggAutoDto
import no.nav.pensjon.brev.alder.model.aldersovergang.VedtakAldersovergang67AarGarantitilleggAutoDtoSelectors.alderspensjonVedVirk
import no.nav.pensjon.brev.alder.model.aldersovergang.VedtakAldersovergang67AarGarantitilleggAutoDtoSelectors.beregnetPensjonPerManedVedVirk
import no.nav.pensjon.brev.alder.model.aldersovergang.VedtakAldersovergang67AarGarantitilleggAutoDtoSelectors.maanedligPensjonFoerSkattAP2025Dto
import no.nav.pensjon.brev.alder.model.aldersovergang.VedtakAldersovergang67AarGarantitilleggAutoDtoSelectors.maanedligPensjonFoerSkattDto
import no.nav.pensjon.brev.alder.model.aldersovergang.VedtakAldersovergang67AarGarantitilleggAutoDtoSelectors.orienteringOmRettigheterOgPlikterDto
import no.nav.pensjon.brev.alder.model.aldersovergang.VedtakAldersovergang67AarGarantitilleggAutoDtoSelectors.virkFom

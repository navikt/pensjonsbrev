...
object VedleggVeiledningStatisk : OutlinePhrase<LangBokmalNynorskEnglish>() {
...
object VedleggInnsynSakPensjonStatisk : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        title1 {
            text(
        ...
        paragraph {
            text(
                bokmal { + "Med få unntak har du rett til å se dokumentene i saken din. Du kan logge deg inn på ${Constants.NAV_URL} for å se all kommunikasjon som har vært mellom deg og Nav i saken din. Du kan også ringe oss på telefon ${Constants.NAV_KONTAKTSENTER_TELEFON_PENSJON}." },
                nynorsk { + "Med få unntak har du rett til å sjå dokumenta i saka di. Du kan logge deg inn på ${Constants.NAV_URL} for å sjå all kommunikasjon som har vore mellom deg og Nav i saka di. Du kan også ringje oss på telefon ${Constants.NAV_KONTAKTSENTER_TELEFON_PENSJON}." },
                english { + "With some exceptions, you are entitled to access all the documents relating to your case. Log on to ${Constants.NAV_URL} to review the communication between you and Nav in connection with your case. You can also call us at tel.: ${Constants.NAV_KONTAKTSENTER_TELEFON_PENSJON}." }
            )
        }
    }
}

object VedleggHjelpFraAndreStatisk : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        title1 {
            text(
...
object VedleggKlagePaaVedtaketStatisk : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        title1 {
            text(
        ...
        paragraph {
            text(
                bokmal { + "Klagen må inneholde navn, fødselsnummer og adresse. Bruk gjerne skjemaet som du finner på ${Constants.KLAGE_URL}. Trenger du hjelp, er du velkommen til å ringe oss på telefon ${Constants.NAV_KONTAKTSENTER_TELEFON_PENSJON}." },
                nynorsk { + "Klaga må innehalde namn, fødselsnummer og adresse. Bruk gjerne skjemaet som du finn på ${Constants.KLAGE_URL}. Treng du hjelp, er du velkomen til å ringje oss på telefon ${Constants.NAV_KONTAKTSENTER_TELEFON_PENSJON}." },
                english { + "Your appeal must include your name, national identity number and address. Feel free to use the form found at ${Constants.KLAGE_URL}. Should you need assistance in writing the appeal, please call us at tel.: ${Constants.NAV_KONTAKTSENTER_TELEFON_PENSJON}." }
            )
        }
        paragraph {

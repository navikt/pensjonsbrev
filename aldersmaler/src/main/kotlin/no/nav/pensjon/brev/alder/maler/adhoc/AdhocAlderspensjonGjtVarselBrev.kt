...
object AdhocAlderspensjonGjtVarselBrev : AutobrevTemplate<EmptyAutobrevdata> {
    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            paragraph {
                text(
                    bokmal { + "Du har rett til å uttale deg i saken. Fristen for å uttale deg er 14 dager etter at du " +
                            "har fått dette brevet. Uttalelsen bør være skriftlig. Du kan skrive til oss på ${Constants.KONTAKT_URL}" },
                    nynorsk { + "Du har rett til å uttale deg i saka. Fristen for å uttale deg er 14 dagar etter at du " +
                            "har fått dette brevet. Fråsegna bør vere skriftleg. Du kan skrive til oss på ${Constants.KONTAKT_URL}" },
                    english { + "You have the right to submit a statement on your case. The deadline for commenting is " +
                            "14 days after you receive this letter. You can submit a statement by logging in to ${Constants.KONTAKT_URL}" },
                )
            }
            ...
            paragraph {
                text(
                    bokmal { + "Du finner mer informasjon om gjenlevendetillegg på ${Constants.ALDERSPENSJON_GJENLEVENDE_URL}. " +
                            "På ${Constants.KONTAKT_URL} kan du chatte eller skrive til oss. Hvis du ikke finner svar på ${Constants.NAV_URL}, " +
                            "kan du ringe oss på telefon ${Constants.NAV_KONTAKTSENTER_TELEFON_PENSJON}, hverdager kl. ${Constants.NAV_KONTAKTSENTER_AAPNINGSTID}." },
                    nynorsk { + "Du finn meir informasjon om attlevandetillegg på ${Constants.ALDERSPENSJON_GJENLEVENDE_URL}. " +
                            "På ${Constants.KONTAKT_URL} kan du chatte eller skrive til oss. Om du ikkje finn svar på ${Constants.NAV_URL}, " +
                            "kan du ringje oss på telefon ${Constants.NAV_KONTAKTSENTER_TELEFON_PENSJON}, kvardagar kl. ${Constants.NAV_KONTAKTSENTER_AAPNINGSTID}." },
                    english { + "You can find more information about survivor's pension at ${Constants.ALDERSPENSJON_GJENLEVENDE_URL_EN}. " +
                            "At ${Constants.KONTAKT_ENG_URL} you can chat or write to us. If you do not find the answer at ${Constants.NAV_URL}, " +
                            "you can call us at +47 ${Constants.NAV_KONTAKTSENTER_TELEFON_PENSJON}, weekdays ${Constants.NAV_KONTAKTSENTER_OPEN_HOURS}." },
                )
            }
        }
    }

...
import no.nav.pensjon.brev.alder.model.avslag.AvslagForLiteTrygdetidAPDtoSelectors.PesysDataSelectors.avtaleland
import no.nav.pensjon.brev.alder.model.avslag.AvslagForLiteTrygdetidAPDtoSelectors.PesysDataSelectors.borINorge
import no.nav.pensjon.brev.alder.model.avslag.AvslagForLiteTrygdetidAPDtoSelectors.PesysDataSelectors.bostedsland
import no.nav.pensjon.brev.alder.model.avslag.AvslagForLiteTrygdetidAPDtoSelectors.PesysDataSelectors.dineRettigheterOgMulighetTilAaKlageDto
import no.nav.pensjon.brev.alder.model.avslag.AvslagForLiteTrygdetidAPDtoSelectors.PesysDataSelectors.erEOSland
import no.nav.pensjon.brev.alder.model.avslag.AvslagForLiteTrygdetidAPDtoSelectors.PesysDataSelectors.regelverkType
import no.nav.pensjon.brev.alder.model.avslag.AvslagForLiteTrygdetidAPDtoSelectors.PesysDataSelectors.trygdeperioderAvtaleland
import no.nav.pensjon.brev.alder.model.avslag.AvslagForLiteTrygdetidAPDtoSelectors.PesysDataSelectors.trygdeperioderEOSland
import no.nav.pensjon.brev.alder.model.avslag.AvslagForLiteTrygdetidAPDtoSelectors.PesysDataSelectors.trygdeperioderNorge
import no.nav.pensjon.brev.alder.model.avslag.AvslagForLiteTrygdetidAPDtoSelectors.PesysDataSelectors.vedtaksBegrunnelse
import no.nav.pensjon.brev.alder.model.avslag.AvslagForLiteTrygdetidAPDtoSelectors.pesysData
...
object AvslagForLiteTrygdetidAP : RedigerbarTemplate<AvslagForLiteTrygdetidAPDto> {
    ...
    override val template = createTemplate(
        ...
        val erAp2025 = regelverkType.equalTo(AlderspensjonRegelverkType.AP2025)
        ...
        outline {
            showIf(avslagsBegrunnelse.equalTo(UNDER_1_AR_TT) and (erAp2011 or erAp2016)) {
                ...
                paragraph {
                    ...
                    showIf(erEOSland) {
                        ...
                        text(
                            ...
                            english {
                                +" of the National Insurance Act and to the rules of the Article of the Social Security Agreement with "
                                +avtaleland + "."
                            },
                        )
                    }
                ...
                showIf(not(erAvtaleland) and not(erEOSland)) {
                    ...
                    paragraph {
                        ...
                        text(
                            bokmal { +". Den samlede trygdetiden din i Norge og annet " },
                            nynorsk { +". Den samla trygdetida din i Noreg og anna " },
            ...
            showIf(avslagsBegrunnelse.isOneOf(UNDER_20_AR_BO_2016) and erAp2016) {
                ...
                paragraph {
                    text(
                        bokmal {
                            +"For å få utbetalt alderspensjonen din når du bor i "
                        ...
                        nynorsk {
                            +"For å få utbetalt alderspensjonen din når du bur i "
                        ...
                        english {
                            +"To be eligible for your retirement pension while living in "
    ...
    private fun OutlineOnlyScope<LanguageSupport.Triple<Language.Bokmal, Language.Nynorsk, Language.English>, AvslagForLiteTrygdetidAPDto>.avslagUnder1aar3aar5aarTT() {
        paragraph {
            text(
                bokmal {
                    +"Våre opplysninger viser at du har bodd eller arbeidet i Norge i "
                    +fritekst("X antall dager/måneder") +
                            ". /Våre opplysninger viser at du ikke har bodd eller arbeidet i Norge."
                },

                nynorsk {
                    +"Våre opplysningar viser at du har budd eller arbeidd i Noreg i "
                    +fritekst("X antall dager/måneder") +
                            ". /Våre opplysningar viser at du ikkje har budd eller arbeidd i Noreg."
                },

                english {
                    +"We have registered that you have been living or working in Norway "
    ...
    private data class EOSogEllerAvtaleland(val erEOSland: Expression<Boolean>, val erAvtaleland: Expression<Boolean>) :

...
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenKap19Selectors.innvilgetTillegspensjon
...
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.delingstallVedNormertPensjonsalder
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.delingstallVedUttak
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.kravAarsak
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.normertPensjonsalder
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.opplysningerKap19
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.opplysningerKap20
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.pensjonsbeholdning
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.sisteOpptjeningsAar
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.trygdeperioderNorge
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.trygdeperioderUtland
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.trygdetid
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.uttaksgrad
import no.nav.pensjon.brev.alder.model.avslag.OpplysningerBruktIBeregningenSelectors.virkFom
import no.nav.pensjon.brev.alder.model.avslag.TrygdeperiodeNorgeSelectors.fom
import no.nav.pensjon.brev.alder.model.avslag.TrygdeperiodeNorgeSelectors.tom
import no.nav.pensjon.brev.alder.model.avslag.TrygdeperiodeUtlandSelectors.fom
import no.nav.pensjon.brev.alder.model.avslag.TrygdeperiodeUtlandSelectors.land

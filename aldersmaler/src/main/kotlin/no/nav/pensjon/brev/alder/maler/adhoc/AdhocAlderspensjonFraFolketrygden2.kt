    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            paragraph {
                text(
                    bokmal {
                        +"Metoden for beregningen av alderspensjonen din gjør at du nå får et gjenlevendetillegg. Dette erstatter det som før het " + quoted(
                            "minstenivåtillegg individuelt"
                        ) + "."
                    },
                    nynorsk {
                        +"Metoden for utrekninga av alderspensjonen din gjer at du no får eit attlevandetillegg. Dette erstattar det som før heitte " + quoted(
                            "minstenivåtillegg individuelt"
                        ) + "."
                    },
                    english {
                        +"The method for calculating your retirement pension means that you now receive a survivor’s supplement. This replaces what was previously called " + quoted(
            ...
            paragraph {
                text(
                    bokmal { +"Hvis du får endringer i familiesituasjon eller planlegger opphold i et annet land, kan det påvirke utbetalingen din. I slike tilfeller må du derfor straks melde fra til Nav. Se hva du må melde fra om på ${Constants.PENSJON_ENDRING_URL}." },
                    nynorsk { +"Viss du får endringar i familiesituasjon eller planlegg opphald i eit anna land, kan det påverke utbetalinga di. I slike tilfelle må du derfor straks melde frå til Nav. Sjå kva du må melde frå om på ${Constants.PENSJON_ENDRING_URL}." },

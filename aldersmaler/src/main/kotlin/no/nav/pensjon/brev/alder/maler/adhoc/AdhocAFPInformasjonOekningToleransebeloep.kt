...
object AdhocAFPInformasjonOekningToleransebeloep : AutobrevTemplate<EmptyBrevdata> {
    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            paragraph {
                text(
                    bokmal { +"Du kan melde fra om ny forventet inntekt på ${Constants.SEND_BESKJED_URL}" },
                    nynorsk { +"Du kan melde frå om ny forventa inntekt på ${Constants.SEND_BESKJED_URL}" },
                )
            }

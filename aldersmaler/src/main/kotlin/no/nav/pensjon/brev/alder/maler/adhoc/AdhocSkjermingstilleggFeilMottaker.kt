...
object AdhocSkjermingstilleggFeilMottaker : AutobrevTemplate<EmptyAutobrevdata> {
    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            paragraph {
                text(
                    bokmal { + "Du kan lese mer på ${Constants.PERSONVERNERKLAERING_URL}." }
                )
            }
            ...
            paragraph {
                text(
                    bokmal { + "På ${Constants.KONTAKT_URL} kan du chatte eller skrive til oss. " +
                            "Du kan også ringe oss på telefon ${Constants.NAV_KONTAKTSENTER_TELEFON_PENSJON} hverdager kl.${Constants.NAV_KONTAKTSENTER_AAPNINGSTID}." }
                )
            }

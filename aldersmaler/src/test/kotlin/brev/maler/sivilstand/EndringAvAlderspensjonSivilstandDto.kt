...
fun createEndringAvAlderspensjonSivilstandDto(): EndringAvAlderspensjonSivilstandDto {
    val endringAvAlderspensjonSivilstandDto = EndringAvAlderspensjonSivilstandDto(
        saksbehandlerValg =
    ...
    return endringAvAlderspensjonSivilstandDto
}

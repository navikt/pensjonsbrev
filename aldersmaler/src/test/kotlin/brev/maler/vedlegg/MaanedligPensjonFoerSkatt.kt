...
internal fun createAlderspensjonPerManed() =
    MaanedligPensjonFoerSkattTabell.AlderspensjonPerManed(
...
internal fun createMaanedligPensjonFoerSkatt() =
    MaanedligPensjonFoerSkattDto(
        beregnetPensjonPerManedGjeldende = createAlderspensjonPerManed(),
        alderspensjonGjeldende =
            MaanedligPensjonFoerSkattDto.AlderspensjonGjeldende(
        ...
        institusjonsoppholdGjeldende =
            MaanedligPensjonFoerSkattDto.InstitusjonsoppholdGjeldende(
        ...
        epsGjeldende =
            MaanedligPensjonFoerSkattDto.EPSgjeldende(
                mottarPensjon = true,
                borSammenMedBruker = true,
                harInntektOver2G = true,
            ),
        ektefelletilleggGjeldende =
            MaanedligPensjonFoerSkattDto.EktefelletilleggGjeldende(
                innvilgetEktefelletillegg = true,
            ),
        tilleggspensjonGjeldende =
            MaanedligPensjonFoerSkattDto.TilleggspensjonGjeldende(
                erRedusert = true,
        ...
        saerskiltSatsGjeldende =
            MaanedligPensjonFoerSkattDto.SaerskiltSatsGjeldende(
                saerskiltSatsErBrukt = true,
            ),
        barnetilleggGjeldende =
            MaanedligPensjonFoerSkattDto.BarnetilleggGjeldende(
                innvilgetBarnetilleggFB = true,
                innvilgetBarnetilleggSB = true,
            ),
        bruker =
            MaanedligPensjonFoerSkattDto.Bruker(
                foedselsDato = LocalDate.of(1950, 1, 1),
                sivilstand = MetaforceSivilstand.GIFT,
            ),
        krav =
            MaanedligPensjonFoerSkattDto.Krav(
                virkDatoFom = LocalDate.of(2020, 1, 1),
            ),

...
fun <Lang1 : Language, Lang2 : Language> languages(
    lang1: Lang1,
    lang2: Lang2,
): LanguageSupport.Double<Lang1, Lang2> =
    LanguageCombination.Double(lang1, lang2)

fun <Lang1 : Language, Lang2 : Language, Lang3 : Language> languages(
    lang1: Lang1,
    lang2: Lang2,
    lang3: Lang3,
): LanguageSupport.Triple<Lang1, Lang2, Lang3> =

...
@JvmName("equalToKroner")
infix fun Expression<Kroner?>.equalTo(compareTo: Kroner?): Expression<Boolean> = BinaryOperation.Equal<Kroner?>().invoke(this, compareTo.expr())
@JvmName("notEqualToKroner")
infix fun Expression<Kroner?>.notEqualTo(compareTo: Kroner): Expression<Boolean> = equalTo(compareTo).not()
...
@JvmName("equalToYear")
infix fun Expression<Year?>.equalTo(compareTo: Year?): Expression<Boolean> = BinaryOperation.Equal<Year?>().invoke(this, compareTo.expr())
@JvmName("notEqualToYear")
infix fun Expression<Year?>.notEqualTo(compareTo: Year): Expression<Boolean> = equalTo(compareTo).not()
...
@JvmName("equalToPercent")
infix fun Expression<Percent?>.equalTo(compareTo: Percent?): Expression<Boolean> = BinaryOperation.Equal<Percent?>().invoke(this, compareTo.expr())
@JvmName("notEqualToPercent")
infix fun Expression<Percent?>.notEqualTo(compareTo: Percent): Expression<Boolean> = equalTo(compareTo).not()

...
interface RedigerbarTemplate<LetterData : RedigerbarBrevdata<out SaksbehandlerValgBrevdata, out PesysBrevdata>> : BrevTemplate<LetterData, Brevkode.Redigerbart> {

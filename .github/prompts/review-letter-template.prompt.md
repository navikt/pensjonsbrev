...
- `.github/skills/write-template/SKILL.md` (applies to both autobrev and redigerbar)
- `.github/skills/write-template/write-redigerbar-template.md` (only if the template is a `RedigerbarTemplate`)

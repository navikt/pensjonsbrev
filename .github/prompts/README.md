...
If you are using Copilot Chat without prompt-file support, you can still reference the skills inline by attaching them with `#file:skills/write-template.md`.

...
import no.nav.pensjon.brev.ufore.api.model.Ufoerebrevkoder.Redigerbar.UT_AVSLAG_OKT_GRAD_HENSIKTSMESSIG_ARB_TILTAK_I1
...
object UforegradAvslagHensiktsmessigArbTiltakI1 : RedigerbarTemplate<UforeAvslagEnkelDto> {
        ...
        outline {
            ...
            title1 {
                text(bokmal { +"Derfor får du ikke økt uføregrad" },
                    nynorsk { +"Derfor du ikkje auka uføregrad" })
            }
            paragraph {
                text(bokmal { +"Vi avslår søknaden din fordi du ikke har forsøkt arbeidsrettede tiltak." },
                    nynorsk { +"Vi avslår søknaden din fordi du ikkje har forsøkt arbeidsretta tiltak." })
            }
            paragraph {
            ...
            paragraph {
                text(bokmal { + "Vi vurderer at du ikke har forsøkt hensiktsmessige arbeidsrettede tiltak eller annet arbeid som kan bedre inntektsevnen din. " +
                        "Fordi du ikke har forsøkt arbeidsrettede tiltak, " +
                        "er det for tidlig å vurdere om inntektsevnen din er varig nedsatt med mer enn " + fritekst("Nåværende uføregrad") + " prosent."},
                    nynorsk { + "Vi vurderer at du ikkje har forsøkt føremålstenlege arbeidsretta tiltak eller anna arbeid som kan betre inntektsevna di. " +
                        "Fordi du ikkje har forsøkt arbeidsretta tiltak, " +
                        "er det for tidleg å vurdere om inntektsevna di er varig nedsett med meir enn " + fritekst("Nåværende uføregrad") + " prosent." })
            }
            paragraph {

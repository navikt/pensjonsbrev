...
/** Portert fra legacy TBU038V_4. Fotnoter for inntektstabell (avdoed, utland-metode) inkl. **-note. */
data class TBU038V_4(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorsk, Unit>.template() {
        ...
        showIf(flagg.avdoedHarOpptjeningUTMedFoerstegangstjenesteOgOmsorg) {
            paragraph {
                text(
        ...
        showIf(flagg.avdoedHarOpptjeningUTMedOmsorgOgIkkeFoerstegangstjeneste) {
            paragraph {
                text(
        ...
        showIf(flagg.avdoedHarOpptjeningUTMedFoerstegangstjenesteOgIkkeOmsorg) {
            paragraph {
                text(

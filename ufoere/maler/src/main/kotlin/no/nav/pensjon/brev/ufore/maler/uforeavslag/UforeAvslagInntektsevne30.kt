        ...
        outline {
            ...
            paragraph {
                text(bokmal { +"Vi har avslått søknaden din om uføretrygd fordi inntektsevnen din er varig nedsatt med mindre enn 30 prosent." },
                    nynorsk { +"Vi har avslått søknaden din om uføretrygd fordi inntektsevna di er varig nedsett med mindre enn 30 prosent." })
            }
            ...
            paragraph {
                text(bokmal { +"Vedtaket har vi gjort etter folketrygdloven §§ 12-7 og 12-17." },
                    nynorsk { +"Vedtaket har vi gjort etter folketrygdlova §§ 12-7 og 12-17." })
            }

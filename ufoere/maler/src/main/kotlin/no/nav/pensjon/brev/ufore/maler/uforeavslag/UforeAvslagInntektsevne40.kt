...
import no.nav.pensjon.brev.ufore.maler.uforeavslag.UforeAvslagInntektsevne50.fritekst
        ...
        outline {
            ...
            paragraph {
                text(bokmal { +"Vi har avslått søknaden din om uføretrygd fordi inntektsevnen din er varig nedsatt med mindre enn 40 prosent." },
                    nynorsk { +"Vi har avslått søknaden din om uføretrygd fordi inntektsevna di er varig nedsett med mindre enn 40 prosent." })
            }
            ...
            paragraph {
                text(bokmal { +"Uføretidspunktet ditt er satt til " + pesysData.uforetidspunkt.format() + ". På dette tidspunktet vurderer vi at dine helseutfordringer førte til at din arbeidsevne ble varig nedsatt. " },
                    nynorsk { +"Uføretidspunktet ditt er sett til " + pesysData.uforetidspunkt.format() + ". På dette tidspunktet vurderer vi at helseutfordringar dine førte til at arbeidsevna di blei varig nedsett. " })
            }
            ...
            paragraph {
                ...
                text(bokmal { + " Oppjustert til dagens verdi tilsvarer dette en inntekt på " + fritekst("oppjustert IFU") + " kroner. Inntekt etter uførhet er satt til " + pesysData.inntektEtterUforhet.format(CurrencyFormat) + " kroner. " },
            ...
            paragraph {
                text(bokmal { + "For å få uføretrygd må inntektsevnen din som hovedregel være varig nedsatt med minst 50 prosent. " +
                    ...
                    nynorsk { + "For å få uføretrygd må inntektsevna di som hovudregel vere varig nedsett med minst 50 prosent. " +
                            "Fordi du fekk arbeidsavklaringspengar då du søkte om uføretrygd, må inntektsevna di vere nedsett med minst 40 prosent." }
                )
            }
            paragraph {
            ...
            paragraph {
                text(bokmal { + "Uføregraden din er under 40 prosent, og du oppfyller derfor ikke vilkårene for å få uføretrygd. "},
                    nynorsk { + "Uføregraden din er under 40 prosent, og du oppfyller derfor ikkje vilkåra for å få uføretrygd. " })
            }

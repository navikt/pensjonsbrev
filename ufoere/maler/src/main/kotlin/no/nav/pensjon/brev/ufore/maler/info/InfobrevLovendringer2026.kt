...
object InfobrevLovendringer2026 : AutobrevTemplate<EmptyAutobrevdata> {
    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            title3 { text(bokmal { +"Hvis du har hatt uføretrygd i mindre enn 2 år" }) }
            ...
            title3 { text(bokmal { +"Hvis du har hatt uføretrygd i 2 år eller mer" }) }
            ...
            title3 { text(bokmal { +"Hva er reduksjonsprosent? " }) }
            ...
            title3 { text(bokmal { +"Hva er inntekt før uførhet (IFU)?" }) }
            ...
            title3 { text(bokmal { +"Du kan ta kontakt" }) }
            paragraph {
                list {
                    item {

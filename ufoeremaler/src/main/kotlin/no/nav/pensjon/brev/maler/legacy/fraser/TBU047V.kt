    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        paragraph {
            text(
                ...
                english { + "You have had national insurance coverage for less than 4/5 of the period from the year you turned 16 years old until the date of your disability. This means that your future period of national insurance coverage will total 40 years, where we deduct 4/5 of the period from the year you turned 16 years old until the date of your disability." },
            )
        }
    }
}
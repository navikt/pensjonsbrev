...
import no.nav.pensjon.brev.maler.fraser.Constants.INNTEKTSPLANLEGGEREN_URL
import no.nav.pensjon.brev.maler.fraser.Constants.KLAGE_URL
import no.nav.pensjon.brev.maler.fraser.Constants.MELDE_URL
...
import no.nav.pensjon.brev.maler.legacy.vedleggDineRettigheterOgPlikterUfoere
...
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.BarnetilleggFellesbarnSelectors.inntektAnnenForelder
import no.nav.pensjon.brevbaker.api.model.LetterMetadata
import no.nav.pensjon.brevbaker.api.model.LetterMetadata.Distribusjonstype.VEDTAK
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.uforetrygd
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.UforetrygdSelectors.endringsbelop
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.UforetrygdSelectors.netto
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.UforetrygdSelectors.totalNettoInnevarendeAr
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.UforetrygdSelectors.nettoRestbelop
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.UforetrygdSelectors.inntektBruktIAvkortning
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.UforetrygdSelectors.nettoAkkumulert
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.UforetrygdSelectors.inntektsgrense
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.UforetrygdSelectors.inntektstak
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.btfbEndret
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.btsbEndret
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.virkningFom
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.barnetilleggSaerkullsbarn
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.BarnetilleggSaerkullsbarnSelectors.netto
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.BarnetilleggSaerkullsbarnSelectors.inntektBruktIAvkortning
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.barnetilleggFellesbarn
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.BarnetilleggFellesbarnSelectors.netto
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.BarnetilleggFellesbarnSelectors.inntektBruker
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.GjenlevendetilleggSelectors.belop
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.brukerBorINorge
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.forventetInntekt
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.gjenlevendetillegg
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.totalNetto
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.datoForNormertPensjonsalder
import no.nav.pensjon.brev.ufore.api.model.maler.auto.EndretUTPgaInntektDtoV2Selectors.pe
...
object EndretUfoeretrygdPGAInntektV2 : AutobrevTemplate<EndretUTPgaInntektDtoV2> {
    ...
    override val kode = Ufoerebrevkoder.AutoBrev.UT_ENDRET_PGA_INNTEKT_V2
    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            paragraph {
                text(
                    bokmal { + "Hvis du mener inntekten vi har brukt i denne beregningen er feil, kan du selv legge inn ny forventet inntekt på $INNTEKTSPLANLEGGEREN_URL eller kontakte oss på $NAV_KONTAKTSENTER_TELEFON_UFORE. " },
                    nynorsk { + "Dersom du meiner at vi har brukt feil inntekt i denne utrekninga, kan du leggje inn forventa inntekt sjølv på $INNTEKTSPLANLEGGEREN_URL eller kontakte oss på $NAV_KONTAKTSENTER_TELEFON_UFORE. " },
                )
            }
            paragraph {
                text(
            ...
            includePhrase(Felles.HarDuSpoersmaal(UFORE_URL, NAV_KONTAKTSENTER_TELEFON_UFORE))
        }

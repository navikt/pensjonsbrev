...
import no.nav.pensjon.brev.ufore.api.model.maler.legacy.Institusjon
import no.nav.pensjon.brev.ufore.api.model.maler.legacy.OrienteringOmRettigheterUfoereDto
import no.nav.pensjon.brev.ufore.api.model.maler.legacy.OrienteringOmRettigheterUfoereDtoSelectors.bruker_borINorge
import no.nav.pensjon.brev.ufore.api.model.maler.legacy.OrienteringOmRettigheterUfoereDtoSelectors.harInnvilgetBarnetilleggFellesBarn
import no.nav.pensjon.brev.ufore.api.model.maler.legacy.OrienteringOmRettigheterUfoereDtoSelectors.harInnvilgetBarnetilleggSaerkullsbarn
import no.nav.pensjon.brev.ufore.api.model.maler.legacy.OrienteringOmRettigheterUfoereDtoSelectors.institusjon_gjeldende
import no.nav.pensjon.brev.ufore.api.model.maler.legacy.OrienteringOmRettigheterUfoereDtoSelectors.harTilleggForFlereBarn
    ...
    createAttachment<LangBokmalNynorskEnglish, OrienteringOmRettigheterUfoereDto>(
        ...
        paragraph {
            list {
                ...
                showIf(
                    bruker_borINorge
                            and institusjon_gjeldende.isNotAnyOf(Institusjon.FENGSEL, Institusjon.HELSE, Institusjon.SYKEHJEM)
                ) {

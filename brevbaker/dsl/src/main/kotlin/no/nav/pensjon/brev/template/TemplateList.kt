...
class ListScope<Lang : LanguageSupport, LetterData : Any> internal constructor(): ControlStructureScope<Lang, LetterData, Element.OutlineContent.ParagraphContent.AbstractList.Item<Lang>, ListScope<Lang, LetterData>> {
    ...
    fun item(create: TextOnlyScope<Lang, LetterData>.() -> Unit) {
        TextOnlyScope<Lang, LetterData>().apply(create)
            .let { Element.OutlineContent.ParagraphContent.AbstractList.Item(it.elements) }

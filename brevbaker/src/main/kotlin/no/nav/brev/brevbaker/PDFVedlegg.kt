...
class PDFVedlegg(val name: String, val tittel: Map<LanguageCode, String>, val sider: List<Side>) {
    init {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return this.name == other.name && this.tittel == other.tittel && this.sider == other.sider
    }
    override fun hashCode() = Objects.hash(name, tittel, sider)
    override fun toString() = "PDFVedlegg(name=$name, tittel=$tittel, sider=$sider)"
}

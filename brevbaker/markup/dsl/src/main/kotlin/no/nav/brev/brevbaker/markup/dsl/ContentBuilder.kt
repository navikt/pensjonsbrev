...
class ContentBuilder internal constructor() : AbstractContentBuilder() {
    ...
    fun text(text: String, fontType: FontType = FontType.PLAIN) {
        texts.add(MarkupModel.literal(0, text, fontType))
    }
     ...
     */
    fun newLine() {
        texts.add(MarkupModel.newLine(0))
    }
}
...
class PlainTextBuilder internal constructor() {
    ...
    fun text(text: String) {
        texts.add(MarkupModel.literal(0, text, FontType.PLAIN))
    }
...
internal fun plainText(text: String): List<Text> = listOf(MarkupModel.literal(0, text, FontType.PLAIN))

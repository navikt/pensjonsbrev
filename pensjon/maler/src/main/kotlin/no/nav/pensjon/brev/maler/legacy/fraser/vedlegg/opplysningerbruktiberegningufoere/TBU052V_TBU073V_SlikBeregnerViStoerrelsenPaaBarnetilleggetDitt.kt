...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.sivilstand_ektefelle_partner_samboer_bormed_ut_en
import no.nav.pensjon.brev.maler.legacy.pegruppe10.sivilstand_ektefelle_partner_samboer_bormed_ut_en_cohabiting_partner
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_btfbinntektbruktiavkortningminusbtfbfribelop
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_btsbinntektbruktiavkortningminusbtsbfribelop
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_etteroppgjor_bt_utbetalt
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_tbu069v
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_tbu605
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_tbu605v_eller_til_din
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_tbu606v_tbu608v
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_tbu606v_tbu611v
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_tbu608_far_ikke
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_tbu609v_tbu611v
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_tbu611_far_ikke
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_tbu613v
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_tbu613v_1_3
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_tbu613v_4_5
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggfelles_avkortningsinformasjon_justeringsbelopperar_utenminus
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggserkull_avkortningsinformasjon_justeringsbelopperar_utenminus
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_antallbarnserkull
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggfelles_btfbbruttoperar
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggfelles_btfbnettoperar
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggserkull_btsbbruttoperar
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggserkull_btsbnettoperar
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkarvirkningfom
        ...
        showIf(
            ...
            paragraph {
                text(
                    ...
                    english { + "If both parents receive disability benefits, child supplement is paid to the parent who has the right to the highest supplement. " },
                )
            }
        }
        ...
        showIf((pe.ut_tbu069v() and (not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget()) and pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()))) {
            ...
            paragraph {
                text(
                    ...
                    english { + "If both parents receive disability benefits, child supplement is paid to the parent who has the daily care of the child. If the parents have joint daily care of the child, the child supplement will be paid to the parent who lives at the same address, registered in the population register, as the child." },
                )
            }
        }

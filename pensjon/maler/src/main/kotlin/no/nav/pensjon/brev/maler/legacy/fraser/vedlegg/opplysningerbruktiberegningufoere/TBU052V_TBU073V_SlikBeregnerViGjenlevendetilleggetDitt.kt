        ...
        showIf(
            ...
            title1 {
                text(
                    ...
                    english { + "This is how we calculate your survivor's supplement" },
                )
            }
            paragraph { text(
            ...
            paragraph {
                text(
                    ...
                    english { + "You will get disability benefit without survivor's supplement in the case of your own disability benefit being higher then the disability benefit including the deceased rights." }
                )
            }
            paragraph {
                text(
                    ...
                    english { + "Your survivor's supplement is adjusted in accordance with your degree of disability and your period of national insurance coverage." }
                )
            }
        }

...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksbrev_vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_fortsattmedlemskap_inngangunntak
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_minsteytelse_oppfyltungufor
            ...
            showIf((pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_avkortningsinformasjon_belopsgrense().equalTo(60000) and pe.vedtaksdata_beregningsdata_beregningufore_uforetrygdberegning_mottarminsteytelse())){
                ...
                title1 {
                    text (
                        ...
                        english { + "You have been granted minimum benefit" },
                    )
                }
            }
            ...
            showIf((pe.vedtaksdata_beregningsdata_beregningufore_uforetrygdberegning_mottarminsteytelse())){
                ...
                paragraph {
                    text (
                        ...
                        english { + "For you, the minimum benefit is equal to " + pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_minsteytelse_sats().format(3) + " times the National Insurance basic amount. This will be adjusted based on your degree of disability and your insurance period in Norway. In case of changes in your marital status, you are obliged to inform Nav because your disability benefit may change." },
                    )
                }
            }
            ...
            showIf((pe.vedtaksdata_kravhode_onsketvirkningsdato().legacyGreaterThanOrEqual(LocalDate.of(2024,7,1)) and pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_minsteytelse_oppfyltungufor() and pe.ut_vilkargjelderpersonalder().lessThan(20) and pe.vedtaksdata_beregningsdata_beregningufore_uforetrygdberegning_mottarminsteytelse())){
                ...
                paragraph {
                    text (
                        ...
                        english { + "From the month you turn 20 years old, your disability benefit will be calculated in accordance with your rights as a young disabled person. Your benefit will then be " },
                    )
                    ...
                    text (
                        ...
                        english { + " times the National Insurance basic amount. Your minimum benefit will be adjusted based on your degree of disability." },
                    )
                }
            }
            ...
            showIf((pe.vedtaksdata_kravhode_onsketvirkningsdato().legacyLessThan(LocalDate.of(2024,7,1)) and pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_minsteytelse_oppfyltungufor() and pe.ut_vilkargjelderpersonalder().lessThan(20) and pe.vedtaksdata_beregningsdata_beregningufore_uforetrygdberegning_mottarminsteytelse())){
                ...
                paragraph {
                    ...
                    text (
                        ...
                        english { + " times the National Insurance basic amount. Your minimum benefit will be adjusted based on your degree of disability. From 1 July 2024 your benefit will be 2,709/2,959 times the National Insurance basic amount." },
                    )
                }
            }
            ...
            showIf((pe.vedtaksdata_beregningsdata_beregningufore_uforetrygdberegning_beregningsmetode().notEqualTo("eos") and pe.vedtaksdata_beregningsdata_beregningufore_uforetrygdberegning_beregningsmetode().notEqualTo("folketrygd") and pe.vedtaksdata_beregningsdata_beregningufore_uforetrygdberegning_beregningsmetode().notEqualTo("nordisk") and pe.vedtaksbrev_vedtaksdata_vilkarsvedtak_vilkar_medlemskapforutettertrygdeavtaler_oppfyltvedsammenlegging())){
                ...
                paragraph {
                    text (
                        ...
                        english { + "We have calculated your disability benefit in accordance with the conditions of the national insurance agreement with " + pe.grunnlag_persongrunnlagsliste_trygdeavtaler_avtaleland() + ", because the conditions for disability benefit eligibility have been met by combining insurance periods in Norway and " + pe.grunnlag_persongrunnlagsliste_trygdeavtaler_avtaleland() + ". Your disability benefit has first been calculated on the basis of your total pensionable income in Norway and " + pe.grunnlag_persongrunnlagsliste_trygdeavtaler_avtaleland() + ". Then, your disability benefit has been multiplied by the ratio between your actual insurance periods in Norway and total actual insurance periods in Norway and " + pe.grunnlag_persongrunnlagsliste_trygdeavtaler_avtaleland() + ". You can see the data we have used in our calculations in the table " + quoted("Data used in calculations") +"." },
                    )
                }
            }

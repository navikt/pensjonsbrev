package no.nav.pensjon.brev.maler.legacy.fraser.vedlegg.opplysningerbruktiberegningufoere.minsteytelse
    ...
    override fun OutlineOnlyScope<LangBokmalNynorsk, Unit>.template() {
        ...
        showIf(pe.pebrevkode().isNotAnyOf("PE_UT_07_100", "PE_UT_05_100", "PE_UT_04_300", "PE_UT_14_300", "PE_UT_04_103", "PE_UT_04_108", "PE_UT_07_200", "PE_UT_06_300")
            ...
            showIf(pe.vedtaksdata_beregningsdata_beregningufore_uforetrygdberegning_mottarminsteytelse()) {
                ...
                }.orShowIf((pe.ut_vilkargjelderpersonalder().greaterThanOrEqual(20) and pe.vedtaksdata_kravhode_onsketvirkningsdato().legacyLessThan(LocalDate.of(2024, 7, 1)) and pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_vilkar_unguforresultat().equalTo("oppfylt"))) {
                    paragraph {
                        text(
                ...
                showIf (ungUforUnder20) {
                    showIf(pe.vedtaksdata_kravhode_onsketvirkningsdato().legacyGreaterThanOrEqual(LocalDate.of(2024, 7, 1))) {
                        paragraph {
                            text(

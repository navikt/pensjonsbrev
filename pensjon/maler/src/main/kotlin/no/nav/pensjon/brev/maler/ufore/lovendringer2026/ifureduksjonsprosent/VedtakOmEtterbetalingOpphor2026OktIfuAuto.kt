...
object VedtakOmEtterbetalingOpphor2026OktIfuAuto : AutobrevTemplate<VedtakOmEtterbetalingOpphor2026AutoDto> {

    override val kode = Pesysbrevkoder.AutoBrev.UT_VEDTAK_ETTERBETALING_OPPHOR_2026_OKT_IFU

    override val template = createTemplate(
        languages = languages(Language.Bokmal, Language.Nynorsk),
        letterMetadata = LetterMetadata(
            displayTitle = "Vedtaksbrev opphørt sak - økt minste IFU",

    ...
    createAttachment<LangBokmalNynorskEnglish, EmptyVedleggData>(
        title = {
            text(
                bokmal { +"Folketrygden" },
                nynorsk { +"Folketrygda" },
                english { +"Social Insurance Scheme" }
            )
        },
        ...
        title2 {
            text(
                bokmal { +"Vedlegg til vedtak som du kan klage over/anke" },
                nynorsk { +"Vedlegg til vedtak som du kan klage over/anke" },
                english { +"Attachments to decisions which you can appeal" }
            )
        }
        title1 {
            text(
        ...
        paragraph {
            text(
                bokmal { +"Dersom et vedtak blir endret til gunst for deg, kan du få dekket de nødvendige utgiftene du har hatt for å få endret vedtaket. " +
                        ...
                        "Krav om å få dekket sakskostnader skal sendes til <FF01_NAV>." },
                nynorsk { +"Dersom eit vedtak blir endra til gunst for deg, kan du få dekt dei nødvendige utgiftene du har hatt for å få endra vedtaket. " +
                        ...
                        "Krav om å få dekt sakskostnader skal sendast til <FF01_NAV>." },
                english { +"If a decision is amended in your favour, you may have the necessary expenses you have incurred to amend the decision covered. " +
                        ...
                        "Claims for case costs to be covered must be sent to <FF01_NAV> services." }
            )
        }
        title2 {
            text(
        ...
        paragraph {
            text(
                bokmal { +"Dersom du har behov for juridisk bistand i trygdesaken din, kan du på visse vilkår få utgiftene dekket etter reglene om fri rettshjelp. " +
                ...
                nynorsk { +"Dersom du har behov for juridisk hjelp i trygdesaka di, kan du på visse vilkår få utgiftene dekt etter reglane om fri rettshjelp. " +
                ...
                english { +"If you have need of legal aid in your national insurance case, you may, under certain conditions, have your expenses covered under the rules of free legal aid. " +

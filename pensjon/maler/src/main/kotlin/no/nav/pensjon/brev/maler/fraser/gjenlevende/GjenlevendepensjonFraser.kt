...
object GjenlevendepensjonFraser {
    ...
    object FyllInnEgenTekst : OutlinePhrase<LangBokmalNynorskEnglish>() {
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            paragraph {
                val fritekst = fritekst("Fyll inn egen tekst.")
                text(bokmal { +fritekst }, nynorsk { +fritekst }, english { +fritekst })
            }
        }
    }
        ...
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            paragraph {
                text(
                    ...
                    nynorsk { +"Pensjonen er berekna etter full trygdetid (40 år) fordi avdøde var flyktning." },
                    english {

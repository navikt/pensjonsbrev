...
// Erstatte PE_IY_03_162 Klage - orientering om saksbehandlingstid ved Nav Klageinstans

@TemplateModelHelpers
object KlageOrienteringOmSaksbehandlingstidVedNavKlageinstans : RedigerbarTemplate<EmptyRedigerbarBrevdataMedSaksbehandlerValg> {

    override val featureToggle = FeatureToggles.brevmalKlageOrienteringOmSaksbehandlingstidVedNavKlageinstans.toggle

    override val kode = PE_KLAGE_SAKSBEHANDLINGSTID_VED_KLAGEINSTANS
    ...
    override val template = createTemplate(
        ...
        letterMetadata = LetterMetadata(
            displayTitle = "Klage - orientering om saksbehandlingstid ved Nav Klageinstans",
        ...
        outline {
            ...
            paragraph {
                text(
                    bokmal { +"Vi har " + fritekst("mottaksdato for klagen") + " mottatt klagen over " + fritekst("Navn på Nav saksbehandlingsenhet") + " vedtak av " + fritekst("vedtaksdato") + "." },
                    english { +"On " + fritekst("mottaksdato for klagen") + " we received an appeal about " + fritekst("Navn på Nav saksbehandlingsenhet") + " decision of " + fritekst("vedtaksdato") + "." }
                )
            }

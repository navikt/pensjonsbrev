...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.barnetilleggfelles_justeringsbelopperarutenminus
import no.nav.pensjon.brev.maler.legacy.pegruppe10.barnetilleggserkull_justeringsbelopperarutenminus
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.nettoakk_pluss_nettorestar
import no.nav.pensjon.brev.maler.legacy.pegruppe10.pe_ut_barnet_barna_felles_serkull
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_vilfylle67ivirkningfomar
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_virkningfomar
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_virkningstidpunktarminus1ar
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggfelles_avkortningsinformasjon_avkortingsbelopperar
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggfelles_avkortningsinformasjon_fribelopperiodisert
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggfelles_avkortningsinformasjon_inntektperiodisert
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggserkull_avkortningsinformasjon_avkortingsbelopperar
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggserkull_avkortningsinformasjon_fribelopperiodisert
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggserkull_avkortningsinformasjon_inntektperiodisert
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_belopsendring_uforetrygdordineryk_belopnyut
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_avkortingsbelopperar
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_avkortningsinformasjon_inntektstak

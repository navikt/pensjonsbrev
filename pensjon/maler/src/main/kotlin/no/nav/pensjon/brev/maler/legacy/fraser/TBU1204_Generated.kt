    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
		...
		paragraph {
			text (
				...
				english { + "You may earn an income at the same time as receiving disability benefit. It pays to work because income and disability benefit will always be higher than your disability benefit alone." },
			)
		}
    }
}

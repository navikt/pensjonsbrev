    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            showIf((pe.vedtaksdata_beregningsdata_beregning_beregningnokkelinfo_beregningnokkelinfo2_beregningsmetode2().equalTo("folketrygd") or pe.grunnlag_persongrunnlagslisteavdod_inngangogeksportgrunnlag_minsttrearsfmnorge() or pe.grunnlag_persongrunnlagslisteavdod_inngangogeksportgrunnlag_minstettarfmnorge() or pe.grunnlag_persongrunnlagslisteavdod_inngangogeksportgrunnlag_unntakfraforutgaendemedlemskap() or pe.grunnlag_persongrunnlagslisteavdod_inngangogeksportgrunnlag_oppfyltettergamleregler())){
                ...
                showIf((pe.grunnlag_persongrunnlagslisteavdod_inngangogeksportgrunnlag_eksportforbud() and pe.grunnlag_persongrunnlagslisteavdod_inngangogeksportgrunnlag_eksportunntak().equalTo("dod26_gjenlev"))){
                    ...
                    paragraph {
                        text (
                            ...
                            english { + " An exemption to this requirement is made if the deceased was a member of the National Insurance Scheme at the time of death and had not yet turned 26." },
                                )
                            }
                    }
                    //[Table, Table 2]
                ...
                showIf((pe.vedtaksdata_beregningsdata_beregning_beregningsinformasjonkapittel19_yug().notEqualTo(false) and not(pe.vedtaksdata_beregningsdata_beregning_beregningssammendragavdod_avdoddodsfallskyldesyrkesskade()))){
                    //[PE_GP_04_024_forventet_inntekt]
                ...
                showIf((FUNKSJON_FF_GetArrayElement_String(pe.grunnlag_persongrunnlagsliste_trygdeavtaler_avtaletype(),1).equalTo("eos_nor"))){
                    //[PE_GP_04_024_dine_plikter]
                ...
                showIf((pe.vedtaksdata_beregningsdata_beregning_beregningsivilstandanvendt().equalTo(pe.sivilstandanvendt_enslig()))){
                    //[PE_GP_04_024_dine_plikter]
                ...
                showIf((pe.vedtaksdata_beregningsdata_beregning_beregningsivilstandanvendt().equalTo(pe.sivilstandanvendt_bormed_3_2()))){
                    //[PE_GP_04_024_dine_plikter]

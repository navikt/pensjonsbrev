...
object AdhocInformasjonHvilendeRett4Aar : AutobrevTemplate<EmptyAutobrevdata> {
    override val kode = Pesysbrevkoder.AutoBrev.PE_UT_ADHOC_2024_INFO_HVILENDE_RETT_4_AAR
    override val template = createTemplate(
        ...
        outline {
            paragraph {
                text(
                    bokmal { + "Du har siden 2020 ikke fått utbetaling av uføretrygd fordi inntekten din har vært over 80 prosent av oppjustert inntekt før du ble ufør. Du har derfor fått innvilget en hvilende rett." },
                )
            }
            paragraph {
                text(
            ...
            paragraph {
                text(
                    bokmal { + "Du har ikke hatt utbetaling av uføretrygd siden 2020. Du kan derfor ha en hvilende rett til uføretrygd i ytterligere fem år før uføretrygden opphøres. Ved opphør av uføretrygden vil du få et eget varsel og vedtak om dette." },
                )
            }
            paragraph {
                text(

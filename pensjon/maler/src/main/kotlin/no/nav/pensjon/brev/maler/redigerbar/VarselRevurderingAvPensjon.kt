...
import no.nav.pensjon.brev.api.model.maler.redigerbar.VarselRevurderingAvPensjonDto.SaksbehandlerValg.TittelValg
            ...
            ifNotNull(tittelValg) { t ->
                ...
                showIf(sakstype.equalTo(ALDER)) {
                    paragraph {
                        text(
                            bokmal {
                                +"Du kan sende uttalelsen din ved å logge deg inn på $DIN_PENSJON_URL og velge " + quoted("Kontakt Nav om pensjon") + ", " +
                            ...
                            nynorsk {
                                +"Du kan sende uttalen din ved å logge deg inn på $DIN_PENSJON_URL og velje " + quoted("Kontakt Nav om pensjon") + ", " +
                            ...
                            english {
                                +"You can submit your statement by logging in to your personal $DIN_PENSJON_URL pension page and selecting " + quoted("Kontakt Nav om pensjon") + ", " +
                    ...
                    paragraph {
                        text(
                            bokmal {
                                +"Du kan sende uttalelsen din ved å logge deg inn på $BESKJED_TIL_NAV_URL og velge " + quoted("Send beskjed til Nav") + ". " +
                                        "Du kan også sende uttalelsen din til oss i posten. Adressen finner du på $ETTERSENDELSE_URL."
                            },
                            nynorsk {
                                +"Du kan sende uttalen din ved å logge deg inn på $BESKJED_TIL_NAV_URL og velje " + quoted("Send beskjed til Nav") + ". " +

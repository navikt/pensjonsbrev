...
import no.nav.pensjon.brev.api.model.maler.redigerbar.selectors.vedtakEndringAvUttaksgradStansBrukerEllerVergeDto.*
import no.nav.pensjon.brev.api.model.maler.Pesysbrevkoder
import no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAvUttaksgradStansBrukerEllerVergeDto
import no.nav.pensjon.brev.api.model.maler.redigerbar.selectors.vedtakEndringAvUttaksgradStansBrukerEllerVergeDto.alderspensjonVedVirk.*
import no.nav.pensjon.brev.api.model.maler.redigerbar.selectors.vedtakEndringAvUttaksgradStansBrukerEllerVergeDto.krav.*
import no.nav.pensjon.brev.api.model.maler.redigerbar.selectors.vedtakEndringAvUttaksgradStansBrukerEllerVergeDto.pesysData.*

...
import no.nav.pensjon.brev.api.model.maler.redigerbar.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.alderspensjonVedVirk.*
import no.nav.pensjon.brev.api.model.maler.redigerbar.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.beregnetPensjonPerMaanedVedVirk.*
import no.nav.pensjon.brev.api.model.maler.redigerbar.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.bruker.*
import no.nav.pensjon.brev.api.model.maler.redigerbar.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.inngangOgEksportVurderingAvdoed.*
import no.nav.pensjon.brev.api.model.maler.redigerbar.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.inngangOgEksportVurdering.*
import no.nav.pensjon.brev.api.model.maler.redigerbar.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.krav.*

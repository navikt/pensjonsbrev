...
override val featureToggle = FeatureToggles.brevmalAvslagGjenlevendepensjon.toggle
    ...
    override val template = createTemplate(
        ...
        outline {
            paragraph {
                text(
                    bokmal { +"Nav viser til søknaden din om gjenlevendepensjon mottatt " + pesysData.kravMottattDato.format() + ". Søknaden din er avslått." }, //TODO
                    nynorsk { +"Nav viser til søknaden din om etterlatnepensjon motteken " + pesysData.kravMottattDato.format() + ". Søknaden din er avslått." },
            ...
            ifNotNull(saksbehandlerValg.folketrygdlovenParagraf) { paragraf ->
                showIf(paragraf.isOneOf(AvslagGjenlevendepensjonDto.SaksbehandlerValg.FolketrygdlovenParagraf.paragraf17_2_foersteEllerTredje_ledd)) {
                    paragraph {
                        text(
                            bokmal {
                                +"I folketrygdloven paragraf 17-2 er det angitt hvilke personer som kan få rett til ytelser til gjenlevende ektefelle. "
                                +"Du tilhører ikke denne gruppen fordi "
                                +fritekst("Angi grunn") + "."
                            },
                            nynorsk {
                                +"I folketrygdlova paragraf 17-2 er det fastsett kven som kan få rett til ytingar til attlevande ektefelle. "
                                +"Du høyrer ikkje til denne gruppa fordi "
                                +fritekst("Angi grunn") + "."
                            },
                            english {
                                +"The National Insurance Act paragraph 17-2 specifies who may have the right to receive benefit as a surviving spouse. "
                                +"You are not entitled to survivor’s benefit in accordance with this provision because "
                                +fritekst("Angi grunn") + "."
                            }
                        )
                    }
                }.orShowIf(paragraf.isOneOf(AvslagGjenlevendepensjonDto.SaksbehandlerValg.FolketrygdlovenParagraf.paragraf17_2_andre_ledd)) {
                    paragraph {
                        text(
                            bokmal {
                                ...
                                +"Du har ikke rett til gjenlevendepensjon etter denne bestemmelsen fordi "
                                +fritekst("Angi grunn") + "."
                            },
                            nynorsk {
                                ...
                                +"Du har ikkje rett til attlevandepensjon etter denne føresegna fordi "
                                +fritekst("Angi grunn") + "."
                            },
                            english {
                ...
                }.orShowIf(paragraf.isOneOf(AvslagGjenlevendepensjonDto.SaksbehandlerValg.FolketrygdlovenParagraf.paragraf17_3)) {
                    paragraph {
                        text(
                            bokmal {
                                +"Etter hovedregelen i folketrygdloven paragraf 17-3 er det et vilkår for rett til gjenlevendepensjon at avdøde de siste "
                                +fritekst("tre/fem") + " årene fram til dødsfallet var medlem i folketrygden. "
                                +"Vi har lagt til grunn at avdøde de siste "
                                +fritekst("tre/fem") + " årene hadde følgende medlemsperioder "
                                +fritekst("FOM - TOM") + "."
                            ...
                            nynorsk {
                                +"Etter hovudregelen i folketrygdlova paragraf 17‑3 er det eit vilkår for rett til attlevandepensjon at den avdøde dei siste "
                                +fritekst("tre/fem") + " åra fram til dødsfallet var medlem i folketrygda. "
                                +"Vi har lagt til grunn at den avdøde dei siste "
                                +fritekst("tre/fem") + " åra hadde følgjande medlemsperiodar "
                                +fritekst("FOM - TOM") + "."
                            ...
                            english {
                                +"The main provision of paragraph 17-3 of the National Insurance Act states that it is a requirement for a survivor's pension that the deceased had been a member of the National Insurance Scheme during the "
                                +fritekst("three/five") + " years prior to death. "
                                +"We have based our decision on our finding that the deceased in the "
                                +fritekst("three/five") + " years prior to death was a member of the National Insurance Scheme for the following period(s) "
                                +fritekst("FOM - TOM") + "."
                                +"Thus the National Insurance Scheme's requirement that the deceased must have been a member for "
                                +fritekst("three/five") + " years prior to death has not been met, and there are no exemption rules that entitle you to a survivor's benefit."
                            }
                        )
                    }
                }.orShowIf(paragraf.isOneOf(AvslagGjenlevendepensjonDto.SaksbehandlerValg.FolketrygdlovenParagraf.paragraf17_5)) {
                    paragraph {
                        text(
                            bokmal {
                                ...
                                +"Du fyller ikke disse vilkårene fordi "
                                +fritekst("Angi grunn") + ". Vi har også vurdert din rett til overgangsstønad til gjenlevende ektefelle etter folketrygdloven paragraf 17-6. "
                                +"Du fyller ikke rett til overgangsstønad fordi "
                                +fritekst("Angi grunn") + "."
                            },
                            nynorsk {
                            ...
                            english {
                                ...
                                +"You do not meet these requirements because "
                                +fritekst("Angi grunn") + "."
                                ...
                                +"You do not meet the requirements for transitional benefit because "
                                +fritekst("Angi grunn") + "."
                            }
                        )
                    }
                }.orShowIf(paragraf.isOneOf(AvslagGjenlevendepensjonDto.SaksbehandlerValg.FolketrygdlovenParagraf.paragraf17_10)) {
                    paragraph {
                        text(
                            bokmal {

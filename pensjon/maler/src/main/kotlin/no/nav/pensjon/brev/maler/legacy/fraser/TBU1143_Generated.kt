...
data class TBU1143_Generated(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
		//[TBU1143NN, TBU1143EN, TBU1143]

		paragraph {
			text (
				bokmal { + "Vedtaket er gjort etter folketrygdloven §§ 12-2 til 12-14, 12-17, 12-18 og " },
				nynorsk { + "Vedtaket er gjort etter folketrygdlova §§ 12-2 til 12-14, 12-17, 12-18 og " },
				english { + "The decision has been made pursuant to Section 12-2 to 12-14, 12-17, 12-18 and " },
			)

    ...
    override fun OutlineOnlyScope<LangBokmalNynorsk, Unit>.template() {
            ...
            paragraph {
                table(
                    header = {
                        column(columnSpan = 3) {
                            text (
                                bokmal { + "Utbetaling før skatt" },
                                nynorsk { + "Utbetalinga før skatt" },
                            )
                        }
        ...
        showIf(
            ...
            paragraph {
                text (
                    ...
                    nynorsk { + "Utbetalinga av uføretrygda di er redusert, fordi du har inntekt. Den innmelde inntekta er høgare enn botnfrådraget ditt på " + pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_avkortningsinformasjon_bunnfradrag()
        ...
        showIf(
            (pe.vedtaksdata_beregningsdata_beregningufore_belopsendring_uforetrygdordineryk_belopnyut()
                .equalTo(0) and pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_avkortningsinformasjon_bunnfradrag()
            ...
            paragraph {
                text (
                    ...
                    nynorsk { + "Du får tilbake " + pe.vedtaksdata_beregningsdata_beregningufore_uforetrygdberegning_uforegrad()
                        .format() + " prosent uføretrygd utan søknad dersom du tener mindre enn botnfrådraget ditt. Dersom du allereie har fått utbetalt det du har rett til i uføretrygd for kalenderåret, får du ikkje utbetalt uføretrygd med den opphavlege uføregraden din før neste kalenderår." },
                )
            }
        }
    }

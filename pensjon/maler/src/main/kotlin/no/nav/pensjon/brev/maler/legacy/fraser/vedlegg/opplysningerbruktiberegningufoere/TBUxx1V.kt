...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.avdod_fremtidig_trygdetid_under_40_aar
import no.nav.pensjon.brev.maler.legacy.pegruppe10.grunnlag_persongrunnlagavdod_brukerflyktning
import no.nav.pensjon.brev.maler.legacy.pegruppe10.grunnlag_persongrunnlagavdod_fodselsnummer
import no.nav.pensjon.brev.maler.legacy.pegruppe10.pebrevkode
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_fattnorgeplusfatta10netto_avdod
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_fattnorgeplusfattbilateral_avdod
import no.nav.pensjon.brev.maler.legacy.pegruppe10.ut_fattnorgeplusfatteos_avdod
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningvirkningdatofom
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gjenlevendetillegginformasjon_anvendttrygdetid
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gjenlevendetillegginformasjon_beregningsgrunnlagavdodordiner_arsbelop
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gjenlevendetillegginformasjon_beregningsgrunnlagavdodyrkesskadearsbelop
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gjenlevendetillegginformasjon_inntektvedskadetidspunktet
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gjenlevendetillegginformasjon_minsteytelsebenyttetungufor
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gjenlevendetillegginformasjon_uforetidspunkt
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gjenlevendetillegginformasjon_yrkesskadegrad
...
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_fatt_a10_netto
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_fatteos
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_fattnorge
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_framtidigtteos
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_framtidigttnorsk
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_ttnevnereos
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_ttnevnernordisk
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_ttnordisk
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_tttellereos
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_tttellernordisk
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_ttutlandtrygdeavtale_fattbilateral
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_ttutlandtrygdeavtale_framtidigttavtaleland
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_ttutlandtrygdeavtale_ttnevnerbilateral
import no.nav.pensjon.brev.maler.legacy.pegruppe10.vedtaksdata_trygdetidavdod_ttutlandtrygdeavtale_tttellerbilateral
...
data class TBUxx1V (val pe: Expression<PEgruppe10>) : OutlinePhrase<LangBokmalNynorskEnglish>(){

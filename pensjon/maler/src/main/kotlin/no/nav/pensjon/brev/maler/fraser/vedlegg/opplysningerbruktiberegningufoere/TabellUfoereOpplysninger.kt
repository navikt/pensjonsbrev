...
import no.nav.pensjon.brev.api.model.vedlegg.selectors.opplysningerBruktIBeregningUTDto.barnetilleggGjeldende.fellesbarn.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.opplysningerBruktIBeregningUTDto.barnetilleggGjeldende.saerkullsbarn.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.opplysningerBruktIBeregningUTDto.barnetilleggGjeldende.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.opplysningerBruktIBeregningUTDto.beregnetUTPerManedGjeldende.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.opplysningerBruktIBeregningUTDto.inntektFoerUfoereGjeldende.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.opplysningerBruktIBeregningUTDto.inntektsAvkortingGjeldende.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.opplysningerBruktIBeregningUTDto.trygdetidsdetaljerGjeldende.utenforEOSogNorden.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.opplysningerBruktIBeregningUTDto.trygdetidsdetaljerGjeldende.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.opplysningerBruktIBeregningUTDto.ufoeretrygdGjeldende.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.opplysningerBruktIBeregningUTDto.yrkesskadeGjeldende.*
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        paragraph {
            table(
                ...
                ifNotNull(yrkesskadeGjeldende.safe { beregningsgrunnlagBeloepAar }) { beloep ->
                    showIf(beloep.greaterThan(0)) {
                        row {
                            cell {
                                text(
                                    bokmal { + "Beregningsgrunnlag yrkesskade" },
                                    nynorsk { + "Utrekningsgrunnlag yrkesskade" },
                ...
                ifNotNull(barnetilleggGjeldende) { barnetillegg ->
                    ...
                    val samletInntektBruktIAvkortningFelles =
                        barnetillegg.fellesbarn.safe { samletInntektBruktIAvkortning }.ifNull(Kroner(0))
                    val inntektBruktIAvkortningSaerkull =
                        barnetillegg.saerkullsbarn.safe { inntektBruktIAvkortning }.ifNull(Kroner(0))
                    showIf(
                    ...
                    val inntektstakFelles = barnetillegg.fellesbarn.safe { inntektstak }.ifNull(Kroner(0))
                    val inntektstakSaerkull = barnetillegg.saerkullsbarn.safe { inntektstak }.ifNull(Kroner(0))

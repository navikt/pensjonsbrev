...
import no.nav.pensjon.brev.maler.ufore.diverse.OrienteringOmSaksbehandlingstidRedigerbarV2
import no.nav.pensjon.brev.maler.ufore.VarselSaksbehandlingstidAutoV2
...
fun hentMuligOverstyrtMal(kode: String) = when (kode) {
    ...
    ) -> OrienteringOmSaksbehandlingstidRedigerbarV2

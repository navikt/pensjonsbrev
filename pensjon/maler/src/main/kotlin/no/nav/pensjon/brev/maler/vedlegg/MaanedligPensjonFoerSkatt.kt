...
import no.nav.pensjon.brev.api.model.vedlegg.selectors.maanedligPensjonFoerSkattDto.alderspensjonGjeldende.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.maanedligPensjonFoerSkattDto.barnetilleggGjeldende.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.maanedligPensjonFoerSkattDto.bruker.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.maanedligPensjonFoerSkattDto.ektefelletilleggGjeldende.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.maanedligPensjonFoerSkattDto.institusjonsoppholdGjeldende.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.maanedligPensjonFoerSkattDto.krav.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.maanedligPensjonFoerSkattDto.saerskiltSatsGjeldende.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.maanedligPensjonFoerSkattDto.*
import no.nav.pensjon.brev.api.model.vedlegg.selectors.maanedligPensjonFoerSkattTabell.alderspensjonPerManed.*
...
val vedleggMaanedligPensjonFoerSkatt = createAttachment<LangBokmalNynorskEnglish, MaanedligPensjonFoerSkattDto>(
    ...
    outline = {
        ...
        val harGjenlevendeTilleggKap19 =
            beregnetPensjonPerManedGjeldende.safe { gjenlevendetilleggKap19 }.ifNull(Kroner(0)).greaterThan(0)

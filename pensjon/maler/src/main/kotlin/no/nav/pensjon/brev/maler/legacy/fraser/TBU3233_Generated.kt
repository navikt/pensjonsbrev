...
data class TBU3233_Generated(
    val pe: Expression<PEgruppe10>,
) : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
		//[TBU3233NN, TBU3233EN, TBU3233]

		paragraph {
			text (
				bokmal { + "Vedtaket er gjort etter folketrygdloven §§ 12-2 til 12-14, 12-19 og " },
				nynorsk { + "Vedtaket er gjort etter folketrygdlova §§ 12-2 til 12-14, 12-19 og " },
				english { + "The decision has been made pursuant to Section 12-2 to 12-14, 12-19 and " },
			)

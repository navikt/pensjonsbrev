package no.nav.pensjon.brev.maler.ufore.avslag
...
import no.nav.pensjon.brev.api.model.maler.legacy.redigerbar.selectors.avslagUfoeretrygdDto.pesysData.*
import no.nav.pensjon.brev.api.model.maler.legacy.redigerbar.selectors.avslagUfoeretrygdDto.*
...
object AvslagUfoeretrygdRedigerbar : RedigerbarTemplate<AvslagUfoeretrygdDto> {
        ...
        outline {
            ...
            showIf(pe.vedtaksdata_kravhode_kravgjelder().equalTo("sok_okn_ug")) {
                ...
                paragraph {
                    text(
                        bokmal {
                            +"Vi har avslått søknaden din om økt uføretrygd som vi mottok " + pe.vedtaksdata_kravhode_kravmottatdato()
                                .format() + "."
                        },
                        nynorsk {
                            +"Vi har avslått søknaden din om auka uføretrygd som vi fekk " + pe.vedtaksdata_kravhode_kravmottatdato()
                                .format() + "."
                        },
                        english {
                            +"We have denied your application for increased disability benefit, which we received on " + pe.vedtaksdata_kravhode_kravmottatdato()
                                .format() + "."
                        },
                    )
                }
            ...
            showIf(pe.vedtaksdata_kravhode_kravgjelder().equalTo("sok_ys")) {
                ...
                paragraph {
                    text(
                        bokmal {
                            +"Vi har avslått søknaden din om særbestemmelser for yrkesskade eller yrkessykdom i uføretrygden, som vi mottok " + pe.vedtaksdata_kravhode_kravmottatdato()
                                .format() + "."
                        },
                        nynorsk {
                            +"Vi har avslått søknaden din om særreglar for yrkesskade eller yrkessjukdom i uføretrygda som vi fekk " + pe.vedtaksdata_kravhode_kravmottatdato()
                                .format() + "."
                        },
                        english {
                            +"We have denied your application for special rules pertaining to occupational injury or occupational illness to be applied to your disability benefit, which we received on " + pe.vedtaksdata_kravhode_kravmottatdato()
                                .format() + "."
                        },
                    )
                }
            ...
            showIf(pe.vedtaksdata_kravhode_kravgjelder().equalTo("sok_uu")) {
                ...
                paragraph {
                    text(
                        bokmal {
                            +"Vi har avslått søknaden din om rettighet som ung ufør som vi mottok " + pe.vedtaksdata_kravhode_kravmottatdato()
                                .format() + "."
                        },
                        nynorsk {
                            +"Vi har avslått søknaden din om rett som ung ufør som vi fekk " + pe.vedtaksdata_kravhode_kravmottatdato()
                                .format() + "."
                        },
                        english {
                            +"We have denied your application to be granted rights as a young disabled person, which we received on " + pe.vedtaksdata_kravhode_kravmottatdato()
                                .format() + "."
                        },
                    )
                }
            ...
            showIf(pe.vedtaksdata_kravhode_kravarsaktype().equalTo("endring_ifu")) {
                ...
                paragraph {
                    text(
                        bokmal {
                            +"Vi har avslått søknaden din om å endre den fastsatte inntekten din før du ble ufør, som vi mottok " + pe.vedtaksdata_kravhode_kravmottatdato()
                                .format() + "."
                        },
                        nynorsk {
                            +"Vi har avslått søknaden din om å endre den fastsette inntekta di før du blei ufør, som vi fekk " + pe.vedtaksdata_kravhode_kravmottatdato()
                                .format() + "."
                        },
                        english {
                            +"We have denied your application to change your determined income prior to your disability, which we received on " + pe.vedtaksdata_kravhode_kravmottatdato()
                             .format() + "."
                        },
                    )
                }
            ...
            showIf(
                ...
                paragraph {
                    ...
                    text(
                        bokmal {
                            +"Du flyttet til Norge " + innflyttingsdatoFritekst + ", og ble da medlem av folketrygden. Vi har fastsatt uføretidspunktet ditt til " + uforetidspunkt
                                .format() + ". Da ble inntektsevnen din varig nedsatt med minst "
                        },
                        nynorsk {
                            +"Du flytta til Noreg " + innflyttingsdatoFritekst + ", og blei då medlem av folketrygda. Vi har fastsett uføretidspunktet ditt til " + uforetidspunkt
                                .format() + ". Då blei inntektsevna di varig sett ned med minst "
                        },
                        english {
                            +"You moved to Norway on " + innflyttingsdatoFritekst + ", and you have national insurance coverage from that date. We have determined your date of disability to be " + uforetidspunkt
            ...
            showIf(
                ...
                paragraph {
                    text(
                        bokmal {
                            +"Vi har satt uføretidspunktet ditt til " + uforetidspunkt
                                .format() + ". Da ble inntektsevnen din varig nedsatt med minst "
                        },
                        nynorsk {
                            +"Vi har sett uføretidspunktet ditt til " + uforetidspunkt
                                .format() + ". Då blei inntektsevna di varig sett ned med minst "
                        },
                        english {
                            +"We have determined your date of disability to be " + uforetidspunkt
                                .format() + ". Your earning ability then became permanently reduced by at least "
                        },
                    )
                ...
                showIf(
                    ...
                    paragraph {
                        ...
                        text(
                            ...
                            english {
                                +"Your income prior to your disability was determined as " + pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_ifuinntekt()
                ...
                showIf(
                    ...
                    paragraph {
                        ...
                        text(
                            ...
                            english {
                                +"Your income prior to your disability was established as " + pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_ifuinntekt()
            ...
            showIf(
                ...
                showIf(
                    ...
                    paragraph {
                        text(
                            bokmal {
                                +"Du har en godkjent yrkesskade eller yrkessykdom. Vi har vurdert at " + pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_yrkesskadegrad()
                            ...
                            nynorsk {
                                +"Du har ein godkjend yrkesskade eller yrkessjukdom. Vi har vurdert det slik at " + pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_yrkesskadegrad()
                            ...
                            english {
                                +"You have a certified occupational injury or occupational illness. We have concluded that " + pe.vedtaksdata_vilkarsvedtaklist_vilkarsvedtak_beregningsvilkar_yrkesskadegrad()

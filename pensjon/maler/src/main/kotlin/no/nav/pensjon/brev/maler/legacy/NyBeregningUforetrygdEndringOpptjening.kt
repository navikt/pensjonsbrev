...
object NyBeregningUforetrygdEndringOpptjening : AutobrevTemplate<EndretUfoeretrygdPGAInntektDto> {

    // PE_UT_06_100
    override val kode = Pesysbrevkoder.AutoBrev.UT_NY_BEREGNING_ENDRING_OPPTJENING
    ...
    override val template = createTemplate(
        ...
        title {
            text (
                bokmal { + "Ny beregning av uføretrygd på grunn av endring i opptjening" },
                nynorsk { + "Ny berekning av uføretrygd på grunn av endring i opptjening" },
            )
        }
        outline {
            paragraph {
                text (
                    ...
                    nynorsk { + "Vi har motteke nye opplysningar frå Skatteetaten, og har derfor rekna ut uføretrygda di på nytt." },
                )
            }
            ...
            showIf((pe.vedtaksdata_beregningsdata_beregningufore_belopokt() or pe.vedtaksdata_beregningsdata_beregningufore_belopredusert())){
                paragraph {
                    text (
                        bokmal { + "Utbetalingen er endret med virkning fra " + pe.vedtaksdata_virkningfom().format() + "." },
                        nynorsk { + "Utbetalinga er endra med verknad frå " + pe.vedtaksdata_virkningfom().format() + "." },
                    )
                }
            }
            ...
            paragraph {
                text (
                    ...
                    nynorsk { + "Uføretrygda blir rekna ut frå inntektsåra før du blei ufør. Vi reknar ut uføretrygda på nytt dersom du får endringar i:" },
                )
                text (
                    bokmal { + "Pensjonsgivende inntekt" },
                    nynorsk { + "Pensjonsgivende inntekt" },
                )
                text (
                    bokmal { + "Omsorgspoeng" },
                    nynorsk { + "Omsorgspoeng" },
                )
                text (
            ...
            showIf(pe.vedtaksdata_beregningsdata_beregningufore_belopokt()){
                ...
                paragraph {
                    text (
                        bokmal { + "Du har fått en endring i opptjeningen din før du ble ufør. Dette gir deg en økt uføretrygd fra " + pe.vedtaksdata_virkningfom().format() + ". Du vil derfor motta en etterbetaling fra NAV." },
                        nynorsk { + "Du har fått en endring i opptjeningen din før du ble ufør. Dette gir deg en økt uføretrygd fra " + pe.vedtaksdata_virkningfom().format() + ". Du vil derfor motta en etterbetaling fra NAV." },
                    )
                }
            }
            ...
            showIf(pe.vedtaksdata_beregningsdata_beregningufore_belopredusert()){
                ...
                paragraph {
                    text (
                        bokmal { + "Du har fått en endring i opptjeningen din før du ble ufør. Dette gir deg en redusert uføretrygd fra " + pe.vedtaksdata_virkningfom().format() + "." },
                        nynorsk { + "Du har fått en endring i opptjeningen din før du ble ufør. Dette gir deg en redusert uføretrygd fra " + pe.vedtaksdata_virkningfom().format() + "." },
                    )
                }
            }
            //[TBU2227]
            ...
            paragraph {
                text (
                    bokmal { + "I vedlegget «Opplysninger om beregningen» kan du lese mer om beregningen av uføretrygden din." },
                    nynorsk { + "I vedlegget «Opplysningar om berekninga» kan du lese meir om berekninga av uføretrygda di." },
                )
            }
                ...
                showIf((not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_ektefelletillegg_etinnvilget()))){
                    ...
                    paragraph {
                        text (
                            ...
                            nynorsk { + "Vedtaket er gjort etter folketrygdlova §§ 12-11 til 12-14 og 22-12." },
                        )
                    }
                }
                ...
                showIf(((pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget() or pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_ektefelletillegg_etinnvilget()))){
                    ...
                    paragraph {
                        text (
                            ...
                            nynorsk { + "Vedtaket er gjort etter folketrygdlova §§12-11 til 12-16 og 22-12." },
                        )
                    }
                }
                ...
                showIf((not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()) and pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget() and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_ektefelletillegg_etinnvilget()))){
                    ...
                    paragraph {
                        text (
                            ...
                            nynorsk { + "Vedtaket er gjort etter folketrygdlova §§ 12- 11 til 12-14, 12-18 og 22-12." },
                        )
                    }
                }
                ...
                showIf(((pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget() or pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()) and pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget() and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_ektefelletillegg_etinnvilget()))){
                    ...
                    paragraph {
                        text (
                            ...
                            nynorsk { + "Vedtaket er gjort etter folketrygdlova §§12-11 til 12-16, 12-18 og 22-12." },
                        )
                    }
                }
                ...
                showIf(((pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget() or pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget()) and pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_ektefelletillegg_etinnvilget())){
                    ...
                    paragraph {
                        text (
                            ...
                            nynorsk { + "Vedtaket er gjort etter folketrygdlova §§ 12-11 til 12-16, 22-12 og overgangsforskrifta § 8." },
                        )
                    }
                }
                ...
                showIf((not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget()) and pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_ektefelletillegg_etinnvilget())){
                    ...
                    paragraph {
                        text (
                            ...
                            nynorsk { + "Vedtaket er gjort etter folketrygdlova §§ 12-11 til 12-14, 22-12 og overgangsforskrifta § 8." },
                        )
                    }
                }
            }
                ...
                showIf((not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_ektefelletillegg_etinnvilget()))){
                    ...
                    paragraph {
                        text (
                            ...
                            nynorsk { + "Vedtaket er gjort etter folketrygdlova §§ 12-11 til 12-14, 12-17 og 22-12." },
                        )
                    }
                }
                ...
                showIf(((pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget() or pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_ektefelletillegg_etinnvilget()))){
                    ...
                    paragraph {
                        text (
                            ...
                            nynorsk { + "Vedtaket er gjort etter folketrygdlova §§12-11 til 12-17 og 22-12." },
                        )
                    }
                }
                ...
                showIf((not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()) and pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget() and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_ektefelletillegg_etinnvilget()))){
                    ...
                    paragraph {
                        text (
                            ...
                            nynorsk { + "Vedtaket er gjort etter folketrygdlova §§ 12-11 til 12-14, 12-17, 12-18 og 22-12." },
                        )
                    }
                }
                ...
                showIf(((pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget() or pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()) and pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget() and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_ektefelletillegg_etinnvilget()))){
                    ...
                    paragraph {
                        text (
                            ...
                            nynorsk { + "Vedtaket er gjort etter folketrygdlova §§12-11 til 12-18 og 22-12." },
                        )
                    }
                }
                ...
                showIf(((pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget() or pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget()) and pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_ektefelletillegg_etinnvilget())){
                    ...
                    paragraph {
                        text (
                            ...
                            nynorsk { + "Vedtaket er gjort etter folketrygdlova §§ 12-11 til 12-17, 22-12 og overgangsforskrifta § 8." },
                        )
                    }
                }
                ...
                showIf((not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget()) and not(pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget()) and pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_ektefelletillegg_etinnvilget())){
                    ...
                    paragraph {
                        text (
                            ...
                            nynorsk { + "Vedtaket er gjort etter folketrygdlova §§ 12-11 til 12-14, 12-17, 22-12 og overgangsforskrifta § 8." },
                        )
                    }
                }
            }
            ...
            showIf((pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_avkortningsinformasjon_utbetalingsgrad().lessThan(pe.vedtaksdata_beregningsdata_beregningufore_uforetrygdberegning_uforegrad()) and pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_avkortningsinformasjon_inntektsgrense().lessThan(pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_uforetrygdordiner_avkortningsinformasjon_oifu_x_08()))){
                paragraph {
                    text (
                        ...
                        nynorsk { + "Ut frå den årlege inntekta di vil uføretrygda utgjere " + pe.ut_nettoakk_pluss_nettorestar().format() + " kroner." },
                    )
            ...
            showIf((pe.vedtaksdata_beregningsdata_beregningufore_reduksjonsgrunnlag_sumutbt().greaterThan(pe.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_reduksjonsgrunnlag_gradertoppjustertifu()) and pe.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_reduksjonsgrunnlag_barnetilleggregelverktype().notEqualTo("overgangsregler_2016") and pe.vedtaksdata_beregningsdata_beregningufore_beregningvirkningdatofom().legacyGreaterThanOrEqual(LocalDate.of(2016,1,1)))){
                paragraph {
                    text (
                        ...
                        nynorsk { + "Uføretrygda og barnetillegget ditt kan til saman ikkje utgjere meir enn 95 prosent av inntekta di før du blei ufør. 95 prosent av den inntekta du hadde før du blei ufør, tilsvarer i dag ei inntekt på " + pe.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_reduksjonsgrunnlag_gradertoppjustertifu().format() + " kroner. Uføretrygda og barnetillegget ditt er til saman høgare enn dette. Brutto årleg barnetillegg før reduksjon ut frå inntekt blir " },
                    )
            ...
            showIf(not(((pe.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_reduksjonsgrunnlag_sumbruttoforreduksjonbt().greaterThan(0) and pe.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_reduksjonsgrunnlag_sumbruttoetterreduksjonbt().equalTo(0))))){
                    ...
                    paragraph {
                        ...
                        showIf((pe.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggfelles_btfbbelopfratrukketannenforeldersinntekt().greaterThan(0))){
                            text (
                                ...
                                nynorsk { + "Folketrygdas grunnbeløp på inntil " + pe.vedtaksdata_beregningsdata_beregningufore_uforetrygdberegning_grunnbelop().format() + " kroner er holdt utanfor inntekta til ektefella, partnaren eller sambuaren din. " },
                            )
                        }
                        ...
                        showIf(((pe.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggfelles_avkortningsinformasjon_justeringsbelopperar().notEqualTo(0) and not(pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget())))){
                            text (
                                ...
                                nynorsk { + "Det du har fått utbetalt i barnetillegg tidlegare i år har også betydning for kva du får i barnetillegg framover. Dette blei tatt hensyn til då vi endra barnetillegget. " },
                            )
                        }
                    ...
                    paragraph {
                        ...
                        showIf(((pe.ut_btsbinnvilget_og_justbeloppa()))){
                            text (
                                ...
                                nynorsk { + "Inntekta di er " + pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinntektbruktiavkortning().format() + " kroner. Det du har fått utbetalt i barnetillegg tidlegare i år har også betydning for kva du får i barnetillegg framover. Dette blei tatt hensyn til då vi endra barnetillegget. " },
                            )
                        }
                    ...
                    paragraph {
                        ...
                        showIf((pe.ut_tbu1286_del1() and pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbnetto().notEqualTo(0) and pe.vedtaksbrev_vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_barnetilleggserkull_avkortningsinformasjon_justeringsbelopperar().equalTo(0))){
                            text (
                                ...
                                nynorsk { + "Inntekta di er " + pe.ut_btsb_inntekt_hoyere_lavere() + " enn " + pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbfribelop().format() + " kroner, som er fribeløpet for barnetillegget til " + pe.ut_barnet_barna_serkull() + " som ikkje bur sammen med begge foreldra. " },
                            )
                        }
                        ...
                        showIf(((pe.ut_tbu1286_del2()))){
                            text (
                                ...
                                nynorsk { + "Det du har fått utbetalt i barnetillegg tidlegare i år har også betydning for kva du får i barnetillegg framover. Dette blei tatt hensyn til da vi endra barnetillegget for " + pe.ut_barnet_barna_felles() + " som bur med begge sine foreldre. " }
                            )
                        }
                        ...
                        showIf(((pe.ut_tbu1286_del2() and pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbnetto().equalTo(0)))){
                            text (
                                bokmal { + "Du har allerede fått utbetalt det du har rett til i år, og får derfor ikke utbetalt barnetillegg for resten av året. " },
                                nynorsk { + "Du har allereie fått utbetalt det du har rett til i år, og får derfor ikje utbetalt barnetillegg for resten av året. " }
                            )
                        }
                        ...
                        showIf(((pe.ut_tbu1286_del3()))){
                            text (
                                ...
                                nynorsk { + "Det du har fått utbetalt i barnetillegg tidlegare i år har også betydning for kva du får i barnetillegg framover. Dette blei tatt hensyn til da vi endra barnetillegget for " + pe.ut_barnet_barna_serkull() + " som ikkje bur saman med begge foreldra. " }
                            )
                        }
                ...
                showIf((pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggserkull_btsbinnvilget() or pe.vedtaksdata_beregningsdata_beregning_beregningytelsekomp_barnetilleggfelles_btfbinnvilget())){
                    paragraph {
                        text (
                            bokmal { + "Du kan lese mer om beregningen av barnetillegg i vedlegget «Opplysninger om beregningen»." },
                            nynorsk { + "Du kan lese meir om berekninga av barnetillegg i vedlegget «Opplysningar om berekninga»." },
                        )
                    }
                }
            }
            ...
            showIf(pe.vedtaksdata_beregningsdata_beregningufore_beregningytelseskomp_gjenlevendetillegg_gtinnvilget()){
                ...
                paragraph {
                    text (
                        ...
                        nynorsk { + "Du mottar uføretrygd med attlevandetillegg. Tillegget er beregna etter ditt eiga og din avdøde ektefelles beregningsgrunnlag og trygdetid. Attlevandetillegget ditt har same grad som uføretrygda di. Endringar i opptjeningsgrunnlaget for uføretrygda di vil også ha betydning for beregninga av attlevandetillegget ditt. Tjener du meir enn inntektsgrensa di, reduserer vi attlevandetillegget ditt med same prosent som vi reduserer uføretrygda di." }
                    )
                }

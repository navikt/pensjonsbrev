            ...
            beregningPerioder = listOf(
                BeregningPeriode(
                    ...
                    ytelser = BeregningYtelser(
                        ...
                        tilleggspensjon = KomponentValgfri(brutto = Kroner(8_000), netto = Kroner(6_000)),
                        saertillegg = KomponentValgfri(brutto = Kroner(0), netto = Kroner(0)),
                        fasteUtgifter = KomponentValgfri(brutto = Kroner(0), netto = Kroner(0)),
                        familietillegg = KomponentValgfri(brutto = Kroner(1_500), netto = Kroner(1_000)),
                    ),
                ),
                BeregningPeriode(
                    ...
                    ytelser = BeregningYtelser(
                        ...
                        tilleggspensjon = KomponentValgfri(brutto = Kroner(4_300), netto = Kroner(4_300)),
                        saertillegg = KomponentValgfri(brutto = Kroner(0), netto = Kroner(0)),
                        fasteUtgifter = KomponentValgfri(brutto = Kroner(1_000), netto = Kroner(1_000)),
                        familietillegg = KomponentValgfri(brutto = Kroner(0), netto = Kroner(0)),
                    ),
                ),
            ),
            beregning = Beregning(
                ...
                ytelser = BeregningYtelser(
                    ...
                    grunnpensjon = Komponent(brutto = Kroner(10_500), netto = Kroner(8_000)),
                    tilleggspensjon = KomponentValgfri(brutto = Kroner(8_000), netto = Kroner(6_000)),
                    saertillegg = KomponentValgfri(brutto = Kroner(500), netto = Kroner(400)),
                    fasteUtgifter = KomponentValgfri(brutto = Kroner(0), netto = Kroner(0)),
                    familietillegg = KomponentValgfri(brutto = Kroner(1_000), netto = Kroner(600)),
                ),
            ),
        ),
    )

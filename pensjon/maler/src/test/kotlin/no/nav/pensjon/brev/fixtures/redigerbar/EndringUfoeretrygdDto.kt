    ...
    EndringUfoeretrygdDto(
        ...
        pesysData = EndringUfoeretrygdDto.PesysData(
            ...
            nyeInnvilgedeBarnetillegg = listOf(
                ...
                BarnetilleggUTDto(antallBarn = 1, begrunnelse = BtBegrunnelseCode.INNVILGET, fodselsdato = LocalDate.of(1991, Month.FEBRUARY, 2), fom = LocalDate.of(1991, Month.JANUARY, 1), tom = LocalDate.of(1991, Month.MARCH, 31)),
            ...
            nyeAvslagBarnetillegg = listOf(
                BarnetilleggUTDto(antallBarn = 1, begrunnelse = BtBegrunnelseCode.BT_INNT_OVER_1G, fodselsdato = LocalDate.of(1990, Month.APRIL, 1), fom = LocalDate.of(1990, Month.JANUARY, 1)),

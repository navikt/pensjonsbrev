    ...
    fun `hvert redigerbart brev har forventede saksbehandlervalg`() {
        ...
        val forventet = mapOf(
            ...
            Redigerbar.GP_AVSLAG_GJENLEVENDEPENSJON to listOf(
                "folketrygdlovenParagraf: no.nav.pensjon.brev.api.model.maler.redigerbar.AvslagGjenlevendepensjonDto.SaksbehandlerValg.FolketrygdlovenParagraf (Velg folketrygdloven paragraf:)",
            ),
            ...
            Redigerbar.GP_OPPHOER_GJENLEVENDEPENSJON to listOf(
                "folketrygdlovenAlternativ: no.nav.pensjon.brev.api.model.maler.redigerbar.OpphoerGjenlevendepensjonDto.SaksbehandlerValg.FolketrygdlovenAlternativ (Velg § 17-11 alternativ:)",
                "opphoerMedTilbakekreving: kotlin.Boolean (Hvis opphør med tilbakekreving)",
            ),
            Redigerbar.INFORMASJON_OM_SAKSBEHANDLINGSTID to listOf(
                "soeknadMottattFraUtland: kotlin.Boolean (Søknad mottatt fra utland)",
                "venterPaaSvarAFP: kotlin.Boolean (Venter på svar AFP)",
            ),
            ...
            Redigerbar.PE_AP_AVSLAG_GJENLEVENDERETT to listOf(
                "avdoedNavn: kotlin.String (Avdød navn)",
                "ekteskapUnderFemAar: kotlin.Boolean (Ekteskap under fem år)",
                "harTrygdetid: kotlin.Boolean (Inkluder tekst om trygdetid)",
                "hjemmelAvtaleland: kotlin.Boolean (Hjemmel avtaleland)",
                "hjemmelEOES: kotlin.Boolean (Hjemmel EØS)",
                "samboerUtenFellesBarn: kotlin.Boolean (Samboer uten felles barn)",
                "under20AarBotid: kotlin.Boolean (Under 20 år botid)",
                "underEttAarsMedlemstidEOESEllerAvtaleland: kotlin.Boolean (Under ett års medlemstid EØS eller avtaleland)",
                "underTreFemAarsMedlemstidEOESSak: kotlin.Boolean (Under tre/fem års medlemstid EØS-sak)",
                "underTreFemAarsMedlemstidNasjonalSak: kotlin.Boolean (Under tre/fem års medlemstid nasjonal sak)",
                "underTrefemAarsMedlemstidAvtalesak: kotlin.Boolean (Under tre/fem års medlemstid avtalesak)",
            ),
            ...
            Redigerbar.PE_AP_ENDRET_UTTAKSGRAD_STANS_IKKE_BRUKER_VERGE to listOf(
                "aarsak: no.nav.pensjon.brev.api.model.maler.redigerbar.VedtakEndringAvUttaksgradStansIkkeBrukerEllerVergeDto.SaksbehandlerValg.Aarsak (Årsak)",
            ),
            Redigerbar.PE_AP_ENDRING_FLYTTING_MELLOM_LAND to listOf(
                ...
                "endringIPensjonen: kotlin.Boolean (Endring i pensjon)",
                "etterbetaling: kotlin.Boolean (Etterbetaling)",
                "innvandret: kotlin.Boolean (Innvandret)",
                "reduksjonTilbakeITid: kotlin.Boolean (Reduksjon tilbake i tid)",
            ),
            ...
            Redigerbar.PE_FORESPOERSELOMDOKUMENTASJONAVBOTIDINORGE_ALDER to listOf(
                "opplystOmBotid: kotlin.Boolean (Opplyst om botid)",
            ),
            ...
            Redigerbar.PE_OMSORG_EGEN_MANUELL to listOf(
                "aarEgenerklaringOmsorgspoeng: no.nav.pensjon.brevbaker.api.model.BrevbakerType.Year (År egenerklæring omsorgspoeng)",
                "aarInnvilgetOmsorgspoeng: no.nav.pensjon.brevbaker.api.model.BrevbakerType.Year (År innvilget omsorgspoeng)",
            ),
            ...
            Redigerbar.PE_VARSEL_OM_TILBAKEKREVING_FEILUTBETALT_BELOEP to listOf(
                "hvisAktueltAaIleggeRentetillegg: kotlin.Boolean (Hvis aktuelt å ilegge rentetillegg)",
            ),
            Redigerbar.PE_VARSEL_REVURDERING_AV_PENSJON to listOf(
                "tittelValg: no.nav.pensjon.brev.api.model.maler.redigerbar.VarselRevurderingAvPensjonDto.SaksbehandlerValg.TittelValg (Tittelvalg)",
            ),
            Redigerbar.PE_VEDTAK_AVSLAG_PAA_OMSORGSOPPTJENING to listOf(
                "brukerFoedtFoer1948: kotlin.Boolean (Hvis bruker er født før 1948)",
                "omsorgsarbeidEtter69Aar: kotlin.Boolean (Omsorgsarbeid utført etter 69 år)",
                "omsorgsarbeidFoer1992: kotlin.Boolean (Omsorgsarbeid utført for en syk, funksjonshemmet eller eldre person før 1992)",
                "omsorgsarbeidForBarnUnder7aarFoer1992: kotlin.Boolean (Hvis det søkes om omsorgsopptjeningen for omsorg for barn under 7 år før 1992 uten at det er søkt om AFP privat)",
                "omsorgsarbeidMindreEnn22Timer: kotlin.Boolean (Pleie- og omsorgsarbeid mindre enn 22 timer)",
                "omsorgsarbeidMindreEnn22TimerOgMindreEnn6Maaneder: kotlin.Boolean (Pleie- og omsorgsarbeid mindre enn 22 timer  og mindre enn 6 måneder)",
                "omsorgsarbeidMindreEnn6Maaneder: kotlin.Boolean (Pleie- og omsorgsarbeid mindre enn 6 måneder)",
                "omsorgsopptjeningenGodskrevetEktefellen: kotlin.Boolean (Hvis omsorgsopptjening før 1992 allerede er godskrevet ektefellen)",
                "privatAFPavslaat: kotlin.Boolean (Hvis søknad om AFP privat er avslått av Fellesordningen)",
            ),
            Redigerbar.PE_VEDTAK_OM_FJERNING_AV_OMSORGSOPPTJENING to listOf(
                "aktuelleAar: kotlin.String (Aktuelle år)",
            ),
            ...
            Redigerbar.UT_INFORMASJON_OM_SAKSBEHANDLINGSTID to listOf(
                "forlengetSaksbehandlingstid: kotlin.Boolean (Forlenget saksbehandlingstid)",
            ),

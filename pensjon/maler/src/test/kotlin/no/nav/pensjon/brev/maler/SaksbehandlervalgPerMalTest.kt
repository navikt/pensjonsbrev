    ...
    fun `hvert redigerbart brev har forventede saksbehandlervalg`() {
        ...
        val forventet = mapOf(
            ...
            Redigerbar.GP_AVSLAG_GJENLEVENDEPENSJON to listOf(
                "folketrygdlovenParagraf: no.nav.pensjon.brev.api.model.maler.redigerbar.AvslagGjenlevendepensjonDto.SaksbehandlerValg.FolketrygdlovenParagraf",
            ),
            ...
            Redigerbar.GP_OPPHOER_GJENLEVENDEPENSJON to listOf(
                "folketrygdlovenAlternativ: no.nav.pensjon.brev.api.model.maler.redigerbar.OpphoerGjenlevendepensjonDto.SaksbehandlerValg.FolketrygdlovenAlternativ",
            ...
            Redigerbar.PE_AP_INNHENTING_INFORMASJON_FRA_BRUKER to listOf(
                "amerikanskSocialSecurityNumber: kotlin.Boolean?",
                "bankopplysninger: kotlin.Boolean?",
                "boOgArbeidsperioder: kotlin.Boolean?",
                "bosattIEoesLandSedErEoesBlanketter: kotlin.Boolean?",
                "eps60aarOgInntektUnder1g: kotlin.Boolean?",
                "eps62aarOgInntektUnder1gBoddArbeidUtland: kotlin.Boolean?",
                "epsInntektUnder2g: kotlin.Boolean?",
                "forsoergerEpsBosattIUtlandet: kotlin.Boolean?",
                "inntektsopplysninger: kotlin.Boolean?",
                "manglendeOpptjening: kotlin.Boolean?",
                "registreringAvSivilstand: kotlin.Boolean?",
                "tidspunktForUttak: kotlin.Boolean?",
            ),
            ...
            Redigerbar.PE_INFORMASJON_OM_GJENLEVENDERETTIGHETER to listOf(
                ...
                "gjenlevenderHarEllerKanHaAFPIOffentligSektor: kotlin.Boolean",
                "gjenlevevendeHarAfpOgUttaksgradPaaApSattTilNull: kotlin.Boolean",
                "hvorBorBruker: no.nav.pensjon.brev.api.model.maler.redigerbar.InformasjonOmGjenlevenderettigheterDto.HvorBorBruker?",
                "infoHvordanSoekeOmstillingsstoenad: kotlin.Boolean",
                "infoOmstillingsstoenad: kotlin.Boolean",
                "infoVilkaarSkiltGjenlevende: kotlin.Boolean",
            ...
            Redigerbar.PE_VEDTAK_AVSLAG_PAA_OMSORGSOPPTJENING to listOf(
                ...
                "omsorgsarbeidEtter69Aar: kotlin.Boolean",
                "omsorgsarbeidFoer1992: kotlin.Boolean",
                "omsorgsarbeidForBarnUnder7aarFoer1992: kotlin.Boolean",
                "omsorgsarbeidMindreEnn22Timer: kotlin.Boolean",
                "omsorgsarbeidMindreEnn22TimerOgMindreEnn6Maaneder: kotlin.Boolean",
                "omsorgsarbeidMindreEnn6Maaneder: kotlin.Boolean",
                "omsorgsopptjeningenGodskrevetEktefellen: kotlin.Boolean",

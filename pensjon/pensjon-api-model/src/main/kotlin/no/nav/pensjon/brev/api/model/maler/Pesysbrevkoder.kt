...
object Pesysbrevkoder {
    enum class AutoBrev : Automatisk {
        ...
        UT_REVERSERING_LAVERE_MINSTESATS_2026,
        UT_VEDTAK_MINSTE_IFU_2026_AUTO,
        UT_VEDTAK_REDUKSJONSPROSENT_2026_AUTO,
        UT_VEDTAK_MINSTE_IFU_REDUKSJONSPROSENT_2026_AUTO,
    ...
    enum class Redigerbar : Redigerbart {
        ...
        PE_AP_ENDRING_FLYTTING_MELLOM_LAND,
        PE_AP_ENDRING_GJENLEVENDERETT,
        PE_AP_ENDRING_INSTITUSJONSOPPHOLD,
        PE_AP_ENDRING_PGA_OPPTJENING,
        ...
        PE_KLAGE_ORIENTERING_OM_SAKSBEHANDLINGSTID,
        PE_KLAGE_SAKSBEHANDLINGSTID_VED_KLAGEINSTANS,
        ...
        PE_VEDTAK_AVSLAG_PAA_OMSORGSOPPTJENING,
        PE_VEDTAK_OM_FJERNING_AV_OMSORGSOPPTJENING,
        PE_VEDTAK_OM_INNVILGELSE_AV_OMSORGSPOENG,
        UT_AVSLAG_UFOERETRYGD,
        UT_INNVILGELSE_UFOERETRYGD,
        UT_INNVILGELSE_UFOERETRYGD_UTLAND,
        UT_INNVILGELSE_UFOERETRYGD_MELLOMBEHANDLING,
        UT_INNVILGELSE_UFOERETRYGD_MED_ENDRING,
        UT_INNVILGELSE_UFOERETRYGD_NORGE_UTLAND,
        UT_DELVIS_EKSPORT_AV_UFORETRYGD,
        UT_ENDRING_UFOERETRYGD,
        UT_OKNING_UFOREGRAD,
        UT_BEKREFTELSE_PAA_UFOERETRYGD,
        ...
        UT_REVERSERING_LAVERE_MINSTESATS_2026_RED,
        UT_VEDTAK_MINSTE_IFU_2026_RED,
        UT_VEDTAK_MINSTE_IFU_REDUKSJONSPROSENT_2026_RED,

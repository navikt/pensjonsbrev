package no.nav.pensjon.brev.api.model.maler.legacy.pegruppe10
...
// Datasett for brevgruppe 10. Brevgruppe 10 er som regel uføre vedtaksbrev.
data class PEgruppe10(
    ...
    data class ExstreamFunctions(
        ...
        val pe_bruker_var_gammel_nok_til_a_ha_inntekt_pa_uforetidspunkt: Boolean? = null,
    )
}

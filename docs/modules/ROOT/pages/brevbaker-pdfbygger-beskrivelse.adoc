...
|Saksinformasjon
|`saksinformasjon`
|Navn, fødselsnummer, saksnummer og eventuell annen mottaker. Utelates når feltet er `null`.
...
|Footer
|`visFooter`
|Saksnummer og "side N av M" nederst på hver side. Krever `saksinformasjon`, siden footeren viser saksnummer – ellers svarer pdf-bygger 400.
|===

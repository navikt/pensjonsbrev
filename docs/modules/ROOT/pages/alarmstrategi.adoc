...
* `skribenten_cache_requests_total`, med labels `omraade` (nøkkelens prefiks, satt av `Cacheomraade.prefix`, f.eks. `Norg`, `Samhandler`, `PensjonPersondata`) og `result` (`hit`/`miss`). Gir treffrate per område:
+
[source]
----

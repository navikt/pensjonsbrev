...
[source,kotlin]
----
// I f.eks pensjonsbrev/alder/alder-api-model/.../maler/<relevantDomene>/
...
TIP: Legg api-modellen under samme domene-mappe som malen slik at den blir lett å finne.
...
== 2.3
Dersom brevet tar inn data eller saksbehandlervalg krever vi at det lages en stub/fixture av dataene.
Dette er for å kunne teste alle malene. Da kan man også se hvordan malen ser ut fra output av testene [ufoere/alder]/maler/build/test_html/...

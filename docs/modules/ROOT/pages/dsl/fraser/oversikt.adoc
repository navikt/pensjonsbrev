...
|Tekst med formattering (bold/italic), linjeskift
|xref:dsl/scopes.adoc#TextScope[TextScope], xref:dsl/scopes.adoc#ParagraphScope[ParagraphScope]

|xref:dsl/fraser/plainTextPhrase.adoc[]
| Ren tekst
|xref:dsl/scopes.adoc#PlainTextScope[PlainTextScope], xref:dsl/scopes.adoc#TextScope[TextScope], xref:dsl/scopes.adoc#ParagraphScope[ParagraphScope]
|===

...
Vedlegg er separate dokumenter som kan inkluderes i et brev.
De brukes for tilleggsinformasjon som beregningsdetaljer, rettigheter eller annen utfyllende informasjon.
...
=== Bruk vedlegg for utfyllende informasjon
Hold hovedbrevet kort og konsist. Flytt detaljer til vedlegg.

=== Gi vedlegg beskrivende titler
Tittelen bør tydelig si hva vedlegget inneholder.

=== Vurder om vedlegget alltid er relevant
Bruk betinget inkludering hvis vedlegget kun er relevant i noen tilfeller.

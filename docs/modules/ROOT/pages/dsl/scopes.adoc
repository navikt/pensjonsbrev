...
TIP: Se xref:dsl/lister.adoc[] og xref:dsl/tabeller.adoc[] for mer detaljer.
...
TIP: Se xref:dsl/content/formattering.adoc[] for mer om hvordan du formaterer ulike datatyper.

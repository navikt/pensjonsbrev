...
TIP: Se xref:dsl/index.adoc[] for en rask introduksjon til mal-utvikling.
...
* xref:dsl/text/ifElse.adoc[] - velg mellom verdier
...
For å sammenligne verdier og lage betingelser, se xref:dsl/kontroll-struktur/predikat.adoc[].

...
val vedleggInformasjonOmMedlemskapOgHelserettigheterUtenforEOES =
    createAttachment<LangBokmalNynorskEnglish, EmptyVedleggData>(
        title = {
            text(
                bokmal { +"Informasjon om medlemskap og rett til helsetjenester - for alderspensjonister som bosetter seg utenfor EØS-området" },
                nynorsk { +"Informasjon om medlemskap og rett til helsetenester - for alderspensjonistar som buset seg utanfor EØS-området" },
                english { +"Information about membership and entitlement to health services - for retirement pensioners who take up residence outside the EEA" },
            )
        },
        ...
        paragraph {
            text(
                bokmal { +"Du kan søke om frivillig medlemskap i folketrygdens helsedel. Du finner søknadsskjema på ${Constants.MEDLEMSKAP_URL}." },
                nynorsk { +"Du kan søkje om frivillig medlemskap i helsedelen av folketrygda. Du finn søknadsskjema på ${Constants.MEDLEMSKAP_URL}." },
                english { +"You can apply for voluntary membership of the National Insurance Scheme’s health component. You can find the application form at ${Constants.MEDLEMSKAP_URL}." }
            )
        }
        ...
        paragraph {
            text(
                bokmal { +"Har du spørsmål om helsetjenester må du kontakte ${Constants.HELFO}." },
                nynorsk { +"Har du spørsmål om helsetenester, må du kontakte ${Constants.HELFO}." },
                english { +"If you have any questions about health services, please contact ${Constants.HELFO}." }
            )
            list {
                item {
                    text(
        ...
        paragraph {
            text(
                bokmal { +Constants.NAV_URL },
                nynorsk { +Constants.NAV_URL },
                english { +Constants.NAV_URL }
            )
        }
    }
                ...
                list {
                    ...
                    item {
                        text(
                            ...
                            nynorsk { +"Inntekt som skriv seg frå arbeid i forbindelse med fordrivne frå Ukraina." },
                        )
                    }
                }
                text(
                    bokmal { +"Se mer informasjon om arbeid i forbindelse med covid-19 og fordrevne fra Ukraina nedenfor." },
                    nynorsk { +"Sjå meir informasjon om arbeid i forbindelse med covid-19 og fordrivne frå Ukraina nedanfor." },
                )
            }

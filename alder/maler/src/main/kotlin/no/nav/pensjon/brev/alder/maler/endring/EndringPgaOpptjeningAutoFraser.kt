...
import no.nav.pensjon.brev.alder.maler.felles.Constants.ALDERSPENSJON
...
import no.nav.pensjon.brev.alder.model.endring.Opptjening
import no.nav.pensjon.brev.alder.model.endring.OpptjeningType
import no.nav.pensjon.brev.alder.model.AlderspensjonRegelverkType
import no.nav.pensjon.brev.alder.model.BeloepEndring
import no.nav.pensjon.brev.alder.model.endring.*
import no.nav.pensjon.brev.alder.model.endring.selectors.beregnetPensjonPerMaanedGjeldende.*
import no.nav.pensjon.brev.alder.model.endring.selectors.beregnetPensjonPerMaaned.*
        ...
        showIf(uforeKombinertMedAlder) {
            paragraph {
                text(
                    ...
                    nynorsk { +"Uføretrygda di kan framleis bli redusert på grunn av inntekt. Du finn informasjon om botnfrådraget i vedtak om uføretrygd." },

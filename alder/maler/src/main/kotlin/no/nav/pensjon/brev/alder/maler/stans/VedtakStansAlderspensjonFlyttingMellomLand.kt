...
import no.nav.pensjon.brev.alder.model.stans.VedtakStansAlderspensjonFlyttingMellomLandDtoSelectors.PesysDataSelectors.kravVirkDatoFom
import no.nav.pensjon.brev.alder.model.stans.VedtakStansAlderspensjonFlyttingMellomLandDtoSelectors.PesysDataSelectors.minst20AarTrygdetidKap20Avdoed
import no.nav.pensjon.brev.alder.model.stans.VedtakStansAlderspensjonFlyttingMellomLandDtoSelectors.PesysDataSelectors.minst20ArTrygdetid
import no.nav.pensjon.brev.alder.model.stans.VedtakStansAlderspensjonFlyttingMellomLandDtoSelectors.PesysDataSelectors.regelverkType
import no.nav.pensjon.brev.alder.model.stans.VedtakStansAlderspensjonFlyttingMellomLandDtoSelectors.SaksbehandlerValgSelectors.feilutbetaling
import no.nav.pensjon.brev.alder.model.stans.VedtakStansAlderspensjonFlyttingMellomLandDtoSelectors.pesysData
import no.nav.pensjon.brev.alder.model.stans.VedtakStansAlderspensjonFlyttingMellomLandDtoSelectors.saksbehandlerValg
    ...
    override val template = createTemplate(
        ...
        outline {
            ...
            paragraph {
                ...
                text(
                    bokmal { + brevdataEllerFritekst(pesysData.brukersBostedsland, "BOSTEDSLAND") },
                    nynorsk { + brevdataEllerFritekst(pesysData.brukersBostedsland, "BOSTEDSLAND") },
                    english { + brevdataEllerFritekst(pesysData.brukersBostedsland, "BOSTEDSLAND") }
                )
                text(
                    bokmal { + "." },
                    nynorsk { + "." },
                ...
                showIf(pesysData.harAvdoed and not(pesysData.minst20AarTrygdetidKap20Avdoed)) {
                    ...
                    paragraph {
                        ...
                        showIf(regelverkType.equalTo(AP2016)) {
                            text(
                                bokmal { + " Du har ikke rett til tilleggspensjon eller inntektspensjon." },
                                nynorsk { + " Du har ikkje rett til tilleggspensjon eller inntektspensjon." },
                                english { + ", are entitled to a supplementary pension or income-based pension." }
                            )
                        }.orShow {
                            text(
                                bokmal { + " Du har ikke rett til tilleggspensjon." },
                                nynorsk { + " Du har ikkje rett til tilleggspensjon." },
                    ...
                    paragraph {
                        text(
                            bokmal { +"Du har ikke vært medlem i folketrygden i minst 20 år." },
                            nynorsk { +"Du har ikkje vore medlem i folketrygda i minst 20 år." },

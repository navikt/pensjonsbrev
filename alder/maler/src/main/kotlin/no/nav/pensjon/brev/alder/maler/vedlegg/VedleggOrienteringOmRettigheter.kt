...
object VedleggPlikterUT1 : TextOnlyPhrase<LangBokmalNynorskEnglish>() {
    override fun TextOnlyScope<LangBokmalNynorskEnglish, Unit>.template() =
        text(
            bokmal { +"inntekten din endrer seg. Du kan informere Nav om endret inntekt ved å bruke selvbetjeningsløsningen på ${Constants.NAV_URL}" },
            nynorsk { +"inntekta di endrar seg. Du kan informere Nav om endra inntekt ved å bruke sjølvbeteningsløysninga på ${Constants.NAV_URL}" },
            english { +"your income changes. You can notify Nav of changes in your income by using the online service at ${Constants.NAV_URL}" },
        )
}
...
object VedleggPlikterEndretInntektBarnetillegg : TextOnlyPhrase<LangBokmalNynorskEnglish>() {
    override fun TextOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        text(
            ...
            english {
                +"the income of your spouse, partner or cohabitant changes, and you are receiving a child supplement for your joint child(ren)"
            },
        )
    }
}
...
object VedleggPlikterAFP : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal {
                    +"Du må melde fra til Nav om endringer som har betydning for størrelsen på pensjonen din. Du må alltid melde fra dersom"
                },
                nynorsk {
                    +"Du må melde frå til Nav om endringar som har noko å seie for storleiken på pensjonen din. Du må alltid melde frå dersom"
                },
...
object VedleggVeiledning : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal {
                    +"Vi har plikt til å veilede deg om dine rettigheter og plikter i saken din, både før, under og etter saksbehandlingen. Dersom du har spørsmål eller er usikker på noe, vil vi gjøre vårt beste for å hjelpe deg."
                },
                nynorsk {
                    +"Vi har plikt til å rettleie deg om rettane og pliktene dine i saka di, både før, under og etter saksbehandlinga. Dersom du har spørsmål eller er usikker på noko, vil vi gjere vårt beste for å hjelpe deg."
                },
                english {
                    +"We have a duty to inform you of your rights and obligations in connection with your case, both before, during and after the administrative process. If you have any questions or are uncertain about something, we will do our best to help you."
                },
            )
        }
    }
...
data class VedleggInnsynSakPensjon(
    val telefonnummer: Expression<Telefonnummer>,
    val nettside: Expression<String>,
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal {
                    +"Med få unntak har du rett til å se dokumentene i saken din. Du kan logge deg inn på " + nettside +
                ...
                nynorsk {
                    +"Med få unntak har du rett til å sjå dokumenta i saka di. Du kan logge deg inn på " + nettside +
                        " for å sjå all kommunikasjon som har vore mellom deg og Nav i saka di. Du kan også ringje oss på telefon " +
                        telefonnummer.format() +
                        "."
                },
                english {
                    +"With some exceptions, you are entitled to access all the documents relating to your case. Log on to " + nettside +
                        " to review the communication between you and Nav in connection with your case. You can also call us at tel.: " +
                        telefonnummer.format() +
                        "."
                },
            )
...
object VedleggInnsynSakUfoeretrygdPesys : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal {
                    +"Med få unntak har du rett til å se dokumentene i saken din. Du kan logge deg inn via ${Constants.NAV_URL} for å se dokumenter i saken din. Du kan også ringe oss på telefon ${Constants.NAV_KONTAKTSENTER_TELEFON}."
                },
                nynorsk {
                    +"Med få unntak har du rett til å sjå dokumenta i saka di. Du kan logge deg inn via ${Constants.NAV_URL} for å sjå dokumenter i saka di. Du kan også ringje oss på telefon ${Constants.NAV_KONTAKTSENTER_TELEFON}."
                },
                english {
                    +"With some exceptions, you are entitled to access the documents relating to your case. Log on to ${Constants.NAV_URL} to review the documents in connection with your case. You can also call us at telephone +47 ${Constants.NAV_KONTAKTSENTER_TELEFON}."
                },
            )
        }
    }
...
object VedleggInnsynSakUfoeretrygdPesysNoenDokumenter : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal {
                    +"Med få unntak har du rett til å se dokumentene i saken din. Du kan se noen dokumenter på ${Constants.DITT_NAV}. Du kan også ringe oss på telefon " +
                        felles.avsenderEnhet.telefonnummer.format() +
                        "."
                },
                nynorsk {
                    +"Med få unntak har du rett til å sjå dokumenta i saka di. Du kan sjå nokre dokument på ${Constants.DITT_NAV}. Du kan også ringe oss på telefon " +
                        felles.avsenderEnhet.telefonnummer.format() +
                        "."
                },
                english {
                    +"With some exceptions, you are entitled to access all the documents pertaining to your case. You can read some of the documents at ${Constants.DITT_NAV}. You can also call us at tel.: " +
                        felles.avsenderEnhet.telefonnummer.format() +
                        "."
                },
            )
...
object VedleggHjelpFraAndre : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal {
                    +"Du kan be om hjelp fra andre under hele saksbehandlingen, for eksempel av advokat, rettshjelper, en organisasjon du er medlem av eller en annen myndig person. Hvis den som hjelper deg ikke er advokat, må du gi denne personen en skriftlig fullmakt. Bruk gjerne skjemaet du finner på ${Constants.FULLMAKT_URL}."
                },
                nynorsk {
                    +"Du kan be om hjelp frå andre under heile saksbehandlinga, for eksempel av advokat, rettshjelpar, ein organisasjon du er medlem av, eller ein annan myndig person. Dersom den som hjelper deg, ikkje er advokat, må du gi denne personen ei skriftleg fullmakt. Bruk gjerne skjemaet du finn på ${Constants.FULLMAKT_URL}."
                },
                english {
                    +"You can use the assistance of a third party throughout the administrative process, e.g. from a lawyer, legal services provider, an organisation of which you are a member, or another competent person. If the person assisting you is not a lawyer, you must issue a written power of attorney authorising them to help you. You can use the form found on ${Constants.FULLMAKT_URL}."
                },
            )
        }
    }
...
data class VedleggKlagePaaVedtaket(
    val telefonnummer: Expression<Telefonnummer>,
) : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        title1 {
        ...
        paragraph {
            text(
                ...
                nynorsk {
                    +"Du kan klage på vedtaket innan seks veker frå du fekk det. Kontoret som har gjort vedtaket, vurderer då saka di på nytt."
                },
                english {
                    +"You may appeal the decision within six weeks of receiving it. The department that made the decision will then review your case."
                },
            )
        }
        paragraph {
            text(
                bokmal {
                    +"Hvis du ikke får gjennomslag for klagen din, blir den sendt videre til Nav klageinstans for ny vurdering og avgjørelse. Dersom du heller ikke får gjennomslag hos klageinstansen, kan du anke saken inn for Trygderetten."
                },
                nynorsk {
                    +"Dersom du ikkje får gjennomslag for klaga di, blir ho send vidare til Nav klageinstans for ny vurdering og avgjerd. Dersom du heller ikkje får gjennomslag hos klageinstansen, kan du anke saka inn for Trygderetten."
                },
                english {
                    +"If your complaint is declined, it will be forwarded to Nav Appeals for a new review and decision. If this review is also unsuccessful, you may appeal to The National Insurance Court."
                },
            )
        }
        paragraph {
            text(
                bokmal {
                    +"Klagen må inneholde navn, fødselsnummer og adresse. Bruk gjerne skjemaet som du finner på ${Constants.KLAGE_URL}. Trenger du hjelp, er du velkommen til å ringe oss på telefon " +
                        telefonnummer.format() +
                        "."
                },
                nynorsk {
                    +"Klaga må innehalde namn, fødselsnummer og adresse. Bruk gjerne skjemaet som du finn på ${Constants.KLAGE_URL}. Treng du hjelp, er du velkomen til å ringje oss på telefon " +
                        telefonnummer.format() +
                        "."
                },
                english {
                    +"Your appeal must include your name, national identity number and address. Feel free to use the form found at ${Constants.KLAGE_URL}. Should you need assistance in writing the appeal, please call us at tel.: " +
                        telefonnummer.format() +
                        "."
                },
            )
        ...
        paragraph {
            text(
                bokmal {
                    +"Får du medhold, kan du få dekket vesentlige utgifter som har vært nødvendige for å få endret vedtaket. Du kan ha krav på fri rettshjelp etter rettshjelploven. Informasjon om denne ordningen kan du få hos statsforvalteren, advokater eller Nav."
                },
                nynorsk {
                    +"Får du medhald, kan du få dekt vesentlege utgifter som har vore nødvendige for å få endra vedtaket. Du kan ha krav på fri rettshjelp etter rettshjelplova. Informasjon om denne ordninga kan du få hos statsforvalteren, advokatar eller Nav."
                },
                english {
                    +"If your appeal is successful, you may be eligible for compensation for costs incurred to have the decision overturned. You may also be eligible for free legal aid, pursuant to the Legal Aid Act. Information about the legal aid scheme can be obtained from the county governor, lawyers or Nav."
                },
            )
        }
        paragraph {

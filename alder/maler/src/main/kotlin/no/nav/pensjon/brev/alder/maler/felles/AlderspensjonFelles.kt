            ...
            text(
                bokmal {
                    +"Hvis du har andre pensjonsytelser som for eksempel AFP eller tjenestepensjon, blir de utbetalt i tillegg til alderspensjonen. " +
                        "Alderspensjonen din utbetales innen den 20. hver måned. Du finner oversikt over utbetalingene dine på ${Constants.UTBETALINGER_URL}."
                },
                nynorsk {
                    +"Dersom du har andre pensjonsytingar som for eksempel AFP eller tenestepensjon, kjem slik utbetaling i tillegg til alderspensjonen. " +
                        "Alderspensjonen din blir betalt ut innan den 20. i kvar månad. Du finn meir informasjon om utbetalingane dine på ${Constants.UTBETALINGER_URL}."
                },
                english {
                    +"If you have occupational pensions from other schemes, this will be paid in addition to your retirement pension. " +
                        "Your pension will be paid at the latest on the 20th of each month. See the more detailed information on what you will receive at ${Constants.UTBETALINGER_URL}."
                },
            )
        }
    }
...
object InformasjonOmAlderspensjon : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal {
                    +"Du finner mer informasjon om hvordan alderspensjon er satt sammen og oversikter over grunnbeløp og aktuelle satser på ${Constants.ALDERSPENSJON}."
                },
                nynorsk {
                    +"Du finn meir informasjon om korleis alderspensjonen er sett saman, og oversikter over grunnbeløp og aktuelle satsar på ${Constants.ALDERSPENSJON}."
                },
                english {
                    +"There is more information on how retirement pension is calculated, with overviews of basic amounts and relevant rates, at ${Constants.ALDERSPENSJON}."
                },
            )
        }
        paragraph {
            text(
                bokmal { +"Informasjon om utbetalingene dine finner du på ${Constants.DITT_NAV}. Her kan du også endre kontonummeret ditt." },
                nynorsk { +"Informasjon om utbetalingane dine finn du på ${Constants.DITT_NAV}. Her kan du også endre kontonummeret ditt." },
                english {
                    +"You can find more detailed information on what you will receive at ${Constants.DITT_NAV}. Here you can also change your bank account number."
                },
            )
        }
    }
            ...
            text(
                bokmal {
                    +"Reguleringen skjer med virkning fra 1. mai og selve økningen blir vanligvis etterbetalt i juni. " +
                        "Du får informasjon om dette på utbetalingsmeldingen din. På ${Constants.NAV_URL} kan du lese mer om hvordan pensjonene reguleres."
                },
                nynorsk {
                    +"Reguleringa skjer med verknad frå 1. mai, og sjølve auken blir vanlegvis etterbetalt i juni. " +
                        "Du får informasjon om dette på utbetalingsmeldinga di. På ${Constants.NAV_URL} kan du lese meir om korleis pensjonane blir regulerte."
                },
                english {
                    +"The pension amount will be adjusted with effect from 1 May, and the actual increase is usually paid retroactively in June. " +
                        "You will be informed about this on your payout notice. You can read more about how pensions are adjusted at ${Constants.NAV_URL}."
                },
            )
        }
    }
            ...
            text(
                bokmal {
                    +"Hvis du har kort botid i Norge når du fyller 67 år, kan du søke om supplerende stønad. " +
                        ...
                        "" +
                        "samboer eller registrert partner blir også regnet med. Du kan lese mer om supplerende stønad på nettsiden vår ${Constants.SUPPLERENDE_STOENAD_URL}."
                },
                nynorsk {
                    +"Dersom du har kort butid i Noreg når du fyller 67 år, kan du søkje om supplerande stønad. " +
                        ...
                        "sambuar eller registrert partnar skal også reknast med. Du kan lese meir om supplerande stønad på nettsida vår ${Constants.SUPPLERENDE_STOENAD_URL}."
                },
                english {
                    +"If you have only lived a short period in Norway before reaching 67 years of age, you can apply for supplementary benefit. " +
                        ...
                        "You can read more about supplementary benefit at our website ${Constants.SUPPLERENDE_STOENAD_URL}."
                },
            )
        }
    }
...
data class InnvilgelseAPUttakEndr(
    ...
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal { +"Du kan bruke pensjonskalkulatoren på ${Constants.DIN_PENSJON_URL} for å se om du kan endre alderspensjonen din." },
                nynorsk { +"Du kan bruke pensjonskalkulatoren på ${Constants.DIN_PENSJON_URL} for å sjå om du kan endre alderspensjonen din." },
                english { +"Use the pension calculator on ${Constants.DIN_PENSJON_URL} to see if you can change your retirement pension." },
            )
        }
...
object SkattAP : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            ...
            text(
                bokmal {
                    +"Du bør endre skattekortet når du begynner å ta ut alderspensjon." +
                        " Dette kan du gjøre selv på ${Constants.SKATTEETATEN_PENSJONIST_URL}. Der får du også mer informasjon om skattekort for pensjonister." +
                ...
                nynorsk {
                    +"Du bør endre skattekortet når du byrjar å ta ut alderspensjon. " +
                        " Dette kan du gjere sjølv på ${Constants.SKATTEETATEN_PENSJONIST_URL}. Der får du også meir informasjon om skattekort for pensjonistar." +
                ...
                english {
                    +"When you start draw retirement pension, you should change your tax deduction card." +
                        " You can change your tax card by logging on to ${Constants.SKATTEETATEN_PENSJONIST_URL}. There you will find more information regarding tax deduction card for pensioners." +
        ...
        paragraph {
            text(
                bokmal {
                    +"På ${Constants.DIN_PENSJON_URL} kan du se hva du betaler i skatt. Her kan du også legge inn ekstra skattetrekk om du ønsker det." +
                        " Dersom du endrer skattetrekket, vil dette gjelde fra måneden etter at vi har fått beskjed."
                },
                nynorsk {
                    +"På ${Constants.DIN_PENSJON_URL} kan du sjå kva du betaler i skatt. Her kan du også leggje inn tilleggsskatt om du ønskjer det." +
                        " Dersom du endrar skattetrekket, vil dette gjelde frå månaden etter at vi har fått beskjed."
                },
                english {
                    +"At ${Constants.DIN_PENSJON_URL} you can see how much tax you are paying. Here you can also add surtax, if you want." +
            ...
            text(
                ...
                english {
                    +"Our online service " + quoted("Din pensjon") +
                        " at ${Constants.DIN_PENSJON_URL} provides details on your accumulated rights for each year. Here you will be able to see your other types of pension rights we have registered."
                },
            )
        }
    }
        ...
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            showIf(ufoereKombinertMedAlder) {
                paragraph {
                    text(
                        bokmal {
                            +"Uføretrygden din kan fortsatt bli redusert på grunn av inntekt. Du finner informasjon om bunnfradrag i vedtak om uføretrygd."
                        },
                        nynorsk {
                            +"Uføretrygda di kan framleis bli redusert på grunn av inntekt. Du finn informasjon om bunnfradrag i vedtak om uføretrygd."
                        },
                        english {

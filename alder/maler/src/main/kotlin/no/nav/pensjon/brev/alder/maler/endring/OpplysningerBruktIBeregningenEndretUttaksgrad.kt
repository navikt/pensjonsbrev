...
import no.nav.pensjon.brev.alder.maler.felles.Constants.PENSJON_URL
...
import no.nav.pensjon.brev.alder.model.Beregningsmetode.NORDISK
import no.nav.pensjon.brev.alder.model.endring.selectors.opplysningerBruktIBeregningenEndretUttaksgradDto.alderspensjonVedVirk.*
import no.nav.pensjon.brev.alder.model.endring.selectors.opplysningerBruktIBeregningenEndretUttaksgradDto.beregningKap19VedVirk.*
import no.nav.pensjon.brev.alder.model.endring.selectors.opplysningerBruktIBeregningenEndretUttaksgradDto.beregningKap20VedVirk.*
import no.nav.pensjon.brev.alder.model.endring.selectors.opplysningerBruktIBeregningenEndretUttaksgradDto.bruker.*
import no.nav.pensjon.brev.alder.model.endring.selectors.opplysningerBruktIBeregningenEndretUttaksgradDto.endretUttaksgradVedVirk.*
import no.nav.pensjon.brev.alder.model.endring.selectors.opplysningerBruktIBeregningenEndretUttaksgradDto.krav.*
import no.nav.pensjon.brev.alder.model.endring.selectors.opplysningerBruktIBeregningenEndretUttaksgradDto.oppfrisketOpptjeningVedVirk.*
import no.nav.pensjon.brev.alder.model.endring.selectors.opplysningerBruktIBeregningenEndretUttaksgradDto.trygdetidsdetaljerKap19VedVirk.*
import no.nav.pensjon.brev.alder.model.endring.selectors.opplysningerBruktIBeregningenEndretUttaksgradDto.trygdetidsdetaljerKap20VedVirk.*
import no.nav.pensjon.brev.alder.model.endring.selectors.opplysningerBruktIBeregningenEndretUttaksgradDto.*

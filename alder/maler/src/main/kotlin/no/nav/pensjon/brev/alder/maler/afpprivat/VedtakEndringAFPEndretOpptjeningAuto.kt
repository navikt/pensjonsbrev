...
import no.nav.pensjon.brev.alder.model.afpprivat.selectors.aFPPrivatBeregning.totalPensjon
import no.nav.pensjon.brev.alder.model.afpprivat.selectors.opptjeningInfo.antallAarEndretOpptjening
import no.nav.pensjon.brev.alder.model.afpprivat.selectors.opptjeningInfo.endretOpptjeningsAar
import no.nav.pensjon.brev.alder.model.afpprivat.selectors.opptjeningInfo.sisteGyldigeOpptjeningsAar
import no.nav.pensjon.brev.alder.model.afpprivat.selectors.vedtakEndringAFPEndretOpptjeningAutoDto.afpPrivatBeregningGjeldende
import no.nav.pensjon.brev.alder.model.afpprivat.selectors.vedtakEndringAFPEndretOpptjeningAutoDto.afpPrivatBeregningVedVirk
import no.nav.pensjon.brev.alder.model.afpprivat.selectors.vedtakEndringAFPEndretOpptjeningAutoDto.belopEndring
import no.nav.pensjon.brev.alder.model.afpprivat.selectors.vedtakEndringAFPEndretOpptjeningAutoDto.endretOpptjening
import no.nav.pensjon.brev.alder.model.afpprivat.selectors.vedtakEndringAFPEndretOpptjeningAutoDto.maanedligPensjonFoerSkattAFP
import no.nav.pensjon.brev.alder.model.afpprivat.selectors.vedtakEndringAFPEndretOpptjeningAutoDto.opptjeningType
import no.nav.pensjon.brev.alder.model.afpprivat.selectors.vedtakEndringAFPEndretOpptjeningAutoDto.virkFom

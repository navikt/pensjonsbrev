...
import no.nav.pensjon.brev.alder.model.endring.VedtakEndringVedFlyttingMellomLandDto.AarsakTilAtPensjonenOeker
import no.nav.pensjon.brev.alder.model.endring.VedtakEndringVedFlyttingMellomLandDto.Opphoersbegrunnelse.BRUKER_FLYTTET_IKKE_AVT_LAND
import no.nav.pensjon.brev.alder.model.endring.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.alderspensjonVedVirk.*
import no.nav.pensjon.brev.alder.model.endring.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.beregnetPensjonPerMaanedVedVirk.*
import no.nav.pensjon.brev.alder.model.endring.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.bruker.*
import no.nav.pensjon.brev.alder.model.endring.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.inngangOgEksportVurderingAvdoed.*
import no.nav.pensjon.brev.alder.model.endring.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.inngangOgEksportVurdering.*
import no.nav.pensjon.brev.alder.model.endring.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.krav.*
import no.nav.pensjon.brev.alder.model.endring.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.opphoersbegrunnelseVedVirk.*
import no.nav.pensjon.brev.alder.model.endring.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.ytelseskomponentInformasjon.*
import no.nav.pensjon.brev.alder.model.endring.selectors.vedtakEndringVedFlyttingMellomLandDto.pesysData.*
import no.nav.pensjon.brev.alder.model.endring.selectors.vedtakEndringVedFlyttingMellomLandDto.*
...
object VedtakEndringVedFlyttingMellomLand : RedigerbarTemplate<VedtakEndringVedFlyttingMellomLandDto> {
    ...
    override val kode = Aldersbrevkoder.Redigerbar.PE_AP_ENDRING_FLYTTING_MELLOM_LAND

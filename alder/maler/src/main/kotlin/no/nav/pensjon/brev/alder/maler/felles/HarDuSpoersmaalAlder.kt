...
data class HarDuSpoersmaal(val merInformasjonUrl: String) : OutlinePhrase<LangBokmalNynorskEnglish>() {
    override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
        ...
        paragraph {
            text(
                bokmal {
                    +"Du finner mer informasjon på ${merInformasjonUrl}." +
                ...
                nynorsk {
                    +"Du finn meir informasjon på ${merInformasjonUrl}." +
                            " På ${Constants.KONTAKT_URL} kan du chatte eller skrive til oss." +
                ...
                english {
                    +"You can find more information at ${merInformasjonUrl}." +

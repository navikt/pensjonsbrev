...
import no.nav.pensjon.brev.alder.model.adhoc.gjenlevenderett2027.selectors.gjenlevenderett2027Dto.*
...
object VarselGjpForlengetArskull6061 : AutobrevTemplate<Gjenlevenderett2027Dto> {
    ...
    override val kode = Aldersbrevkoder.AutoBrev.GJP_VARSEL_FORLENGELSE_60_61
    ...
    override val template: LetterTemplate<*, Gjenlevenderett2027Dto> = createTemplate(
        ...
        outline {
            ...
            paragraph {
                text(
                    bokmal { + "Hvis du har hatt lav eller ingen pensjonsgivende inntekt de siste fem årene før 2024, kan du beholde gjenlevendepensjonen din til du blir 67 år. " },
                    nynorsk { + "Dersom du har vore utan eller hatt låg pensjonsgivande inntekt dei siste fem åra før 2024, kan du behalde gjenlevandepensjonen din til du blir 67 år. " },
                )
            }
            ...
            paragraph {
                text(
                    bokmal { + "Det er din pensjonsgivende inntekt i årene 2019–2023 som avgjør om du kan beholde gjenlevendepensjonen til du fyller 67 år." },
                    nynorsk { + "Det er den pensjonsgivande inntekta di i åra 2019–2023 som avgjer om du kan behalde gjenlevandepensjonen til du fyller 67 år. " },
            ...
            paragraph {
                text(
                    bokmal { + "Din inntekt har ifølge våre opplysninger vært lavere enn inntektsgrensene. Dersom det er korrekt, beholder du gjenlevendepensjonen din til og med måneden du fyller 67 år. " },
                    nynorsk { + "Inntekta di har ifølgje opplysningane våre vore lågare enn inntektsgrensene. Dersom det er korrekt, beheld du gjenlevandepensjonen din til og med månaden du fyller 67 år. " },
                )
            }

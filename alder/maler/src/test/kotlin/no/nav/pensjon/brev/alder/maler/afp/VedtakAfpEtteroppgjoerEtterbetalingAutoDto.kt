...
fun createVedtakAfpEtteroppgjoerEtterbetalingAutoDto(): VedtakAfpEtteroppgjoerEtterbetalingAutoDto =
    VedtakAfpEtteroppgjoerEtterbetalingAutoDto(
        ...
        scenario = VedtakAfpEtteroppgjoerEtterbetalingAutoDto.Scenario.IFU_OG_IEO_OVERSTYRT,
        periode = VedtakAfpEtteroppgjoerEtterbetalingAutoDto.NyPensjonsberegningPeriode.UTTAK_OG_OPPHOR_I_AARET,
    )

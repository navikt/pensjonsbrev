...
class ApiServiceTest {
    ...
    private val dto2ApiService =
        Dto2ApiService(
            brevbakerService =
                mockk {
                    coEvery { getRedigerbarTemplate(eq(Testbrevkoder.TESTBREV)) } returns
    ...
    @Test
    fun `status er kladd om brev ikke er laast og ikke redigeres`(): Unit =
        runBlocking {
    ...
    @Test
    fun `status er Klar om brev er laast`(): Unit =
        runBlocking {
    ...
    @Test
    fun `status er UnderRedigering om brev ikke er laast og er reservert for redigering`(): Unit =
        runBlocking {
    ...
    @Test
    fun `henter navn for opprettetAv og sistredigertAv`(): Unit =
        runBlocking {
    ...
    @Test
    fun `henter brevtittel fra brevbaker`(): Unit =
        runBlocking {
            val brev = createBrev()
    ...
    @Test
    fun `henter navn paa avsenderEnhet`(): Unit =
        runBlocking {
    ...
    @Test
    fun `henter navn paa samhandler mottaker`(): Unit =
        runBlocking {

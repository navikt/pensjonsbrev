...
class HentBrevForAlleSakerHandlerTest : BrevredigeringHandlerTestBase() {
    ...
    suspend fun `kan hente brev for flere saker`() {
        ...
        val resultat = hentBrevForAlleSaker(setOf(sak1.saksId, sak2.saksId))?.asSuccess()?.value?.toSet()

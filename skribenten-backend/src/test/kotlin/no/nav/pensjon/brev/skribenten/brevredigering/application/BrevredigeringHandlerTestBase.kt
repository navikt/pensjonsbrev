...
abstract class BrevredigeringHandlerTestBase {
    ...
    protected val endreRedigertVedlegg by lazy { EndreRedigertVedleggHandler(brevtilgang, brevmalService, brevdataService) }
    protected val slettRedigertVedlegg by lazy { SlettRedigertVedleggHandler(brevtilgang) }
    protected val hentRedigertVedlegg by lazy { HentRedigertVedleggHandler(brevtilgang, brevmalService, brevdataService) }
    protected val hentRedigerbareVedlegg by lazy { HentRedigerbareVedleggHandler(brevtilgang, brevmalService, brevdataService) }
    ...
    protected val slettBrevHandler by lazy { SlettBrevHandler(brevtilgang) }

...
class BrevbakerServiceTest {
    ...
    private val markup = LetterMarkupImpl(
        title = listOf(TextImpl.LiteralImpl(-1, "the title")),
        ...
        blocks = listOf(
            BlockImpl.ParagraphImpl(
                1, true, listOf(
                    ItemListImpl(
                        11, listOf(
                            ItemListImpl.ItemImpl(
                                111,
                                listOf(TextImpl.LiteralImpl(1111, "item 1", Text.FontType.BOLD))
                            )
                        )
                    ),
                    TableImpl(
                        ...
                        listOf(
                            TableImpl.RowImpl(
                                121,
                                listOf(TableImpl.CellImpl(1211, listOf(TextImpl.LiteralImpl(12111, "cell1"))))
                            )
                        ),
                        TableImpl.HeaderImpl(
                            122,
                            listOf(
                                TableImpl.ColumnSpecImpl(
                                    1221,
                                    TableImpl.CellImpl(12211, listOf(TextImpl.LiteralImpl(122111, "col1"))),
                                    Table.ColumnAlignment.RIGHT,
                                    1
                                )
                            )
                        )

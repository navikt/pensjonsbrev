...
object BrevkodeModule : SimpleModule() {
    ...
    init {
        ...
        addDeserializer(Pesysbrevkoder.Redigerbar::class.java, BrevkodeDeserializerRedigerbart)
    }
    ...
    private object BrevkodeDeserializerRedigerbart : JsonDeserializer<Pesysbrevkoder.Redigerbar>() {
        override fun deserialize(parser: JsonParser, ctxt: DeserializationContext): Pesysbrevkoder.Redigerbar =

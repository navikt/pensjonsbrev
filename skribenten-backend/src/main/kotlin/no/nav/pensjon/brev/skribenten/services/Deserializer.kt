...
internal inline fun <reified T, reified V : T> SimpleModule.addInterfaceDeserializer() =
    addDeserializer(T::class.java, object : AbstractDeserializer<T, V>(V::class.java) {})

internal abstract class AbstractDeserializer<T, V : T>(private val v: Class<V>) : JsonDeserializer<T>() {

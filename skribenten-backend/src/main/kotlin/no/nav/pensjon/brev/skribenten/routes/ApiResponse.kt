            ...
            when (outcome.error) {
                ...
                is FerdigRedigertPolicy.IkkeFerdigRedigert.FritekstFelterUredigert ->
                    call.respond(
                        ...
                        message = BrevExceptionDto(tittel = "Brev ikke klart", melding = "Brevet inneholder fritekst-felter som ikke er endret. Det gjelder følgende felt: ${outcome.error.ikkeredigerteFritekstfelter.joinToString(", ") { it.text }}")
                    )

...
@Suppress("unused")
data class InnhentingOpplysningerFraBrukerAlderDto(
    override val saksbehandlerValg: SaksbehandlerValg,
    override val pesysData: EmptyBrevdata
) : RedigerbarBrevdata<InnhentingOpplysningerFraBrukerAlderDto.SaksbehandlerValg, EmptyBrevdata> {
    data class SaksbehandlerValg(
        ...
        val registreringAvSivilstand: RegistreringAvSivilstand,
        ) : BrevbakerBrevdata{
        data class RegistreringAvSivilstand(
            val epsType: EPSType
        ){
            enum class EPSType{
                Ektefelle,

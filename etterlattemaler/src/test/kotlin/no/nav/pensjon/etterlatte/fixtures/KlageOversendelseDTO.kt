...
fun createKlageOversendelseBlankettDTO() =
    KlageOversendelseBlankettDTO(
        innhold = emptyList(),
        formkrav =
            Formkrav(
        ...
        hjemmel = "§ 18-4",
        internKommentar = "Wow en intern kommentar",
        ovesendelseTekst = "Noe ekstra her",
        klager = "12312312312",
        klageDato = LocalDate.now().minusDays(3),
        sakType = SakType.BARNEPENSJON,
    )

fun createKlageOversendelseBrukerDTO() =
    KlageOversendelseBrukerDTO(

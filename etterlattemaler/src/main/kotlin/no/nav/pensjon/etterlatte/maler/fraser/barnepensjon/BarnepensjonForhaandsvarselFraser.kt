...
class BarnepensjonForhaandsvarselFraser {
    ...
    object ForhaandsvarselRedigerbart : OutlinePhrase<LangBokmalNynorskEnglish>() {
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            ...
            paragraph {
                text(
                    bokmal { +"<Fritekst. Eks.: Utbetaling av barnepensjon skulle vært stoppet fra " +
                    ...
                    nynorsk { +"<Fritekst. Eks.: Utbetalinga av barnepensjon skulle ha vore stoppa " +
                    ...
                    english { +"<Fritekst. Eks.: The children’s pension payments should have stopped " +
                            "the month after you were adopted. We did not receive the information in time to stop " +
                            "the payment at the right time. This has resulted in an incorrect payment to you. >" },
                )
            }

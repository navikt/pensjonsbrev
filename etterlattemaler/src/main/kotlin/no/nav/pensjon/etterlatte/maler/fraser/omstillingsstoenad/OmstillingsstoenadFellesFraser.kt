    ...
    object Utbetaling : OutlinePhrase<LangBokmalNynorskEnglish>() {
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            ...
            paragraph {
                text(
                    bokmal {
                        +"Omstillingsstønad blir utbetalt innen den 20. i hver måned. Du finner " +
                    ...
                    nynorsk {
                        +"Omstillingsstønad blir utbetalt innan den 20. i kvar månad. Du finn " +
                    ...
                    english {
                        +"The adjustment allowance is paid on or before the 20th of each month. " +
    ...
    object MeldFraOmEndringer : OutlinePhrase<LangBokmalNynorskEnglish>() {
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            ...
            paragraph {
                text(
                    bokmal {
                        +"Du har plikt til å melde fra til oss om endringer som har betydning for " +
                    ...
                    nynorsk {
                        +"Du pliktar å melde frå til oss om endringar som har innverknad på utbetalinga " +
                                "av eller retten på omstillingsstønad. I vedlegget «Dine rettar og plikter» ser du kva " +
                                "endringar du må seie frå om. "
                    },
                    english {
                        +"You are obligated to notify us of any changes that affect the payment of " +
    ...
    object MeldFraOmEtteroppgjoer : OutlinePhrase<LangBokmalNynorskEnglish>() {
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            ...
            paragraph {
                text(
                    bokmal {
                        +"Du finner mer informasjon om etteroppgjør på ${Constants.OMS_ETTEROPPGJOER_URL}. " +
                                "Du kan melde fra om opplysninger og sende dokumentasjon om etteroppgjøret på ${Constants.OMS_MELD_INN_ENDRING_URL}."
                    },
                    nynorsk {
                        +"Du finn meir informasjon om etteroppgjer på ${Constants.OMS_ETTEROPPGJOER_URL}. " +
                    ...
                    english {
                        +"You can find more information about the final settlement of adjustment allowance at ${Constants.OMS_ETTEROPPGJOER_URL}. " +
    ...
    object DuHarRettTilInnsyn : OutlinePhrase<LangBokmalNynorskEnglish>() {
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            ...
            paragraph {
                text(
                    bokmal {
                        +"Du har som hovedregel rett til å se dokumentene i saken din " +
                                "etter bestemmelsene i forvaltningsloven § 18. Hvis du ønsker innsyn, " +
                                "må du kontakte oss på telefon eller per post."
                    },
                    nynorsk {
                        +"Etter føresegnene i forvaltingslova § 18 har du som hovudregel rett til å " +
                                "sjå dokumenta i saka di. Kontakt oss på telefon eller per post dersom du ønskjer innsyn."
                    },
                    english {
                        +"As a general rule, you have the right to see the documents in your case " +
    ...
    object Etteroppgjoer : OutlinePhrase<LangBokmalNynorskEnglish>() {
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            ...
            paragraph {
                text(
                    bokmal {
                        +"Hver høst sjekker Nav inntektsopplysningene i skatteoppgjøret ditt for å se " +
                    ...
                    nynorsk {
                        +"Kvar haust sjekkar Nav inntektsopplysningane i skatteoppgjeret ditt for å sjå " +
                    ...
                    english {
                        +"Each autumn, Nav checks income data from your tax return to verify the correct " +
        ...
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            ...
            showIf(omsRettUtenTidsbegrensning) {
                paragraph {
                    text(
                        bokmal {
                            +"Du kommer inn under unntaksreglene for varighet av stønaden, fordi du har hatt " +
                        ...
                        nynorsk {
                            +"Du kjem inn under unntaksreglane for lengde på stønad, då du var utan " +
                        ...
                        english {
                            +"If any of the rules for exemption from the duration of allowance apply to " +
                ...
                showIf(beregning.sisteBeregningsperiode.utbetaltBeloep.greaterThan(0)) {
                    paragraph {
                        text(
                            bokmal {
                                +"Du får omstillingsstønad frem til det er gått tre år " +
                                        ifElse(
                                            tidligereFamiliepleier,
                                            "siden pleieforholdet opphørte",
                                            "fra datoen for dødsfallet"
                                        ) + ", så " +
                                        "lenge du oppfyller vilkårene. Rett til omstillingsstønad faller uansett bort når du fyller 67 år."
                            },
                            nynorsk {
                                +"Under føresetnad av at du oppfyller vilkåra, får du omstillingsstønad " +
                            ...
                            english {
                                +"You are eligible for adjustment allowance for three years from the " +
                                        ifElse(tidligereFamiliepleier, "care period ended", " date of the death") +
                    ...
                    paragraph {
                        text(
                            bokmal {
                                +"Stønaden kan forlenges med inntil to år hvis du tar utdanning som er nødvendig " +
                                        "og hensiktsmessig."
                            },
                            nynorsk {
                                +"Stønaden kan bli forlenga med inntil to år dersom du tek utdanning " +
                                        "som er nødvendig og føremålstenleg."
                            },
                            english {
                                +"The allowance can be extended for two years if you begin an education or " +
                    ...
                    paragraph {
                        text(
                            bokmal {
                                +"Du er innvilget omstillingsstønad frem til det er gått tre år " +
                                        ifElse(
                                            tidligereFamiliepleier,
                                            "siden pleieforholdet opphørte",
                                            "fra datoen for dødsfallet"
    ...
    object SpesieltOmInntektsendring : OutlinePhrase<LangBokmalNynorskEnglish>() {
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            ...
            paragraph {
                text(
                    bokmal {
                        +"For at du skal motta korrekt omstillingsstønad, er det viktig at du informerer " +
                    ...
                    nynorsk {
                        +"For at du skal få rett omstillingsstønad, er det viktig at du informerer oss " +
                    ...
                    english {
                        +"To receive the correct amount of the adjustment allowance, you are obligated " +
        ...
        override fun OutlineOnlyScope<LangBokmalNynorskEnglish, Unit>.template() {
            ...
            paragraph {
                text(
                    ...
                    english {
                        +"To receive the correct amount of adjustment allowance, you are obligated to " +

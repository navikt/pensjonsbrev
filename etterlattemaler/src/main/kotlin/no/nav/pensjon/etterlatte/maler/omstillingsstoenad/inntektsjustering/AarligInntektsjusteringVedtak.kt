...
object OmstillingsstoenadInntektsjusteringVedtak : EtterlatteTemplate<AarligInntektsjusteringVedtakDTO>,
    ...
    override val template =
        createTemplate(
            ...
            includeAttachment(
                beregningAvOmstillingsstoenad(tidligereFamiliepleier = true, innvilgelsesaar = false, nyRedigerbarDel = false.expr()),
                data.beregning,
                data.tidligereFamiliepleier,
            )
            includeAttachment(
                beregningAvOmstillingsstoenad(tidligereFamiliepleier = false, innvilgelsesaar = false, nyRedigerbarDel = false.expr()),
                data.beregning,

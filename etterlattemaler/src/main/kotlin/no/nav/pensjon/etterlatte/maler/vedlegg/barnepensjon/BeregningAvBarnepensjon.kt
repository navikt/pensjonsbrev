...
val beregningAvBarnepensjonGammeltOgNyttRegelverk: AttachmentTemplate<LangBokmalNynorskEnglish, BarnepensjonBeregning> =
    createAttachment(
        title =
            newText(
...
@TemplateModelHelpers
val beregningAvBarnepensjonNyttRegelverk: AttachmentTemplate<LangBokmalNynorskEnglish, BarnepensjonBeregning> =
    createAttachment(
        title =
            newText(
                Bokmal to "Beregning av barnepensjon",
...
private fun OutlineOnlyScope<LangBokmalNynorskEnglish, BarnepensjonBeregning>.bestBeregnetProrata(
    aarTrygdetid: Expression<Int>,
    prorataBroek: Expression<IntBroek?>,
) {
    paragraph {

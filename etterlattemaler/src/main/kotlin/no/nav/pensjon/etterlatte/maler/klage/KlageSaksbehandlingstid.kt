    ...
    override val template =
        createTemplate(
            ...
            outline {
                ...
                paragraph {
                    textExpr(
                        Bokmal to "Du kan finne vår saksbehandlingstid på ".expr() +
                            ifElse(
                                sakType.equalTo(SakType.BARNEPENSJON), SAKSBEHANDLINGSTIDER_BP.expr(), SAKSBEHANDLINGSTIDER_OMS.expr(),
                            ) + ".",
                        Nynorsk to "Du finn saksbehandlingstida vår på ".expr() +
                            ifElse(
                                sakType.equalTo(SakType.BARNEPENSJON), SAKSBEHANDLINGSTIDER_BP.expr(), SAKSBEHANDLINGSTIDER_OMS.expr(),
                            ) + ".",
                        English to "You can find more information about case processing time here: ".expr() +
                            ifElse(
                                sakType.equalTo(SakType.BARNEPENSJON), SAKSBEHANDLINGSTIDER_BP.expr(), SAKSBEHANDLINGSTIDER_OMS.expr(),
                            ) + ".",
                    )

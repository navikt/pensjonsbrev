...
private fun OutlineOnlyScope<LangBokmalNynorskEnglish, InformasjonOmOmstillingsstoenadData>.aktivitet(
    ...
    paragraph {
        text(
            ...
            nynorsk { +"For å kunne halde fram med å få omstillingsstønad når det har gått seks månader sidan " +
            ...
            english { +"Once six months have passed after the " +
    ...
    paragraph {
        text(
            bokmal { +"Det er unntak fra aktivitetsplikten som gir rett til omstillingsstønad. Dette gjelder " +
            ...
            nynorsk { +"Det finst unntak frå aktivitetsplikta som gir rett til omstillingsstønad. Dette gjeld " +
            ...
            english { +"There are some exemptions to the activity obligation which entitle you to adjustment " +
    ...
    paragraph {
        text(
            ...
            english { +"You can read more about the activity obligation and its exceptions online: " +
...
private fun OutlineOnlyScope<LangBokmalNynorskEnglish, InformasjonOmOmstillingsstoenadData>.hvisDuIkkeFyllerAktivitetsplikten() {
    ...
    paragraph {
        text(
            bokmal { +"Hvis du ikke fyller aktivitetsplikten, kan utbetalingen av stønaden stoppe inntil " +
                    "vilkårene er oppfylt igjen. Det blir midlertidig stans av utbetalingene dine hvis du" },
            nynorsk { +"Dersom du ikkje innfrir aktivitetsplikta, kan utbetalinga av stønaden bli stansa " +
                    "fram til du igjen oppfyller vilkåra. Utbetalingane blir stansa mellombels dersom du" },
            english { +"If you do not meet the activity obligation, allowance payments may stop until the " +
    ...
    paragraph {
        text(
            bokmal { +"Nav må kunne komme i kontakt med deg for å følge deg opp ved behov. Får vi ikke " +
                    "kontakt med deg, kan vi stoppe stønaden din." },
            nynorsk { +"Nav må kunne kontakte deg for å gi oppfølging ved behov. Dersom vi ikkje får kontakt " +
                    "med deg, kan vi stoppe stønaden." },
            english { +"Nav must be able to get in touch with you to follow up your case, whenever needed. " +
...
private fun OutlineOnlyScope<LangBokmalNynorskEnglish, InformasjonOmOmstillingsstoenadData>.inntektOgOmstillingsstoenad() {
    ...
    paragraph {
        text(
            bokmal { +"Omstillingsstønaden skal reduseres med 45 prosent av inntekten din som er over " +
            ...
            nynorsk { +"Omstillingsstønaden skal reduserast med 45 prosent av inntekta di som er over " +
            ...
            english { +"The adjustment allowance are reduced by 45 percent of your income, if it is more " +
...
private fun OutlineOnlyScope<LangBokmalNynorskEnglish, InformasjonOmOmstillingsstoenadData>.endretInntekt() {
    ...
    paragraph {
        text(
            bokmal { +"Om du melder fra om endring av inntekt i løpet av året, vil vi justere " +
            ...
            nynorsk { +"Dersom du melder frå om endring av inntekt i løpet av året, vil vi justere " +
                    ...
                    "utrekninga. " },
            english { +"If you report a change in income during the year, we will adjust the adjustment " +
    ...
    paragraph {
        text(
            bokmal { +"Utbetalingen for resten av året vil justeres utfra det du har fått utbetalt så langt " +
            ...
            nynorsk { +"Utbetalinga for resten av året vil bli justert ut frå det du har fått utbetalt så " +
            ...
            english { +"The payment for the rest of the year will be adjusted based on what you have been " +
...
private fun OutlineOnlyScope<LangBokmalNynorskEnglish, InformasjonOmOmstillingsstoenadData>.hvilkenInntektReduseresEtter() {
    ...
    paragraph {
        text(
            bokmal { +"Omstillingsstønaden skal reduseres etter arbeidsinntekt og annen inntekt som er " +
                    "likestilt med arbeidsinntekt. Dette er blant annet:" },
            nynorsk { +"Omstillingsstønaden skal reduserast etter arbeidsinntekt og anna inntekt som er " +
                    "likestilt med arbeidsinntekt. Dette er mellom anna" },
            english { +"The adjustment allowance shall be reduced according to income from employment and " +
...
private fun OutlineOnlyScope<LangBokmalNynorskEnglish, InformasjonOmOmstillingsstoenadData>.utbetalingTilKontonummer() {
    ...
    paragraph {
        text(
            bokmal { +"Du kan bare ha ett kontonummer registrert hos Nav. Du kan endre kontonummeret i " +
            ...
            nynorsk { +"Du kan berre ha eitt kontonummer registrert hos Nav. Du kan endre kontonummer under " +
            ...
            english { +"You can only have one account number registered with Nav. You can change your account " +
...
private fun OutlineOnlyScope<LangBokmalNynorskEnglish, InformasjonOmOmstillingsstoenadData>.skatt(bosattUtland: Expression<Boolean>) {
    ...
    showIf(bosattUtland) {
        ...
        paragraph {
            ...
            text(
                bokmal { +"Hvis du er skattemessig bosatt i Norge, skal du betale skatt på all inntekt og formue. " +
                ...
                nynorsk { +"Viss du er skattemessig busett i Norge, skal du betale skatt for all inntekt og formue. " +
                ...
                english { +"If you are resident in Norway for tax purposes, you must pay tax on all income and wealth. " +
        ...
        paragraph {
            ...
            text(
                bokmal { +"Er du ikke skattemessig bosatt i Norge, skal du betale 15 prosent kildeskatt på brutto omstillingsstønad." +
                ...
                nynorsk { +"Er du ikkje skattemessig busett i Noreg, skal du betale 15 prosent kjeldeskatt av brutto omstillingsstønad. " +
                ...
                english { +"If you are not resident in Norway for tax purposes, you must pay 15 per cent withholding tax on your adjustment allowance. " +
        ...
        paragraph {
            text(
                bokmal { +"Omstillingsstønaden er skattepliktig. Du trenger ikke levere skattekortet til Nav " +
                        "fordi skatteopplysningene dine sendes elektronisk fra Skatteetaten." },
                nynorsk { +"Omstillingsstønaden er skattepliktig. Du treng ikkje levere skattekortet til Nav, " +
                        "då skatteopplysningane dine blir sende elektronisk frå Skatteetaten." },
                english { +"Adjustment allowance are taxable. You do not need to submit your tax deduction " +
        ...
        paragraph {
            text(
                bokmal { +"Endring av skattekort gjøres enklest på Skatteetatens nettsider www.skatteetaten.no. " +
                ...
                nynorsk { +"Skattekortet endrar du enklast frå nettsidene til Skatteetaten, www.skatteetaten.no. " +
                ...
                english { +"The easiest way to change your tax deduction card is done on the Tax Administration's " +
